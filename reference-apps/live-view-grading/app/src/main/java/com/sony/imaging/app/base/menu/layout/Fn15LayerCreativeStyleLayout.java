...
public class Fn15LayerCreativeStyleLayout extends Fn15LayerMenuLayout {
    ...
    public void onResume() {
        ...
        this.mContrast.init("Contrast", ctrl.getSupportedValue("Contrast"));
        this.mSaturation.init("Saturation", ctrl.getSupportedValue("Saturation"));
        this.mSharpness.init("Sharpness", ctrl.getSupportedValue("Sharpness"));
    ...
    @Override // com.sony.imaging.app.base.menu.layout.Fn15LayerMenuLayout
    protected void onMainBeltItemSelected(BeltView arg0, View arg1, int index, long id) {
