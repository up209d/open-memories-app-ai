        ...
        if (this.mNotificationListener == null) {
            this.mNotificationListener = new NotificationListener() { // from class: com.sony.imaging.app.base.shooting.widget.RotationalSubLcdTextRecTime.1
                ...
                public void onNotify(String tag) {
                    ...
                    if (tag.equals(CameraNotificationManager.MOVIE_REC_STOP) || tag.equals(CameraNotificationManager.MOVIE_REC_START_FAILED)) {
                ...
                public String[] getTags() {
                    return new String[]{CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, CameraNotificationManager.MOVIE_REC_START_FAILED, CameraNotificationManager.MOVIE_REC_STOP, CameraNotificationManager.MOVIE_REC_TIME_CHANGED};
                }
            };
        }
