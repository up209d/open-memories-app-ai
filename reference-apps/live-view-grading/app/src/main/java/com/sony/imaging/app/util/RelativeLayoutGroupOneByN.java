...
public class RelativeLayoutGroupOneByN extends AbstractRelativeLayoutGroup {
    private static final String TAG = "RelativeLayoutGroupOneByN";

    public RelativeLayoutGroupOneByN(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    public void setVisibility(int visibility) {
        super.setVisibility(visibility);
        ViewGroupManagerOneByN.updateStatus(this, this.mGroup);
    }
