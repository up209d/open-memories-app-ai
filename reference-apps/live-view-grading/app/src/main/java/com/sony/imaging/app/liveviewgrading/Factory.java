...
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingCurrentPresetResetConfirmationScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingExposureModeSubMenuLayout;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingGroupSelectionScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingMovieModeMenuLayout;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingPageMenuLayout;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingParameterAdjustmentGuideLayout;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingPlaybackExitScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingPresetAdjustmentScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingPresetParameterResetScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.ColorGradingPresetSelectionScreen;
import com.sony.imaging.app.liveviewgrading.menu.layout.LastBastionMenuLayout;
import com.sony.imaging.app.liveviewgrading.playback.ColorGradingPlayRoot;
import com.sony.imaging.app.liveviewgrading.playback.browser.ColorGradingBrowserIndex;
import com.sony.imaging.app.liveviewgrading.playback.browser.ColorGradingBrowserSingle;
import com.sony.imaging.app.liveviewgrading.playback.delete.multiple.DeleteMultiple;
import com.sony.imaging.app.liveviewgrading.playback.delete.multiple.DeleteMultipleConfirm;
import com.sony.imaging.app.liveviewgrading.playback.delete.multiple.DeleteMultipleExecutor;
import com.sony.imaging.app.liveviewgrading.playback.delete.multiple.DeleteMultipleIndex;
import com.sony.imaging.app.liveviewgrading.playback.delete.multiple.DeleteMultipleSingle;
import com.sony.imaging.app.liveviewgrading.playback.layout.DeleteMultipleConfirmLayout;
import com.sony.imaging.app.liveviewgrading.playback.layout.DeleteMultipleIndexLayout;
import com.sony.imaging.app.liveviewgrading.playback.layout.DeleteMultipleProcessingLayout;
import com.sony.imaging.app.liveviewgrading.playback.layout.DeleteMultipleSingleLayout;
...
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingExposureModeCheckState;
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingForceSettingState;
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingMovieCaptureState;
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingMovieRecStandbyState;
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingMovieRecState;
import com.sony.imaging.app.liveviewgrading.shooting.ColorGradingShootingMenuState;
import com.sony.imaging.app.liveviewgrading.shooting.layout.ColorGradingStableLayout;
import com.sony.imaging.app.liveviewgrading.shooting.trigger.ColorGradingEEStateKeyHandler;
import com.sony.imaging.app.liveviewgrading.shooting.trigger.ColorGradingMfAssistKeyHandler;
import com.sony.imaging.app.liveviewgrading.shooting.trigger.ColorGradingMovieRecStandbyStateKeyHandler;
...
public class Factory extends com.sony.imaging.app.fw.Factory {
    ...
    public static class RootStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            Factory.add(ShootingState.class, ShootingStateFactory.class, ShootingLayoutFactory.class, ShootingStateKeyHandler.class);
            add(BaseApp.APP_PLAY, ColorGradingPlayRoot.class);
            Factory.add(ColorGradingPlayRoot.class, PlaybackStateFactory.class, null, null);
    ...
    public static class ShootingStateFactory extends StateFactory {
        @Override // com.sony.imaging.app.fw.StateFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add("FORCESETTING", ColorGradingForceSettingState.class);
            Factory.add(ColorGradingForceSettingState.class, null, null, null);
            add("ExposureModeCheck", ColorGradingExposureModeCheckState.class);
            Factory.add(ColorGradingExposureModeCheckState.class, null, null, null);
            add("EE", ColorGradingEEState.class);
            Factory.add(ColorGradingEEState.class, EEStateFactory.class, null, ColorGradingEEStateKeyHandler.class);
            ...
            if (Environment.isMovieAPISupported()) {
                add("MovieCapture", ColorGradingMovieCaptureState.class);
                Factory.add(ColorGradingMovieCaptureState.class, null, MovieLayoutFactory.class, MovieCaptureStateKeyHandler.class);
                add("MovieRec", ColorGradingMovieRecState.class);
                Factory.add(ColorGradingMovieRecState.class, MovieRecStateFactory.class, MovieLayoutFactory.class, MovieRecStateKeyHandler.class);
    ...
    public static class MovieLayoutFactory extends LayoutFactory {
        ...
        public void init() {
            add(StateBase.DEFAULT_LAYOUT, ColorGradingStableLayout.class);
            add(DigitalZoomSettingLayout.MENU_ID, DigitalZoomSettingLayout.class);
            add(StateBase.FOCUS_LAYOUT, FocusLayout.class);
            add("ID_COLORGRADINGPLAYBACKEXITSCREEN", ColorGradingPlaybackExitScreen.class);
        }
    }
    ...
    public static class EEStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            Factory.add(S1OffEEState.class, null, S1OffEELayoutFactory.class, S1OffEEStateKeyHandler.class);
            ...
            Factory.add(MfAssistState.class, null, MfAssistLayoutFactory.class, ColorGradingMfAssistKeyHandler.class);
            ...
            add("MovieRecStandby", ColorGradingMovieRecStandbyState.class);
            Factory.add(ColorGradingMovieRecStandbyState.class, null, MovieLayoutFactory.class, ColorGradingMovieRecStandbyStateKeyHandler.class);
            add(ICustomKey.CATEGORY_MENU, ColorGradingShootingMenuState.class);
            Factory.add(ColorGradingShootingMenuState.class, null, MenuLayoutFactory.class, null);
        }
    }
    ...
    public static class MenuLayoutFactory extends LayoutFactory {
        ...
        public void init() {
            ...
            if (ExposureModeController.isMovieMainFeature()) {
                AppLog.info("Check isMovieMainFeature ", "isMovieMainFeature");
                ...
                AppLog.info("Check isMovieMainFeature ", "isMovieMainFeature normal");
                add(ExposureModeMenuLayout.MENU_ID, ColorGradingExposureModeSubMenuLayout.class);
                Factory.add(ColorGradingExposureModeSubMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            }
            ...
            add("ID_MOVIEMODEMENULAYOUT", ColorGradingMovieModeMenuLayout.class);
            Factory.add(ColorGradingMovieModeMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            ...
            add(PageMenuLayout.MENU_ID, ColorGradingPageMenuLayout.class);
            Factory.add(ColorGradingPageMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            ...
            add("ID_COLORGRADINGGROUPSELECTIONSCREEN", ColorGradingGroupSelectionScreen.class);
            Factory.add(ColorGradingGroupSelectionScreen.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_COLORGRADINGPRESETSELECTIONSCREEN", ColorGradingPresetSelectionScreen.class);
            Factory.add(ColorGradingPresetSelectionScreen.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_COLORGRADINGPRESETADJUSTMENTSCREEN", ColorGradingPresetAdjustmentScreen.class);
            Factory.add(ColorGradingPresetAdjustmentScreen.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_COLORGRADINGPRESETPARAMETERRESETSCREEN", ColorGradingPresetParameterResetScreen.class);
            Factory.add(ColorGradingPresetParameterResetScreen.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_COLORGRADINGPRESETRESETCONFIRMATIONSCREEN", ColorGradingCurrentPresetResetConfirmationScreen.class);
            Factory.add(ColorGradingCurrentPresetResetConfirmationScreen.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_COLORGRADINGPARAMETERADJUSTMENTGUIDELAYOUT", ColorGradingParameterAdjustmentGuideLayout.class);
            Factory.add(ColorGradingParameterAdjustmentGuideLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
        }
    }
    ...
    public static class EachPlaybackStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            add(ColorGradingPlayRoot.ID_DELETE_MULTIPLE, DeleteMultiple.class);
    ...
    public static class EachBrowserFactory extends StateFactory {
        @Override // com.sony.imaging.app.fw.StateFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add(PlaySubApp.ID_SINGLE_PB, ColorGradingBrowserSingle.class);
            Factory.add(ColorGradingBrowserSingle.class, PbFunctionCommonFactory.class, EachBrowserSingleLayoutFactory.class, null);
            add(PlaySubApp.ID_INDEX_PB, ColorGradingBrowserIndex.class);
            Factory.add(ColorGradingBrowserIndex.class, PbFunctionCommonFactory.class, EachBrowserIndexLayoutFactory.class, null);
        }
    }
