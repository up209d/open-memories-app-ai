...
public class ColorGradingTrashIcon extends ActiveImage {
    ...
    public ColorGradingTrashIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mListener = null;
    ...
    protected void refresh() {
        setBackgroundResource(R.drawable.p_16_dd_parts_key_delete);
    }
    ...
    class LVGActiveImageListener extends ActiveImage.ActiveImageListener {
        ...
        public void onNotify(String tag) {
            if ("movieStarted".equals(tag)) {
                ColorGradingTrashIcon.this.setVisibility(4);
            } else if ("movieStopped".equals(tag)) {
                ColorGradingTrashIcon.this.setVisibility(0);
            }
            super.onNotify(tag);
        }
