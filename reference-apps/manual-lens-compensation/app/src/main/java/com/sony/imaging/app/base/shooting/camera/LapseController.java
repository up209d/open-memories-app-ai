...
public class LapseController extends AbstractController {
    ...
    protected static void setIntervalSecDictionay() {
        ...
        app2pf.put(INTERVAL_1S, Integer.valueOf(S_1S));
        app2pf.put(INTERVAL_2S, 2000);
        app2pf.put(INTERVAL_5S, Integer.valueOf(S_5S));
        ...
        pf2app.put(S_1S, INTERVAL_1S);
        pf2app.put(2000, INTERVAL_2S);
        pf2app.put(S_5S, INTERVAL_5S);
