...
public class PfBugAvailability {
    ...
    public static final int PF_MAJOR_VERSION = Integer.parseInt(PF_VERSION.substring(0, PF_VERSION.indexOf(".")));
    public static final int PF_API_VERSION = Integer.parseInt(PF_VERSION.substring(0, PF_VERSION.indexOf(".")));
