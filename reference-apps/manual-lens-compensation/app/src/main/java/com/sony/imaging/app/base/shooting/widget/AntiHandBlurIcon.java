...
public class AntiHandBlurIcon extends ActiveImage {
    ...
    protected boolean isMovieMode() {
        return 2 == CameraSetting.getInstance().getCurrentMode();
    }
    ...
    public class NotificationListener extends ActiveImage.ActiveImageListener {
        ...
        protected NotificationListener() {
            super();
            this.TAGS = new String[]{"AntiHandBlur", CameraNotificationManager.DEVICE_LENS_CHANGED};
        }
        ...
        public void onNotify(String tag) {
            if ("AntiHandBlur".equals(tag) || CameraNotificationManager.DEVICE_LENS_CHANGED.equals(tag)) {
