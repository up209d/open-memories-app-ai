...
public class OCMovieRecState extends MovieRecState {
    ...
    protected class OCBackupToEE extends MovieStateBase.BackupToEE {
        ...
        public void onReopened(CameraEx arg0) {
            AppLog.enter(OCMovieRecState.TAG, AppLog.getMethodName());
            ...
            AppLog.exit(OCMovieRecState.TAG, AppLog.getMethodName());
        }
    }
}
