...
public abstract class MenuState extends State implements MenuLayoutListener {
    ...
    public static final String IS_HISTORY_NEEDED = "IsHistroyNeeded";
    ...
    public void onResume() {
        ...
        if (this.data != null) {
            itemId = this.data.getString("ItemId");
            if (itemId == null) {
            ...
            createHistory = this.data.getBoolean(IS_HISTORY_NEEDED);
        }
        openMenuLayout(itemId, nextMenuID, createHistory);
        this.doneFinishMenuState = false;
    }

    /* JADX INFO: Access modifiers changed from: protected */
    public void openMenuLayout(String itemId, String layoutID) {
        openMenuLayout(itemId, layoutID, false);
    }

    protected void openMenuLayout(String itemId, String layoutID, boolean createHistory) {
        if (this.data == null) {
        ...
        if (createHistory) {
            baseMenuService.setMenuItemIdWithHistory(nextItemId);
        }
        this.mMenuData.setMenuData(nextItemId, null, null, null, baseMenuService);
