...
public class CreativeStyleOptionView extends RelativeLayout {
    ...
    public CreativeStyleOptionView(Context context, AttributeSet attrs) {
        ...
        this.INVALID_ALPHA = 128;
        this.VALID_ALPHA = 255;
        this.mOpCursor = null;
        ...
        if (resourceId3 != 0) {
            ...
            params3.topMargin = AREAFIG_OPTION_DOWN_TOP;
        ...
        RelativeLayout.LayoutParams params5 = new RelativeLayout.LayoutParams(AREAFIG_OPTION_VALUE_WIDTH, AREAFIG_OPTION_VALUE_HEIGHT);
