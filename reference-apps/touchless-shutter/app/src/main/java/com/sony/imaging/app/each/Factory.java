...
import com.sony.imaging.app.each.menu.list.ShowCautionLayout;
import com.sony.imaging.app.each.playback.EachPlayRoot;
import com.sony.imaging.app.each.playback.browser.EachBrowserIndex;
import com.sony.imaging.app.each.playback.browser.EachBrowserSingle;
import com.sony.imaging.app.each.playback.delete.multiple.DeleteMultiple;
import com.sony.imaging.app.each.playback.delete.multiple.DeleteMultipleConfirm;
import com.sony.imaging.app.each.playback.delete.multiple.DeleteMultipleExecutor;
import com.sony.imaging.app.each.playback.delete.multiple.DeleteMultipleIndex;
import com.sony.imaging.app.each.playback.delete.multiple.DeleteMultipleSingle;
import com.sony.imaging.app.each.playback.layout.DeleteMultipleConfirmLayout;
import com.sony.imaging.app.each.playback.layout.DeleteMultipleIndexLayout;
import com.sony.imaging.app.each.playback.layout.DeleteMultipleProcessingLayout;
import com.sony.imaging.app.each.playback.layout.DeleteMultipleSingleLayout;
import com.sony.imaging.app.each.playback.layout.EachBrowserIndexLayout;
import com.sony.imaging.app.each.playback.layout.EachBrowserSingleLayout;
import com.sony.imaging.app.each.shooting.EachForceSettingState;
import com.sony.imaging.app.each.shooting.LiveBulb_S1OffEEState;
import com.sony.imaging.app.each.shooting.LiveBulb_S1OnEEState;
import com.sony.imaging.app.each.shooting.TLS_DevelopmentState;
import com.sony.imaging.app.each.shooting.TLS_DevelopmentStateKeyHandler;
import com.sony.imaging.app.each.shooting.TLS_EEState;
import com.sony.imaging.app.each.shooting.TLS_MovieCaptureState;
import com.sony.imaging.app.each.shooting.TLS_MovieRecStandbyState;
import com.sony.imaging.app.each.shooting.TLS_MovieRecState;
import com.sony.imaging.app.each.shooting.TLS_MovieRecStateKeyHandler;
import com.sony.imaging.app.each.shooting.TLS_SelfTimerCaptureState;
import com.sony.imaging.app.each.shooting.TLS_ShootingStateKeyHandler;
...
public class Factory extends com.sony.imaging.app.fw.Factory {
    ...
    public static class RootStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            Factory.add(ShootingState.class, ShootingStateFactory.class, ShootingLayoutFactory.class, TLS_ShootingStateKeyHandler.class);
            add(BaseApp.APP_PLAY, PlayRootContainer.class);
            Factory.add(PlayRootContainer.class, PlaybackStateFactory.class, null, null);
    ...
    public static class ShootingStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            Factory.add(EachForceSettingState.class, null, null, null);
            add("ExposureModeCheck", ExposureModeCheckState.class);
            Factory.add(ExposureModeCheckState.class, null, null, null);
            add("EE", TLS_EEState.class);
            Factory.add(TLS_EEState.class, EEStateFactory.class, null, EEStateKeyHandler.class);
            add("Capture", CaptureState.class);
            Factory.add(CaptureState.class, CaptureStateFactory.class, null, CaptureStateKeyHandler.class);
            add("Development", TLS_DevelopmentState.class);
            Factory.add(TLS_DevelopmentState.class, DevelopmentStateFactory.class, DevelopmentLayoutFactory.class, TLS_DevelopmentStateKeyHandler.class);
            ...
            if (Environment.isMovieAPISupported()) {
                add("MovieCapture", TLS_MovieCaptureState.class);
                Factory.add(TLS_MovieCaptureState.class, null, MovieLayoutFactory.class, MovieCaptureStateKeyHandler.class);
                add("MovieRec", TLS_MovieRecState.class);
                Factory.add(TLS_MovieRecState.class, MovieRecStateFactory.class, MovieLayoutFactory.class, TLS_MovieRecStateKeyHandler.class);
    ...
    public static class EEStateFactory extends StateFactory {
        @Override // com.sony.imaging.app.fw.StateFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add(S1OffEEState.STATE_NAME, LiveBulb_S1OffEEState.class);
            Factory.add(LiveBulb_S1OffEEState.class, null, S1OffEELayoutFactory.class, S1OffEEStateKeyHandler.class);
            add("S1OnEE", LiveBulb_S1OnEEState.class);
            Factory.add(LiveBulb_S1OnEEState.class, null, S1OnEELayoutFactory.class, S1OnEEStateKeyHandler.class);
            ...
            add("MovieRecStandby", TLS_MovieRecStandbyState.class);
            Factory.add(TLS_MovieRecStandbyState.class, null, MovieLayoutFactory.class, MovieRecStandbyStateKeyHandler.class);
            add(ICustomKey.CATEGORY_MENU, ShootingMenuState.class);
            Factory.add(ShootingMenuState.class, null, MenuLayoutFactory.class, null);
        }
    }
    ...
    public static class CaptureStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            add("SelfTimerCapture", TLS_SelfTimerCaptureState.class);
            Factory.add(TLS_SelfTimerCaptureState.class, null, SelfTimerCaptureLayoutFactory.class, SelfTimerCaptureStateKeyHandler.class);
        }
    }
    ...
    public static class MenuLayoutFactory extends LayoutFactory {
        @Override // com.sony.imaging.app.fw.LayoutFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add("ID_SHOW_CAUTION_LAYOUT", ShowCautionLayout.class);
            Factory.add(ShowCautionLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
    ...
    public static class EachPlaybackStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            add(EachPlayRoot.ID_DELETE_MULTIPLE, DeleteMultiple.class);
