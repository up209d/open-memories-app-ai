    ...
    public static int dispatchUpAction(IEachKeyHandler handler, KeyEvent event) {
        ...
        switch (code) {
            ...
            case AppRoot.USER_KEYCODE.UM_S2 /* 615 */:
                ...
                return ret27;
            case AppRoot.USER_KEYCODE.CUSTOM1 /* 622 */:
                int ret28 = handler.onCustom1KeyReleased(event);
                return ret28;
            case AppRoot.USER_KEYCODE.CUSTOM2 /* 623 */:
                int ret29 = handler.onCustom2KeyReleased(event);
                return ret29;
            case AppRoot.USER_KEYCODE.PREVIEW /* 632 */:
                int ret30 = handler.onPreviewKeyReleased(event);
                return ret30;
            case AppRoot.USER_KEYCODE.AF_MF_AEL /* 638 */:
                int ret31 = handler.onAfMfAelReleased(event);
                return ret31;
            case AppRoot.USER_KEYCODE.WATER_HOUSING /* 640 */:
                int ret32 = handler.onWaterHousingDetached(event);
                return ret32;
            case AppRoot.USER_KEYCODE.LENS_FOCUS_HOLD /* 653 */:
                int ret33 = handler.onLensFocusHoldReleased(event);
                return ret33;
            default:
                return 0;
        }
