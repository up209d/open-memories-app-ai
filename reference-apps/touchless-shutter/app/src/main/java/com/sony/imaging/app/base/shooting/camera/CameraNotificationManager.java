...
public class CameraNotificationManager extends NotificationManager {
    ...
    public Object getValue(String tag) {
        return ("AudioWindNoiseReduction".equals(tag) || "MicRefLevelChanged".equals(tag)) ? AudioNotificationManager.getInstance().getValue(tag) : this.mValues.get(tag);
    }
    ...
    public void requestNotify(String tag, Object value) {
        if ("AudioWindNoiseReduction".equals(tag) || "MicRefLevelChanged".equals(tag)) {
    ...
    public void requestSyncNotify(String tag, Object value) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_REQUESTSYNCNOTIFY).append("tag = ").append(tag).append(", ").append(LOG_MSG_VALUE).append(value);
        ...
        if (isValueChanged) {
            ...
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_NOTCHANGED).append("tag = ").append(tag);
