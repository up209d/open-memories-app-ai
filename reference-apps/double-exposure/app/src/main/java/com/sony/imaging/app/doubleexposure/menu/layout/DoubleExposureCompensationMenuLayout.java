...
public class DoubleExposureCompensationMenuLayout extends ExposureCompensationMenuLayout {
    public static final String ID_DOUBLEEXPOSURECOMPENSATIONMENULAYOUT = "ID_DOUBLEEXPOSURECOMPENSATIONMENULAYOUT";
