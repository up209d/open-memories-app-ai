...
public class FlashModeIcon extends FlashAbstractIcon {
    ...
    protected NotificationListener getNotificationListener() {
        return new NotificationListener() { // from class: com.sony.imaging.app.base.shooting.widget.FlashModeIcon.1
            ...
            public void onNotify(String tag) {
                Log.i(FlashModeIcon.TAG, FlashModeIcon.this.builder.replace(0, FlashModeIcon.this.builder.length(), FlashModeIcon.LOG_NOTIFYTAG).append(tag).toString());
    ...
    public void refresh() {
        ...
        if ((this.mVisible && this.isEnable) || this.mFnMode) {
            ...
            Log.d(TAG, this.builder.replace(0, this.builder.length(), LOG_FLASHMODE).append(mode).toString());
            if ("off".equals(mode)) {
