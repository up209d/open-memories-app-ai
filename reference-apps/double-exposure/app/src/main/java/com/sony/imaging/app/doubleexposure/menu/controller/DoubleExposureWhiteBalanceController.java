...
public class DoubleExposureWhiteBalanceController extends WhiteBalanceController {
    private static final String TAG = AppLog.getClassName();
    private static DoubleExposureWhiteBalanceController sInstance = null;

    private DoubleExposureWhiteBalanceController() {
    }

    public static DoubleExposureWhiteBalanceController getInstance() {
        AppLog.enter(TAG, AppLog.getMethodName());
        if (sInstance == null) {
            sInstance = new DoubleExposureWhiteBalanceController();
        }
