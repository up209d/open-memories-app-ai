...
public class CameraSetting implements CameraEx.ApertureChangeListener, CameraEx.ShutterSpeedChangeListener, CameraEx.AutoISOSensitivityListener, CameraEx.SettingChangedListener, CameraEx.ProgramLineRangeOverListener, CameraEx.FocusLightStateListener, CameraEx.EquipmentCallback, CameraEx.PreviewAnalizeListener, CameraEx.FlashEmittingListener, CameraEx.FocalLengthChangeListener, CameraEx.FaceDetectionListener, CameraEx.AutoSceneModeListener, CameraEx.ProgramLineListener, CameraEx.ErrorCallback {
    ...
    private void createParameterComparatorList() {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.SCENE_MODE) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.26
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
            public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderSimpleComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.27
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderListComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.28
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
        ...
        this.AUDIO_PARAMETER_COMPARATORS.add(new AudioSimpleComparator<String>(CameraNotificationManager.AUDIO_WIND_NR) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.29
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
