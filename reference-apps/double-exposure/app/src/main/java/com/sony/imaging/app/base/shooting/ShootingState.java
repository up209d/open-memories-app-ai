...
public class ShootingState extends StateBase implements ShootingLayout.HolderListener {
    ...
    public void onResume() {
        ...
        if (2 == Environment.DEVICE_TYPE || 4 == Environment.DEVICE_TYPE) {
            ...
            if (params.getSceneMode() == null) {
                params.setSceneMode("manual-exposure");
            }
    ...
    public void onPause() {
        ...
        HoldKeyServer.holdKey(AppRoot.USER_KEYCODE.EV_DIAL_CHANGED, 3);
        ...
        public void onNotify(String tag) {
            ...
            if (2 == state || state == 0) {
                ...
                if (!currentMedia.equals(ids[0])) {
                    ...
                    BaseShootingExecutor executor = ExecutorCreator.getInstance().getSequence();
                    ShootingState.access$408();
                    executor.setRecordingMedia(ids[0], this.recordingTargetMediaChangedCb);
                ...
                String[] m = {executor2.getRecordingMedia()};
            ...
            if (1 == state) {
                ...
                ExecutorCreator.getInstance().stableSequence(2);
            }
        }
    }
    ...
    private static class MyRecordingMediaChangeCallback implements CameraEx.RecordingMediaChangeCallback {
        ...
        public void onRecordingMediaChange(CameraEx cam) {
            ShootingState.access$410();
            ShootingState.STRBUILD.replace(0, ShootingState.STRBUILD.length(), ShootingState.LOG_ON_RECORDING_MEDIA_CHANGED).append(ShootingState.mSetRecordingMediaCount);
            Log.d(ShootingState.TAG, ShootingState.STRBUILD.toString());
