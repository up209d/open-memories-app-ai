...
public class DoubleExposureFaceDetectionController extends FaceDetectionController {
    private static final String TAG = AppLog.getClassName();
    private static DoubleExposureFaceDetectionController sInstance = null;

    private DoubleExposureFaceDetectionController() {
    }

    public static DoubleExposureFaceDetectionController getInstance() {
        AppLog.enter(TAG, AppLog.getMethodName());
        if (sInstance == null) {
            sInstance = new DoubleExposureFaceDetectionController();
        }
