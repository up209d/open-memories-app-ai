...
public class CreativeStyleIcon extends ActiveImage {
    ...
    static {
        ...
        RESID_DICTIONARY_CS_MODE.put(CreativeStyleController.VIVID, 7);
        RESID_DICTIONARY_CS_MODE.put(CreativeStyleController.NEUTRAL, 8);
        RESID_DICTIONARY_CS_MODE.put(CreativeStyleController.CLEAR, 9);
        ...
        RESID_DICTIONARY_CS_MODE.put(CreativeStyleController.MONO, 17);
        ...
        RESID_DICTIONARY_CS_VALUE.put("0", 22);
        RESID_DICTIONARY_CS_VALUE.put(DoubleExposureConstant.EXPOSURE_COMPENSATION_SKY_DEFAULT_VALUE, 21);
