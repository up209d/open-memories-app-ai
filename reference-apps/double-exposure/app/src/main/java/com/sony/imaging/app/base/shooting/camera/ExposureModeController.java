...
public class ExposureModeController extends AbstractController {
    ...
    private static void initDictionary() {
        ...
        EXPOSURE_MODE_DICTIONARY.put(SHUTTER_MODE, "shutter-speed");
        EXPOSURE_MODE_DICTIONARY.put("Manual", "manual-exposure");
        ...
        EXPOSURE_DIAL_DICTIONARY.append(AppRoot.USER_KEYCODE.MODE_DIAL_AES, SHUTTER_MODE);
        EXPOSURE_DIAL_DICTIONARY.append(AppRoot.USER_KEYCODE.MODE_DIAL_MANUAL, "Manual");
        ...
        STILL_MOVIE_MODE_DICTIONARY.put(SHUTTER_MODE, MOVIE_SHUTTER_MODE);
        STILL_MOVIE_MODE_DICTIONARY.put("Manual", MOVIE_MANUAL_MODE);
        ...
        UI_SCENE_MODE_DICTIONARY.put(2052, SHUTTER_MODE);
        UI_SCENE_MODE_DICTIONARY.put(2053, "Manual");
        ...
        UI_SCENE_MODE_DICTIONARY.put(2073, UNDERWATER);
    ...
    /* JADX INFO: Access modifiers changed from: protected */
    public static void createSupportedList(List<Integer> supportedModeDials) {
    ...
    public void setValue(String tag, String value) {
        ...
        if (mode != null) {
            ...
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SETSCENEMODE).append(mode);
    ...
    private String getValueDirect() {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSCENEMODE).append(mode);
        Log.i(TAG, STRBUILD.toString());
    ...
    private static String retrieveKey(HashMap<String, String> dictionary, String value) {
    ...
    public String getValue(String tag) {
        ...
        if (tag == null) {
            ...
            if (1 == ExecutorCreator.getInstance().getRecordingMode() && (returnValue = retrieveKey(SCENE_SELECTION_MODE_DICTIONARY, mode)) == null && "SceneSelectionMode".equals(tag)) {
            ...
            if (!isMovieMainFeature() && 2 == ExecutorCreator.getInstance().getRecordingMode()) {
                return "movie";
            }
        ...
        } else if (("movie".equals(tag) || MOVIE_MODE_MENU.equals(tag)) && 2 == ExecutorCreator.getInstance().getRecordingMode() && (returnValue = retrieveKey(MOVIE_SUB_MODE_DICTIONARY, mode)) == null) {
    ...
    public List<String> getSupportedValue(String tag) {
        ...
        if (tag.equals(EXPOSURE_MODE)) {
            ...
            if (isMovieMainFeature() && (index = supporteds.indexOf("movie")) != -1) {
    ...
    private static List<String> createSupportedValueArray(List<Pair<Camera.Parameters, CameraEx.ParametersModifier>> params, String tag) {
        ...
        if (EXPOSURE_MODE.equals(tag)) {
            ...
            if (isMovieMainFeature() && params.get(1) != null) {
        ...
        if (supportedSceneModes != null && dictionary != null) {
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSUPPORTEDSCENEMODES).append(supportedSceneModes);
            Log.i(TAG, STRBUILD.toString());
    ...
    public static String scancode2Value(int scancode) {
        ...
        if (value == null) {
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_NOTSUPPORTEDDIAL).append(scancode);
    ...
    public static boolean isMovieMainFeature() {
        if (Environment.getVersionPfAPI() < 2 || ScalarProperties.getInt("ui.main.feature") != 1) {
            return false;
        }
        return true;
    }
        ...
        if (-1 != code) {
            ...
            if ("SceneSelectionMode".equals(appMode)) {
                ...
                if (!"".equals(appMode2)) {
                    ...
                    Log.i(TAG, "get scenemode " + pfMode);
                    if (!isMovieSubExposureMode(pfMode)) {
                ...
                if (pfMode == null) {
                    STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_INVALID_SCANCODE).append(Integer.toString(code));
                    Log.w(TAG, STRBUILD.toString());
                    pfMode = "auto";
                }
            }
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SCENEMODE_UPDATED).append(LOG_MSG_MODE_DIAL_POS).append(Integer.toString(code)).append(LOG_MSG_SCENEMODE).append(pfMode);
            Log.i(TAG, STRBUILD.toString());
    ...
    class MovieExpModeInhibition {
        ...
        void toPMode() {
            if (!this.other2p) {
                ...
                String movieBkup = ExposureModeController.getDefaultMovieExposureMode();
