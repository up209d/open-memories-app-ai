...
public class MeteringController extends AbstractController {
    ...
    public void setValue(String itemId, String value) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SETMETERINGMODE).append(value);
    ...
    public String getValue(String itemId) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETMETERINGMODE).append(value);
        Log.i(TAG, STRBUILD.toString());
        return value;
    }
    ...
    private static List<String> createSupportedValueArray(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSUPPORTEDMETERINGMODES).append(supporteds);
        Log.i(TAG, STRBUILD.toString());
