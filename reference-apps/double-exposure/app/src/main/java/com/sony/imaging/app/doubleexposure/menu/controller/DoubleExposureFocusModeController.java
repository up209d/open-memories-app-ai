...
public class DoubleExposureFocusModeController extends FocusModeController {
    private static final String TAG = AppLog.getClassName();
    private static DoubleExposureFocusModeController sInstance = null;
    public String mFocusMode = "af-s";

    private DoubleExposureFocusModeController() {
    }

    public static DoubleExposureFocusModeController getInstance() {
        AppLog.enter(TAG, AppLog.getMethodName());
        if (sInstance == null) {
            sInstance = new DoubleExposureFocusModeController();
        }
