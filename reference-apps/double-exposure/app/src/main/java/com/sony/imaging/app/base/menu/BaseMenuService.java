...
public class BaseMenuService {
    ...
    private ArrayList<String> getSupportedSettingItemList(ArrayList<String> items, int mode) {
    ...
    private ArrayList<String> getSupportedValueItemList(String itemId, int mode) {
        String value;
    ...
    public int getResourceId(String itemId, String element) {
        ...
        if (intId == null && (item = getDisplayItem(itemId)) != null && item.elements != null && (strid = item.elements.get(element.hashCode())) != null && strid.length() > 0) {
    ...
    public String getString(String itemId, String element) {
        ...
        return item.elements.get(element.hashCode());
    }
    ...
    public void accessorInit(String fileName, MenuAccessor accessor) {
        this.mAccessor = new MenuAccessor();
        this.mAccessor.initialize(this.mContext, null, fileName);
    }
