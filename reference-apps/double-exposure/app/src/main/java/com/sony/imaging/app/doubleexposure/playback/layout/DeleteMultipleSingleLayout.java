...
public class DeleteMultipleSingleLayout extends SelectorSingleLayout {
    ...
    private static final int[] IMAGE_OK_LAYOUT_RESOURCE_ID_INFO_ON = {R.id.pb_parts_cmn_singlepb_metadata, R.id.pb_parts_cmn_header_contents_info};
    private static final int[] IMAGE_OK_LAYOUT_RESOURCE_ID_INFO_OFF = new int[0];
    private static final int[] IMAGE_OK_LAYOUT_RESOURCE_ID_HISTGRAM = {R.id.pb_parts_cmn_singlepb_histo_metadata, R.id.pb_parts_cmn_singlepb_histo, R.id.pb_parts_cmn_header_contents_info};
