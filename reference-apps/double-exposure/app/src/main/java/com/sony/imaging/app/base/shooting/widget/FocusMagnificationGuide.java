...
public class FocusMagnificationGuide extends RelativeLayout {
    ...
    protected void refreshOffsetToImageAspect(int width, int height) {
        ...
        Log.d(TAG, image_aspect + LogHelper.MSG_COLON + this.mOffsetH + LogHelper.MSG_COMMA + this.mOffsetV);
    }
    ...
    protected void refreshGuideFrame() {
        if (getWidth() != 0 && getHeight() != 0) {
            ...
            Log.d(TAG, "refreshGuideFrame( " + params.leftMargin + AbstractSupportedChecker.SEPARATOR + params.topMargin + AbstractSupportedChecker.SEPARATOR + params.rightMargin + AbstractSupportedChecker.SEPARATOR + params.bottomMargin + LogHelper.MSG_CLOSE_BRACKET);
    ...
    public void layoutGuide(int l, int t, int r, int b) {
        if (this.mGuideFrame != null) {
            ...
            Log.d(TAG, "mGuideFrame(" + this.mOffsetH + AbstractSupportedChecker.SEPARATOR + this.mOffsetV + ")-(" + this.mGuideFrame.getMeasuredWidth() + AbstractSupportedChecker.SEPARATOR + this.mGuideFrame.getMeasuredHeight() + LogHelper.MSG_CLOSE_BRACKET);
