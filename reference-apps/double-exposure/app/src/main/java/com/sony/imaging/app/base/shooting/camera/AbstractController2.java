...
public abstract class AbstractController2<PF> extends AbstractController {
    ...
    public void setValue(String tag, String value) throws IllegalArgumentException {
        ...
        if (pfValue == null) {
            ...
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_INVALID_ARGUMENT).append(LOG_MSG_VALUE).append(value);
    ...
    public String getValue(String tag) throws IController.NotSupportedException {
        ...
        if (appValue == null) {
            ...
            STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_ILLEGAL_SETTING).append(LOG_MSG_VALUE).append(getPFValue(tag));
            Log.w(TAG, STRBUILD.toString());
