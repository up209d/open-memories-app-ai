...
public class ExposureModeDialView extends SubMenuView {
    ...
    private void initialize() {
        ...
        setGravity(3);
        setPadding(0, 0, 0, 0);
        setLayoutAttributes(PreparingPlayState.TRANSIT_TO_SHOOTING, CENTER_ICON_HEIGHT, -3, 69);
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new ViewGroup.LayoutParams(PreparingPlayState.TRANSIT_TO_SHOOTING, CENTER_ICON_HEIGHT);
    }
