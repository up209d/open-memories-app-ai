...
public class EKey implements ICustomKey {
    ...
    protected static void initTable() {
        ...
        if (table == null) {
            ...
            p_keytable.append(AppRoot.USER_KEYCODE.UP, CustomizableFunction.Custom);
            ...
            a_keytable.append(AppRoot.USER_KEYCODE.UP, CustomizableFunction.Custom);
            ...
            s_keytable.append(AppRoot.USER_KEYCODE.UP, CustomizableFunction.Custom);
            ...
            m_keytable.append(AppRoot.USER_KEYCODE.UP, CustomizableFunction.Custom);
            ...
            other_keytable.append(AppRoot.USER_KEYCODE.UP, CustomizableFunction.Custom);
