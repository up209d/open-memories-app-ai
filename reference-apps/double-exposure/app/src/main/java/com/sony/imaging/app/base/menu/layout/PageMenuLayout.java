...
public class PageMenuLayout extends DisplayMenuItemsMenuLayout {
    ...
    protected void updateListViewItems(ArrayList<String> itemIds) {
        ...
        while (i$.hasNext()) {
            ...
            item.value = null;
            if (!"ApplicationSettings".equals(itemId) && !ThemeSelectionController.THEMESELECTION.equals(itemId) && (curItemValueId = this.mItemListService.getCurrentValue(itemId)) != null) {
