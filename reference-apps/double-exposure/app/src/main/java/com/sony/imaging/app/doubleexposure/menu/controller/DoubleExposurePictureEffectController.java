...
public class DoubleExposurePictureEffectController extends PictureEffectController {
    private static final String TAG = AppLog.getClassName();
    private static DoubleExposurePictureEffectController sInstance = null;

    private DoubleExposurePictureEffectController() {
    }

    public static DoubleExposurePictureEffectController getInstance() {
        if (sInstance == null) {
            sInstance = new DoubleExposurePictureEffectController();
        }
        return sInstance;
    }
