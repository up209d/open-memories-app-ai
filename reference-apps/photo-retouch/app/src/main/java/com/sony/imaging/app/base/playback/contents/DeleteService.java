...
public class DeleteService extends EditServiceImpl {
    ...
    private static final int SELECTABLE_COUNT = 100;
    ...
    private DeleteService(int selectableCount, int notifyProgressInterval) {
    ...
    protected synchronized int processContents(ContentsIdentifier id) {
        boolean result;
        Log.d(TAG, LogHelper.getScratchBuilder(MSG_EXECUTING_DELETION).append(id.data).append(LogHelper.MSG_COMMA).append(id._id).toString());
