...
public class MiniatureEffectView extends SimulatingEERelativeLayout {
    ...
    static {
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 827));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL169 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 111, Constant.TRANSITION_INDEXPB, 411));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 350, Constant.TRANSITION_INDEXPB, 650));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, AppRoot.USER_KEYCODE.SLIDE_AEL_FOCUS_CHANGED, Constant.TRANSITION_INDEXPB, 889));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL43 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 827));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_LEFT, new Rect(135, 0, 416, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_VCENTER, new Rect(360, 0, AppRoot.USER_KEYCODE.WATER_HOUSING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_RIGHT, new Rect(584, 0, 865, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL11 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 827));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(19, 0, 393, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_VCENTER, new Rect(313, 0, 687, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_RIGHT, new Rect(AppRoot.USER_KEYCODE.FEL, 0, 986, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL_COMMON = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 825));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL_COMMON = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 825));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL32 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 136, Constant.TRANSITION_INDEXPB, 416));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 360, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.WATER_HOUSING));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 584, Constant.TRANSITION_INDEXPB, 864));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL169 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 67, Constant.TRANSITION_INDEXPB, 400));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 333, Constant.TRANSITION_INDEXPB, 667));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, AppRoot.USER_KEYCODE.FOCUS_MODE_DIAL_AF_S, Constant.TRANSITION_INDEXPB, 933));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL43 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 825));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL11 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, Constant.TRANSITION_INDEXPB, 425));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, Constant.TRANSITION_INDEXPB, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, Constant.TRANSITION_INDEXPB, 825));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(67, 0, 400, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_VCENTER, new Rect(333, 0, 667, Constant.TRANSITION_INDEXPB));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_RIGHT, new Rect(AppRoot.USER_KEYCODE.FOCUS_MODE_DIAL_AF_S, 0, 933, Constant.TRANSITION_INDEXPB));
