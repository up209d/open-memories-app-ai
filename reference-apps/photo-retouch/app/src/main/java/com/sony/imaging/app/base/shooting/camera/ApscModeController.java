...
public class ApscModeController extends AbstractController2<String> {
    ...
    public boolean isAvailable(String tag) {
        ...
        this.mStrBuilder.replace(0, this.mStrBuilder.length(), MSG_AVAIABLE).append(result);
    ...
    public String getPFValue(String tag) {
        ...
        this.mStrBuilder.replace(0, this.mStrBuilder.length(), MSG_GET_VALUE).append(MSG_TAG).append(tag).append(", ").append(MSG_VALUE).append(value);
        Log.d(TAG, this.mStrBuilder.toString());
        return value;
    }
    ...
    public void setValueToPF(String tag, String value) {
        this.mStrBuilder.replace(0, this.mStrBuilder.length(), MSG_SET_VALUE).append(MSG_TAG).append(tag).append(", ").append(MSG_VALUE).append(value);
        Log.d(TAG, this.mStrBuilder.toString());
