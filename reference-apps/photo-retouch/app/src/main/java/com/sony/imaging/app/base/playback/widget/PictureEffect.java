...
public class PictureEffect extends IconFileInfo {
    ...
    static {
        ...
        mDrawables.put(VAL_PICTUREEFFECT_MINIATURE_BOTTOM, 26);
        mDrawables.put(VAL_PICTUREEFFECT_MINIATURE_LEFT, 27);
        mDrawables.put(VAL_PICTUREEFFECT_MINIATURE_VERTICAL, 28);
        mDrawables.put(VAL_PICTUREEFFECT_MINIATURE_RIGHT, 29);
    ...
    public void setValue(int pictureEffectMode, int pictureEffectError) {
        ...
        switch (pictureEffectMode) {
            ...
            case 50:
            case VAL_PICTUREEFFECT_MINIATURE_BOTTOM /* 51 */:
            case VAL_PICTUREEFFECT_MINIATURE_LEFT /* 52 */:
            case VAL_PICTUREEFFECT_MINIATURE_VERTICAL /* 53 */:
            case VAL_PICTUREEFFECT_MINIATURE_RIGHT /* 54 */:
