...
public class EVFOffLayout extends Layout implements IModableLayout {
    ...
    public void onResume() {
        super.onResume();
        this.isToggled = true;
        onLayoutModeChanged(DisplayModeObserver.getInstance().getActiveDevice(), DisplayModeObserver.getInstance().getActiveDispMode(1));
        ...
        this.mDisplayManager.setDisplayStatusListener(new DisplayManager.DisplayEventListener() { // from class: com.sony.imaging.app.photoretouch.common.EVFOffLayout.1
    ...
    public void onPause() {
        ...
        onLayoutModeChanged(0, DisplayModeObserver.getInstance().getActiveDispMode(1));
    ...
    public boolean isFinder() {
        return 1 == DisplayModeObserver.getInstance().getActiveDevice();
    }
