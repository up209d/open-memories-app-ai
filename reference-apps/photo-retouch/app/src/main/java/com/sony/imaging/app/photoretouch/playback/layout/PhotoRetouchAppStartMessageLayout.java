...
public class PhotoRetouchAppStartMessageLayout extends Layout implements View.OnTouchListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View currentView = obtainViewFromPool(R.layout.message_app_start);
        TextView appName = (TextView) currentView.findViewById(R.id.AppName);
        appName.setText(R.string.STRID_FUNC_EZEDIT);
        TextView appDescription = (TextView) currentView.findViewById(R.id.AppDescription);
        appDescription.setText(R.string.STRID_FUNC_EZEDIT_PHOTO_SELECT_MSG);
        RelativeLayout messageLayout = (RelativeLayout) currentView.findViewById(R.id.MessageLayout);
        ...
        this.mRunnable = new Runnable() { // from class: com.sony.imaging.app.photoretouch.playback.layout.PhotoRetouchAppStartMessageLayout.1
            @Override // java.lang.Runnable
            public void run() {
                PhotoRetouchAppStartMessageLayout.this.closeLayout();
            }
        };
        return currentView;
    }
