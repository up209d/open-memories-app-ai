...
public class ShootingKeyHandlerBase extends BaseInvalidKeyHandler {
    ...
    protected String getKeyConvCategory() {
        ...
        if (ExposureModeController.SHUTTER_MODE.equals(expMode) || ExposureModeController.MOVIE_SHUTTER_MODE.equals(expMode)) {
    ...
    public int pushedModeSKey() {
        ExposureModeController.getInstance().setValue(ExposureModeController.EXPOSURE_MODE, ExposureModeController.SHUTTER_MODE);
        return 1;
    }

    @Override // com.sony.imaging.app.fw.BaseInvalidKeyHandler, com.sony.imaging.app.fw.BaseKeyHandler, com.sony.imaging.app.fw.IEachFunctionEventHandler
    public int pushedModeMKey() {
        ExposureModeController.getInstance().setValue(ExposureModeController.EXPOSURE_MODE, ExposureModeController.MANUAL_MODE);
        return 1;
    }
