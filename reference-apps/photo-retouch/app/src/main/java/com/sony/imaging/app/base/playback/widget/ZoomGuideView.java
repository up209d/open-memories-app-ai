...
public class ZoomGuideView extends RelativeLayout {
    ...
    private void fitVirtualRect() {
        ...
        if (VIRTUAL_RECT.width() / this.OrigThumW < VIRTUAL_RECT.height() / this.OrigThumH) {
            ...
            this.mThumBm = Bitmap.createScaledBitmap(this.mThumBm, FitLen, (int) (FitLen * (this.OrigThumH / this.OrigThumW)), DEBUG);
        } else {
            logcat("fit to heigth");
            int FitLen2 = VIRTUAL_RECT.height() - 8;
            this.mThumBm = Bitmap.createScaledBitmap(this.mThumBm, (int) (FitLen2 * (this.OrigThumW / this.OrigThumH)), FitLen2, DEBUG);
        }
    ...
    public void drawGuideRect(Rect rect) {
        ...
        this.mGuideRect.set((int) ((rect.left * this.guideScale) + 6.0f), (int) ((rect.top * this.guideScale) + 6.0f), (int) ((rect.right * this.guideScale) + 2.0f), (int) ((rect.bottom * this.guideScale) + 2.0f));
        invalidate();
