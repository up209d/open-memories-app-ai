...
public class SearchInfo {
    ...
    SearchInfo(int folderNumber, int fileNumber) {
        this.folderNumber = -1;
        this.fileNumber = -1;
    ...
    SearchInfo(int folderNumber, int fileNumber, String localDate, String utcDate, long localDateTime, long utcDateTime) {
