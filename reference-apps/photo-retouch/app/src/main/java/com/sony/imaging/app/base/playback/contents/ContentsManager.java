...
public class ContentsManager {
    ...
    static {
        SCALE_WIDE_PANEL_PIXEL.x = 0.75f;
    ...
    public int getInt(String tag) {
        if (checkViewMode()) {
            return this.mViewMode.getInt(tag);
        }
    ...
    public int getIntAt(int position, String tag) {
        if (checkViewMode()) {
            return this.mViewMode.getIntAt(position, tag);
        }
        return Integer.MIN_VALUE;
    }
    ...
    public int getIntOfGroupAt(int position, String tag) {
        if (checkViewMode()) {
            return this.mViewMode.getIntOfGroupAt(position, tag);
        }
        return Integer.MIN_VALUE;
    }
