...
public class NoFaceMessageLayout extends EVFOffLayout implements View.OnTouchListener {
    private final String TAG = NoFaceMessageLayout.class.getSimpleName();

    @Override // com.sony.imaging.app.fw.Layout, com.sony.imaging.app.fw.FakeFragment
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        View currentView = obtainViewFromPool(R.layout.no_face_alert);
        TextView textView = (TextView) currentView.findViewById(R.id.msg_alert);
        textView.setText(R.string.STRID_CAU_TARGET_DETECTED_ML);
