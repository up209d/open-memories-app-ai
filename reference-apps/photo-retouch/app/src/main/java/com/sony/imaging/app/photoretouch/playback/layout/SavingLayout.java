...
public class SavingLayout extends Layout implements View.OnTouchListener {
    @Override // com.sony.imaging.app.fw.Layout, com.sony.imaging.app.fw.FakeFragment
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreateView(inflater, container, savedInstanceState);
        View currentView = obtainViewFromPool(R.layout.message_single);
        TextView textview = (TextView) currentView.findViewById(R.id.message_single);
        textview.setText(R.string.STRID_COM_SAVING);
