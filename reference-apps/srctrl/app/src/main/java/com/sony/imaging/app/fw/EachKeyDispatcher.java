    ...
    public static int dispatchDownAction(IEachKeyHandler handler, KeyEvent event) {
        ...
        switch (code) {
            ...
            case AppRoot.USER_KEYCODE.FOCUS_HOLD /* 603 */:
                int ret36 = handler.onLensFocusHoldPushed(event);
                return ret36;
            ...
            case AppRoot.USER_KEYCODE.ISO /* 681 */:
                int ret80 = handler.onIsoKeyPushed(event);
                return ret80;
            default:
                return 0;
        }
    ...
    public static int dispatchUpAction(IEachKeyHandler handler, KeyEvent event) {
        ...
        switch (code) {
            ...
            case AppRoot.USER_KEYCODE.EV_COMPENSATION /* 602 */:
                ...
                return ret18;
            case AppRoot.USER_KEYCODE.FOCUS_HOLD /* 603 */:
                int ret19 = handler.onLensFocusHoldReleased(event);
                return ret19;
            case AppRoot.USER_KEYCODE.SMART_TELECON /* 606 */:
            ...
            case AppRoot.USER_KEYCODE.LENS_FOCUS_HOLD /* 653 */:
                ...
                return ret34;
            case AppRoot.USER_KEYCODE.ISO /* 681 */:
                int ret35 = handler.onIsoKeyReleased(event);
                return ret35;
            default:
                return 0;
        }
