...
public class ContentsManager {
    ...
    public static final int PB_MODE_MOVIE_PLAYBACK = 3;
    ...
    public ViewMode getViewModeInstance() {
        if (this.mViewMode != null) {
    ...
    public void requestUpdateData(boolean makeData) {
        ContentInfo info = getContentInfo(getContentsId());
        if (makeData && info != null) {
            info.makeData();
        }
        this.mObserver.setData(info);
    }
    ...
    public boolean requeryData(boolean doQuery) {
        if (!checkViewMode()) {
            return false;
        }
        boolean result = this.mViewMode.requeryData(doQuery);
    ...
    public static class HistogramData {
        ...
        public int[] yData = new int[128];
        public int[] rData = new int[128];
        public int[] gData = new int[128];
        public int[] bData = new int[128];
