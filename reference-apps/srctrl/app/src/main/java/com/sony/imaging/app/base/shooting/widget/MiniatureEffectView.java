...
public class MiniatureEffectView extends SimulatingEERelativeLayout {
    ...
    static {
        ...
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 111, SsdpDevice.RETRY_INTERVAL, 411));
        ...
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_LEFT, new Rect(135, 0, 416, SsdpDevice.RETRY_INTERVAL));
        ...
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, LiveviewCommon.HEADER_DATA_SIZE_MAX, SsdpDevice.RETRY_INTERVAL, 416));
        ...
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 67, SsdpDevice.RETRY_INTERVAL, 400));
        ...
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(67, 0, 400, SsdpDevice.RETRY_INTERVAL));
        ...
        GRADATION_COLOR = Color.argb(LiveviewCommon.PAYLOAD_HEADER_SIZE, 204, 204, 204);
    }
