...
public class WifiP2pManagerJb implements WifiP2pManagerFactory.IWifiP2pManager {
    ...
    private class SyncActionListener implements WifiP2pManager.ActionListener, SyncListener {
        ...
        @Override // com.sony.imaging.app.srctrl.network.wifiWrapper.WifiP2pManagerJb.SyncListener
    ...
    public WifiP2pManagerJb(Context context) {
        ...
        this._bReceiver = new BroadcastReceiver() { // from class: com.sony.imaging.app.srctrl.network.wifiWrapper.WifiP2pManagerJb.1
    ...
    @Override // com.sony.imaging.app.srctrl.network.wifiWrapper.WifiP2pManagerFactory.IWifiP2pManager
