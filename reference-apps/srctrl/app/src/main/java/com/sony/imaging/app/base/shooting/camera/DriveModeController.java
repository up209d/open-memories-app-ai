...
public class DriveModeController extends ShootingModeController {
    ...
    private NotificationListener mListener = new SilentChangedListener();
    ...
    public void setValue(String tag, String value) {
        ...
        if (DRIVEMODE.equals(tag) || SELF_TIMER.equals(tag) || SELF_TIMER_BURST.equals(tag) || BURST.equals(tag)) {
    ...
    public String getValue(String tag) {
        ...
        if (tag.equals(BURST)) {
            String speed_settingvalue = this.mBackupUtil.getPreferenceString(BaseBackUpKey.ID_DRIVE_MODE_BURST_SPEED, "");
            List<String> available = getAvailableValue(tag);
            if (available.isEmpty() || available.contains(speed_settingvalue)) {
                return speed_settingvalue;
            }
            String speed_actvalue = params.getBurstDriveSpeed();
            if (!isSupported(speed_actvalue)) {
                return speed_settingvalue;
            }
            return speed_actvalue;
        }
        if (FPS.equals(tag)) {
    ...
    public List<String> getSupportedValue(String tag, int mode) {
        ...
        } else if (tag.equals(SELF_TIMER) && !Environment.isNewBizDeviceActionCam()) {
    ...
    public boolean isSupported(String value, int mode) {
        ...
        if (SELF_TIMER.equals(value) && !Environment.isNewBizDeviceActionCam()) {
    ...
    public boolean isUnavailableSceneFactor(String tag) {
        if (DRIVEMODE.equals(tag)) {
            return isUnavailableAPISceneFactor(SET_DRIVE_MODE_FUNCTION, null, "setSelfTimer", null);
        }
    ...
    public boolean isAvailable(String value) {
        ...
        if (value == null || value.equals(DRIVEMODE)) {
            ...
            boolean ret2 = AvailableInfo.isAvailable(SET_DRIVE_MODE_FUNCTION, null, "setSelfTimer", null, SET_REMOTE_FUNCTION, null);
            return ret2;
        }
        if (FPS.equals(value)) {
        ...
        if (SELF.equals(value)) {
            if (Environment.isNewBizDeviceActionCam()) {
                return AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 2) && AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 10) && AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 0);
            }
            return false;
        }
        ...
        if (value.equals(SINGLE)) {
            boolean ret4 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, SINGLE, "setSelfTimer", 0);
            return ret4;
        }
        if (value.equals(BURST)) {
            if (Environment.isNewBizDeviceActionCam()) {
            ...
            boolean ret6 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, BURST, "setSelfTimer", 0);
            return ret6;
        }
        if (value.equals(SPEED_PRIORITY_BURST)) {
            boolean ret7 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, SPEED_PRIORITY_BURST, "setSelfTimer", 0);
            return ret7;
        }
        if (value.equals(SELF_TIMER)) {
            return AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, SINGLE, "setSelfTimer", 2) && AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, SINGLE, "setSelfTimer", 10);
        }
        if (value.equals(SELF_TIMER_BURST)) {
            return AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, BURST, "setSelfTimer", 2) && AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, SET_DRIVE_MODE_FUNCTION, BURST, "setSelfTimer", 10);
        }
        if (value.equals(SELF_TIMER_2S)) {
            boolean ret8 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 2);
            return ret8;
        }
        if (value.equals(SELF_TIMER_10S)) {
            boolean ret9 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 10);
            return ret9;
        }
        if (SELF_TIMER_OFF.equals(value)) {
            boolean ret10 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 0);
            return ret10;
        }
        if (value.equals(SELF_TIMER_BURST_10S_3SHOT)) {
            boolean ret11 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 10);
            return ret11;
        }
        if (value.equals(SELF_TIMER_BURST_10S_5SHOT)) {
            boolean ret12 = AvailableInfo.isAvailable((Camera.Parameters) p.first, (CameraEx.ParametersModifier) p.second, "setSelfTimer", 10);
            return ret12;
        }
        if (value.equals(BURST_SPEED_HIGH)) {
    ...
    public boolean isContShooting() {
        Pair<Camera.Parameters, CameraEx.ParametersModifier> p = this.mCamSet.getParameters();
        CameraEx.ParametersModifier params = (CameraEx.ParametersModifier) p.second;
        String drive = params.getDriveMode();
        return BURST.equals(drive) || SPEED_PRIORITY_BURST.equals(drive);
    }
    ...
    /* loaded from: classes.dex */
    private class SilentChangedListener implements NotificationListener {
        private final String[] tags;

        private SilentChangedListener() {
            this.tags = new String[]{CameraNotificationManager.SILENT_SHUTTER_SETTING_CHANGED};
        }
        ...
        public void onNotify(String tag) {
            if (DriveModeController.this.isContShooting()) {
                CameraNotificationManager.getInstance().requestNotify(CameraNotificationManager.DRIVE_MODE);
            }
        }
    }
