...
public final class Environment {
    ...
    private static boolean isBulbSupported() {
        if (bulbShootingNotSupportedModelName.contains(ScalarProperties.getString(UtilPFWorkaround.PROP_MODEL_NAME)) || ScalarProperties.getInt("ui.bulb.supported", 1) != 1) {
            return false;
        }
    ...
    private static boolean isCancelExposureSupported() {
        return (getVersionPfAPI() >= 6 && !"DSC-RX100M3".equals(ScalarProperties.getString(UtilPFWorkaround.PROP_MODEL_NAME))) || (ScalarProperties.getInt("ui.modification.patch.bits0") & 4) == 4;
    }
