...
public class DigitalZoomSettingView extends ActiveLayout {
    ...
    public void updateVisibility() {
        ...
        if (2 == this.mCameraSetting.getCurrentMode()) {
            ...
            if (supList != null && supList.contains(AntiHandBlurController.MOVIE_ACTIVE) && this.mCategory != 1 && this.mCategory != 0) {
    ...
    protected NotificationListener getNotificationListener() {
        if (this.mNotificationListener == null) {
            this.mNotificationListener = new NotificationListener() { // from class: com.sony.imaging.app.base.shooting.widget.DigitalZoomSettingView.1
                private final String[] tags = {CameraNotificationManager.ZOOM_INFO_CHANGED, CameraNotificationManager.REC_MODE_CHANGED, CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, "stopMovieRec"};
                ...
                public void onNotify(String tag) {
                    ...
                    if (CameraNotificationManager.REC_MODE_CHANGED.equals(tag) || CameraNotificationManager.MOVIE_REC_START_SUCCEEDED.equals(tag) || "stopMovieRec".equals(tag)) {
    ...
    private void updateDigitalZoomIconAndMagText() {
        if (this.mIsVisibleOnMovieRecording) {
            ...
            } else if ("digitalZoomModeNotSet".equals(digitalZoomStatus)) {
