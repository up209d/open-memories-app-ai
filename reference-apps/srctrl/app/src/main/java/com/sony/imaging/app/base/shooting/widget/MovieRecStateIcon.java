        ...
        if (this.mListener == null) {
            this.mListener = new ActiveLayout.ActiveLayoutListener() { // from class: com.sony.imaging.app.base.shooting.widget.MovieRecStateIcon.1
                ...
                public void onNotify(String tag) {
                    if (CameraNotificationManager.MOVIE_REC_START_SUCCEEDED.equals(tag) || CameraNotificationManager.MOVIE_REC_START_FAILED.equals(tag) || "stopMovieRec".equals(tag)) {
                ...
                public String[] addTags() {
                    return new String[]{CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, CameraNotificationManager.MOVIE_REC_START_FAILED, "stopMovieRec"};
                }
            };
        }
