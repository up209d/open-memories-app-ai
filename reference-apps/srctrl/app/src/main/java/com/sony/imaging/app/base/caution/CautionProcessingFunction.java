...
public class CautionProcessingFunction {
        ...
        if (cautionRsrc != null) {
            ...
            if (view != null) {
                ...
                if (cautionRsrc.time_out != 0) {
                    timeoutProcessing(cautionRsrc.time_out * SsdpDevice.RETRY_INTERVAL);
    ...
    public IKeyDispatch SpecilalKeyDispatcher(int cautionId) {
        switch (cautionId) {
            case 86:
            case LiveviewCommon.PAYLOAD_HEADER_SIZE /* 128 */:
    ...
    private String getStr(String strid) {
        ...
        int id = res.getIdentifier(strid, ResponseType.STRING, "android");
        if (id == 0) {
            id = res.getIdentifier(strid, ResponseType.STRING, packageName);
        }
        try {
