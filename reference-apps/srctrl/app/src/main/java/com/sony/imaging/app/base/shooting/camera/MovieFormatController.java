...
public class MovieFormatController extends AbstractController {
    ...
    public static String pfProfileToApp(String format, String bitrate, String framerate, String size, String aspect) {
        ...
        if ("MPEG4".equals(format)) {
            ...
            if (SRCtrlConstants.IMAGE_TYPE_SMALL.equals(size)) {
                return MP4_VGA;
            }
            ...
            if ("movie_format".equals(tag) || MOVIE_FORMAT_MENU.equals(tag)) {
                ...
                if (DatabaseManager.getInstance().isReady()) {
                    ...
                    for (String mode2 : supporteds) {
                        if (!isMovieAuto || (!XAVC_50M_100P.equals(mode2) && !XAVC_50M_120P.equals(mode2) && !XAVC_100M_120P.equals(mode2) && !XAVC_100M_100P.equals(mode2) && !XAVC_60M_120P.equals(mode2) && !XAVC_60M_100P.equals(mode2))) {
                    ...
                    for (String mode3 : supporteds) {
                        if (!isMovieAuto2 || (!XAVC_50M_100P.equals(mode3) && !XAVC_50M_120P.equals(mode3) && !XAVC_100M_120P.equals(mode3) && !XAVC_100M_100P.equals(mode3) && !XAVC_60M_120P.equals(mode3) && !XAVC_60M_100P.equals(mode3))) {
    ...
    public static boolean isPfIssueAvailable_HfrAndFace() {
        ...
        if (!"DSC-RX100M3".equals(ModelName) && !PfBugAvailability.DSCRX100M4.equals(ModelName) && !PfBugAvailability.DSCRX10M2.equals(ModelName) && !PfBugAvailability.ILCE7S.equals(ModelName) && !PfBugAvailability.ILCE7RM2.equals(ModelName)) {
            return false;
        }
        return true;
    }
