...
public class NwConfirmationLayout extends Layout {
    ...
    public void onResume() {
        ...
        ((TextView) getView().findViewById(R.id.nw_parts_message_1_txt)).setText(R.string.STRID_FUNC_SENDTOSMARTPHONE_MSG_CHANGEPW_ONE_DSLR);
