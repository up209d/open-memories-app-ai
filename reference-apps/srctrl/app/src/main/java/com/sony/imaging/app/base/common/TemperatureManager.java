...
public class TemperatureManager {
    ...
    private static final String COUNTDOWNINFO_CHANGED = "CountDownInfoListener Changed";
    ...
    private static boolean mDuringCountDown = false;
    private TemperatureCountDownInfoChangedListener mTemperatureCountDownInfoChangedListener = null;
    ...
    public void resume(Context c) {
        ...
        if (isTempCounDownSupportedPF()) {
            this.mTemperatureCountDownInfoChangedListener = new TemperatureCountDownInfoChangedListener();
            mTemp.setCountDownInfoListener(this.mTemperatureCountDownInfoChangedListener);
    ...
    public void pause(Context c) {
        ...
        if (isTempCounDownSupportedPF()) {
            ...
            this.mTemperatureCountDownInfoChangedListener = null;
        }
    ...
    public void updateCountDown() {
        if (1 != CameraSetting.getInstance().getCurrentMode()) {
            ...
            if (!isMovieRecording && this.countDownHandler.hasMessages(0)) {
                this.countDownHandler.removeCallbacks(this.countDownRunnable);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public class TemperatureCountDownInfoChangedListener implements Temperature.CountDownInfoListener {
        private TemperatureCountDownInfoChangedListener() {
        }

        public void onChanged(Temperature.CountDownInfo info) {
            Log.i(TemperatureManager.TAG, TemperatureManager.COUNTDOWNINFO_CHANGED);
            ...
            TemperatureManager.this.updateCountDown();
        }
    }
    ...
    public class RecStatusChangedListener implements NotificationListener {
        ...
        private RecStatusChangedListener() {
            this.tags = new String[]{CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, CameraNotificationManager.MOVIE_REC_START_FAILED, "stopMovieRec"};
        }
    ...
    public boolean isDuringCountDown() {
        return mDuringCountDown;
    }
}
