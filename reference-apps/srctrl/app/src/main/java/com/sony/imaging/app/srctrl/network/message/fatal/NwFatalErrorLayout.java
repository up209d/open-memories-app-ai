...
public class NwFatalErrorLayout extends Layout {
    ...
    public void onResume() {
        ...
        ((TextView) getView().findViewById(R.id.nw_parts_message_1_txt)).setText(R.string.STRID_CMN_MSG_UNFORESEEN_ERROR);
