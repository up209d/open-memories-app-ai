...
public class WifiP2pDeviceInfo implements Parcelable {
    public static final Parcelable.Creator<WifiP2pDeviceInfo> CREATOR = new Parcelable.Creator<WifiP2pDeviceInfo>() { // from class: com.sony.imaging.app.srctrl.network.wifiWrapper.WifiP2pDeviceInfo.1
