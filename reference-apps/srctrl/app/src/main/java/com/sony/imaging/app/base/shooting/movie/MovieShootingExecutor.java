...
public class MovieShootingExecutor extends BaseShootingExecutor {
    ...
    static /* synthetic */ StringBuilder access$1000() {
        return getStringBuilder();
    }
    ...
    static /* synthetic */ StringBuilder access$1500() {
        return getStringBuilder();
    }

    static /* synthetic */ StringBuilder access$1800() {
        return getStringBuilder();
    }
    ...
    static /* synthetic */ StringBuilder access$300() {
        return getStringBuilder();
    }

    static /* synthetic */ StringBuilder access$500() {
        return getStringBuilder();
    }
    ...
    protected static class MovieRecStartRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                StringBuilder builder = MovieShootingExecutor.access$100();
                builder.replace(0, builder.length(), "CAMERA :").append("startMovieRecExecutionError");
                Log.e(MovieShootingExecutor.TAG, builder.toString());
            }
        }
    }
    ...
    protected static class MovieRecStopRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                StringBuilder builder = MovieShootingExecutor.access$300();
                builder.replace(0, builder.length(), "CAMERA :").append("stopMovieRecExecutionError");
                Log.e(MovieShootingExecutor.TAG, builder.toString());
            }
        }
    }
    ...
    public static class RecStartedRunnable implements Runnable {
        ...
        public void run() {
            ...
            StringBuilder builder = MovieShootingExecutor.access$500();
            if (this.mIsSuccess) {
                MovieShootingExecutor.sNotify.requestNotify("startMovieRecSucceeded");
                builder.replace(0, builder.length(), "UI :").append("startMovieRecSucceeded");
            } else {
                MovieShootingExecutor.sNotify.requestNotify("startMovieRecFailed");
                builder.replace(0, builder.length(), "UI :").append("startMovieRecFailed");
            }
            Log.i(MovieShootingExecutor.TAG, builder.toString());
    ...
    public static class RecStoppedRunnable implements Runnable {
        ...
        public void run() {
            ...
            MovieShootingExecutor.sNotify.requestNotify("stopMovieRec");
            StringBuilder builder = MovieShootingExecutor.access$1000();
            builder.replace(0, builder.length(), "UI :").append("stopMovieRecMode");
            Log.i(MovieShootingExecutor.TAG, builder.toString());
            if (MovieShootingExecutor.sOnRecordListener != null) {
    ...
    public static class StreamWriteStartedRunnable implements Runnable {
        ...
        public void run() {
            ...
            StringBuilder builder = MovieShootingExecutor.access$1200();
            builder.replace(0, builder.length(), "UI :").append("startStreamWrite");
            Log.i(MovieShootingExecutor.TAG, builder.toString());
    ...
    public static class StreamWriteCompletedRunnable implements Runnable {
        ...
        public void run() {
            ...
            StringBuilder builder = MovieShootingExecutor.access$1500();
            builder.replace(0, builder.length(), "UI :").append("stopStreamWrite");
            Log.i(MovieShootingExecutor.TAG, builder.toString());
            if (MovieShootingExecutor.sOnStreamWriteListener != null) {
    ...
    public static class MovieRecErrorRunnable implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            StringBuilder builder = MovieShootingExecutor.access$1800();
            builder.replace(0, builder.length(), "UI :").append(MovieShootingExecutor.LOG_MOVIE_REC_ERROR);
            Log.i(MovieShootingExecutor.TAG, builder.toString());
    ...
    protected void myRelease() {
        ...
        if (true == sIsMovieRecording) {
            ...
            sNotify.requestNotify("stopMovieRec");
    ...
    protected static class MyMovieRecordingMediaChangeRunnable implements Runnable {
        ...
        @Override // java.lang.Runnable
        public void run() {
            StringBuilder builder = MovieShootingExecutor.access$2000();
            builder.replace(0, builder.length(), "CAMERA :").append(MovieShootingExecutor.LOG_ON_MOVIE_REC_MEDIA_CHANGE);
            Log.i(MovieShootingExecutor.TAG, builder.toString());
