    ...
    public static int dispatchDownAction(IEachFunctionEventHandler handler, KeyEvent event, IKeyFunction func) {
        ...
        if (CustomizableFunction.Unchanged.equals(func)) {
            ...
            try {
                ...
                switch (AnonymousClass1.$SwitchMap$com$sony$imaging$app$fw$CustomizableFunction[customizableFunc.ordinal()]) {
                    case 1:
                    ...
                    case 42:
                        ...
                        break;
                    case 43:
                        ret = handler.pushedFocusHoldCustomKey();
                        break;
                    ...
                    case 48:
                        ...
                        break;
                    default:
                        StringBuilder mBuilder = sStringBuilder.get();
            ...
            try {
                ...
                StringBuilder mBuilder2 = sStringBuilder.get();
                Log.w(TAG, mBuilder2.replace(0, mBuilder2.length(), MSG_UNKNOWN_FUNC).append(customizableFunc2.getType()).append(", ").append(customizableFunc2.name()).toString());
                ret = handler.pushedInvalidCustomKey(func);
        ...
        try {
            ...
            switch (customizableFunc) {
                ...
                case AfMfHold:
                    ...
                    return ret7;
                case FocusHold:
                    int ret8 = handler.releasedFocusHoldCustomKey();
                    return ret8;
                case IRShutterNotCheckDrivemode:
                    int ret9 = handler.releasedIRShutterNotCheckDrivemodeKey();
                    return ret9;
                case Unchanged:
                    int ret10 = onEventKeyUp(handler, event);
                    return ret10;
                default:
                    int ret11 = onEventKeyUp(handler, event);
                    return ret11;
            }
        } catch (ClassCastException e) {
            return -1;
    ...
    protected static int onEventKeyDown(IEachFunctionEventHandler handler, KeyEvent event) {
        ...
        switch (scanCode) {
            ...
            case AppRoot.USER_KEYCODE.EV_COMPENSATION /* 602 */:
                ...
                return ret35;
            case AppRoot.USER_KEYCODE.FOCUS_HOLD /* 603 */:
                int ret36 = handler.pushedLensFocusHold();
                return ret36;
            ...
            case AppRoot.USER_KEYCODE.LENS_APERTURE_RING_RIGHT /* 651 */:
                int ret72 = handler.turnedLensApertureRingToRight();
                return ret72;
            case AppRoot.USER_KEYCODE.LENS_APERTURE_RING_LEFT /* 652 */:
                int ret73 = handler.turnedLensApertureRingToLeft();
                return ret73;
            case AppRoot.USER_KEYCODE.LENS_FOCUS_HOLD /* 653 */:
                int ret74 = handler.pushedLensFocusHold();
                return ret74;
            case AppRoot.USER_KEYCODE.LENS_PARTS_STATE /* 654 */:
                int ret75 = handler.changedLensPartsState();
                return ret75;
            case AppRoot.USER_KEYCODE.LENS_PARTS_OPERATION /* 655 */:
                int ret76 = handler.operatedLensParts();
                return ret76;
            case AppRoot.USER_KEYCODE.IR_TC_RESET /* 656 */:
                int ret77 = handler.pushedIRTcResetKey();
                return ret77;
            case AppRoot.USER_KEYCODE.WIFI /* 657 */:
                int ret78 = handler.pushedWiFiKey();
                return ret78;
            case AppRoot.USER_KEYCODE.RESET /* 658 */:
                int ret79 = handler.pushedResetKey();
                return ret79;
            case AppRoot.USER_KEYCODE.ISO /* 681 */:
                int ret80 = handler.pushedIsoKey();
                return ret80;
            default:
                return -1;
        }
    ...
    protected static int onEventKeyUp(IEachFunctionEventHandler handler, KeyEvent event) {
        ...
        switch (scanCode) {
            ...
            case AppRoot.USER_KEYCODE.EV_COMPENSATION /* 602 */:
                ...
                return ret18;
            case AppRoot.USER_KEYCODE.FOCUS_HOLD /* 603 */:
                int ret19 = handler.releasedLensFocusHold();
                return ret19;
            case AppRoot.USER_KEYCODE.SMART_TELECON /* 606 */:
            ...
            case AppRoot.USER_KEYCODE.UM_S2 /* 615 */:
                ...
                return ret27;
            case AppRoot.USER_KEYCODE.UM_MOVIE_REC /* 616 */:
                int ret28 = handler.releasedUmRemoteRecKey();
                return ret28;
            case AppRoot.USER_KEYCODE.CUSTOM1 /* 622 */:
                int ret29 = handler.releasedCustom1Key();
                return ret29;
            case AppRoot.USER_KEYCODE.CUSTOM2 /* 623 */:
                int ret30 = handler.releasedCustom2Key();
                return ret30;
            case AppRoot.USER_KEYCODE.PREVIEW /* 632 */:
                int ret31 = handler.releasedPreviewKey();
                return ret31;
            case AppRoot.USER_KEYCODE.AF_MF_AEL /* 638 */:
                int ret32 = handler.releasedAfMfAelKey();
                return ret32;
            case AppRoot.USER_KEYCODE.WATER_HOUSING /* 640 */:
                int ret33 = handler.detachedWaterHousing();
                return ret33;
            case AppRoot.USER_KEYCODE.LENS_FOCUS_HOLD /* 653 */:
                int ret34 = handler.releasedLensFocusHold();
                return ret34;
            case AppRoot.USER_KEYCODE.ISO /* 681 */:
                int ret35 = handler.releasedIsoKey();
                return ret35;
            default:
                return -1;
        }
