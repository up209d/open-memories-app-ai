...
import com.sony.mexi.orb.service.camera.v1_2.SmartRemoteControlServiceBase;
...
public class SRCtrlServlet extends SmartRemoteControlServiceBase {
    ...
    @Override // com.sony.mexi.orb.service.camera.v1_2.SmartRemoteControlServiceBase
        ...
        try {
            try {
                ...
                try {
                    ...
                    Log.v(TAG, "---> " + methodName + " 1.2 (isPolling=" + isPolling + LogHelper.MSG_CLOSE_BRACKET);
                    ...
                    if (ServerEventHandler.Status.SUCCESS.equals(status)) {
                        ...
                        GetEventTriggeredErrorParams triggeredError = adapter.getTriggeredError(isPolling);
                        ...
                        GetEventContShootingModeParams contShootingMode = adapter.getContShootingMode(isPolling);
                        GetEventContShootingSpeedParams contShootingSpeed = adapter.getContShootingSpeed(isPolling);
                        GetEventZoomSettingParams zoomSetting = adapter.getEventZoomSettingParams(isPolling);
                        GetEventContShootingParams contShooting = adapter.getContShootingParams(isPolling);
                        GetEventBatteryInfoParams batteryInfo = adapter.getEventBatteryInfoParams(isPolling);
                        GetEventRecordingTimeParams recordingTime = adapter.getEventRecordingTimeParams(isPolling);
                        GetEventNumberOfShotsParams numberOfShots = adapter.getEventNumberOfShotsParams(isPolling);
                        printGetEventData(availableApiList, cameraStatus, zoomInformation, liveviewStatus, null, takePicture, continuousError, triggeredError, null, null, storageInformation, null, cameraFunction, null, null, cameraFunctionResult, null, null, exposureMode, postviewImageSize, selfTimer, shootMode, null, null, null, exposureCompensation, flashMode, fNumber, focusMode, isoSpeedRate, null, programShift, shutterSpeed, whiteBalance, touchAFPosition, focusStatus, zoomSetting, null, contShootingMode, contShootingSpeed, contShooting, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, batteryInfo, recordingTime, numberOfShots, null);
