...
public abstract class ShootingExecutor extends BaseShootingExecutor {
    ...
    protected static Queue<Runnable> sQueue = null;
    ...
    private static CameraEx.MotionShotResultListener sMotionshotResultCb = null;
    ...
    public static class MyShutterCb implements CameraEx.ShutterListener {
        ...
        public void onShutter(int status, CameraEx cameraEx) {
            ...
            ShootingExecutor.sQueue = new LinkedList();
        }
    }
    ...
    public static void setMotionShotResultListener(CameraEx.MotionShotResultListener listener) {
        sMotionshotResultCb = listener;
    }
    ...
    public static class MotionShotCompleteRunnable implements Runnable {
        ...
        public void run() {
            ...
            if (ShootingExecutor.sMotionshotResultCb != null) {
                ShootingExecutor.sMotionshotResultCb.onCompleted(this.mResult, this.mCameraEx);
            }
        }
    }
