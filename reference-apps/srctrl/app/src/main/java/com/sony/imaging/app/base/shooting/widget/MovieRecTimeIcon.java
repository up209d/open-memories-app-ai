...
public class MovieRecTimeIcon extends ActiveText {
    ...
    public class NotificationListener extends ActiveText.ActiveTextListener {
        ...
        private NotificationListener() {
            super();
            this.tags = new String[]{CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, CameraNotificationManager.MOVIE_REC_START_FAILED, "stopMovieRec", CameraNotificationManager.MOVIE_REC_TIME_CHANGED};
        }
        ...
        public void onNotify(String tag) {
            if (tag.equals(CameraNotificationManager.MOVIE_REC_START_SUCCEEDED) || tag.equals(CameraNotificationManager.MOVIE_REC_START_FAILED) || tag.equals("stopMovieRec")) {
