...
public class FnMenuLayout extends DisplayMenuItemsMenuLayout {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (columnNum == 6) {
            ...
            for (int i2 = 0; i2 < rowNum; i2++) {
                ...
                int topMargin2 = topMargin + (i2 * 60);
    ...
    private class FnItemAdapter extends ArrayAdapter<Item> {
        ...
        private View obtainInflatedIcon(int position) {
            ...
            ret.setLayoutParams(new LinearLayout.LayoutParams(70, 60));
            return ret;
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null || !(convertView instanceof LinearLayout)) {
                ...
                AbsListView.LayoutParams lp = new AbsListView.LayoutParams(105, 60);
            ...
            if (inflatedView instanceof ImageView) {
                ...
                iv2.setAlpha(item.valid ? BatteryIcon.BATTERY_STATUS_CHARGING : LiveviewCommon.PAYLOAD_HEADER_SIZE);
            } else if (inflatedView instanceof ActiveLayout) {
                ActiveLayout al = (ActiveLayout) inflatedView;
                al.setAlpha(item.valid ? BatteryIcon.BATTERY_STATUS_CHARGING : LiveviewCommon.PAYLOAD_HEADER_SIZE);
            }
