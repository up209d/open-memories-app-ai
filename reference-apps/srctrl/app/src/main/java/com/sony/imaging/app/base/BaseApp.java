...
public abstract class BaseApp extends AppRoot {
    ...
    private static final String VERSION = "Release_20160531_02";
    ...
    public BaseApp() {
        Log.i(TAG, "BaseApp version Release_20160531_02");
    ...
    /* loaded from: classes.dex */
    public static class BootIdleHandler implements MessageQueue.IdleHandler {
