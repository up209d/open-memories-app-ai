...
public class ZoomBar extends RelativeLayoutGroupOneByN {
        ...
        switch (this.mDispPattern) {
            ...
            case 1:
                if (100 == DigitalZoomController.getInstance().getMaxDigitalZoomMagnification(DigitalZoomController.DIGITAL_ZOOM_TYPE_PRECISION)) {
                    ...
                    point = calcIndicatorPositionBySingle(IntervalRecExecutor.INTVL_REC_INITIALIZED, 0, this.mDigitalZoomController.getDigitalZoomPosition() + this.mDigitalZoomController.getOpticalZoomPosition(), available_length - (margin * 2));
                    break;
                }
            case 2:
    ...
    private class ZoomListener implements NotificationListener {
        ...
        private ZoomListener() {
            this.tags = new String[]{CameraNotificationManager.FOCAL_LENGTH_CHANGED, CameraNotificationManager.DEVICE_LENS_CHANGED, CameraNotificationManager.POWER_ZOOM_CHANGED, CameraNotificationManager.ZOOM_INFO_CHANGED, CameraNotificationManager.DIGITAL_ZOOM_MODE_CHANGED};
        }
        ...
        public void onNotify(String tag) {
            ...
            } else if (CameraNotificationManager.DIGITAL_ZOOM_MODE_CHANGED.equals(tag)) {
                ZoomBar.this.mIsEnableFocalLength = true;
                ZoomBar.this.mIsEnableDigitalZoom = true;
                ZoomBar.this.updateDisplayPattern();
            }
