...
public class RestartingLayout extends Layout {
    private static AnimationDrawable aDrawable;
    ViewTreeObserver.OnGlobalLayoutListener listener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.sony.imaging.app.srctrl.network.progress.restarting.RestartingLayout.1
        @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
        public void onGlobalLayout() {
            RestartingLayout.aDrawable.start();
        }
    };
    ...
    public void onResume() {
        ...
        ((TextView) getView().findViewById(R.id.nw_parts_prog_5_txt)).setText(R.string.STRID_AMC_STR_01176);
        ...
        if (guide != null) {
            guide.setData(new FooterGuideDataResId(getActivity(), 17042388, 17042388));
        }
