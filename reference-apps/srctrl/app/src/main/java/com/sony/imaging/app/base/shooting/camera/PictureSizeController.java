    ...
    public static class PictureSizeData {
        ...
        private void setArrayListProp(HashMap<String, Float> map) {
            for (String key : map.keySet()) {
                String[] strAry = key.split(SRCtrlConstants.URI_CONTENT_ID_SEPARATOR);
        ...
        private HashMap<String, Float> duplicateDataDelete(List<Camera.Size> sizelist) {
            ...
            for (int i = 0; i < num; i++) {
                ...
                String key = Integer.toString(sizelist.get(i).width) + SRCtrlConstants.URI_CONTENT_ID_SEPARATOR + sizelist.get(i).height;
