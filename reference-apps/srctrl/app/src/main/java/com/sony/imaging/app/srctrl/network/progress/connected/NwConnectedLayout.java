...
public class NwConnectedLayout extends Layout {
    private static AnimationDrawable aDrawable;
    ViewTreeObserver.OnGlobalLayoutListener listener = new ViewTreeObserver.OnGlobalLayoutListener() { // from class: com.sony.imaging.app.srctrl.network.progress.connected.NwConnectedLayout.1
        @Override // android.view.ViewTreeObserver.OnGlobalLayoutListener
        public void onGlobalLayout() {
            NwConnectedLayout.aDrawable.start();
        }
    };
    ...
    public void onResume() {
        ...
        if (guide != null) {
            if (7 < Environment.getVersionPfAPI()) {
                ...
                guide.setData(new FooterGuideDataResId(getActivity(), R.string.STRID_FUNC_FOOTER_GUIDE_ENTER_HELP, R.string.STRID_FUNC_FOOTER_GUIDE_HELP_FOR_SK));
            }
        }
