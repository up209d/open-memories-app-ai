...
public class WhiteBalanceController extends AbstractController {
    ...
    private final String API_NAME_WB = Name.SET_WHITEBALANCE;
    ...
    private boolean setWBOption(Pair<Camera.Parameters, CameraEx.ParametersModifier> p, WhiteBalanceParam option) {
        ...
        if ((COLOR_TEMP.equals(mode) || temperatureSetting != null) && temperatureSetting.contains(String.valueOf(option.colorTemp))) {
    ...
    public boolean isAvailable(String tag) {
        ...
        boolean ret = AvailableInfo.isAvailable(Name.SET_WHITEBALANCE, null);
        return ret;
    }
    ...
    public List<String> getAvailableValue(String tag) {
        ...
        String api_name2 = "";
        if (tag.startsWith(WHITEBALANCE)) {
            api_name = Name.SET_WHITEBALANCE;
    ...
    public boolean isUnavailableSceneFactor(String tag) {
        if (WHITEBALANCE.equals(tag)) {
            return isUnavailableAPISceneFactor(Name.SET_WHITEBALANCE, null);
        }
        StringBuilder builder = StringBuilderThreadLocal.getScratchBuilder();
        Log.w(TAG, builder.replace(0, tag.length(), tag).append(LOG_INVALID_TAG).append(Name.SET_WHITEBALANCE).toString());
