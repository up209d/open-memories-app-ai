...
public final class ExpandedProductResultParser extends ResultParser {
    ...
    public ExpandedProductParsedResult parse(Result result) {
        ...
        while (i < rawText.length()) {
            ...
            } else if (ISOSensitivityController.ISO_3200.equals(ai) || "3201".equals(ai) || "3202".equals(ai) || "3203".equals(ai) || "3204".equals(ai) || "3205".equals(ai) || "3206".equals(ai) || "3207".equals(ai) || "3208".equals(ai) || "3209".equals(ai)) {
                weight = value;
