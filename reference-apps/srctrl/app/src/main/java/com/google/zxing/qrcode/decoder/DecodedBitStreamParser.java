...
final class DecodedBitStreamParser {
    ...
    private static void decodeHanziSegment(BitSource bits, StringBuilder result, int count) throws FormatException {
        ...
        while (count > 0) {
            ...
            buffer[offset] = (byte) ((assembledTwoBytes2 >> 8) & BatteryIcon.BATTERY_STATUS_CHARGING);
            buffer[offset + 1] = (byte) (assembledTwoBytes2 & BatteryIcon.BATTERY_STATUS_CHARGING);
            offset += 2;
            count--;
        }
        try {
    ...
    private static int parseECIValue(BitSource bits) throws FormatException {
        ...
        if ((firstByte & LiveviewCommon.PAYLOAD_HEADER_SIZE) == 0) {
