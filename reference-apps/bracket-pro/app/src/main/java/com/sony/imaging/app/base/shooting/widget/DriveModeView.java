...
public class DriveModeView extends ActiveImage {
    ...
    protected boolean isVisible() {
        List<String> supported = DriveModeController.getInstance().getSupportedValue(DriveModeController.DRIVEMODE);
        return (supported == null || supported.size() <= 0 || DriveModeController.getInstance().isUnavailableSceneFactor(DriveModeController.DRIVEMODE)) ? false : true;
    }
