...
public class ExposureCompensationIcon extends ActiveImage {
    ...
    static {
        ...
        RESID_DICTIONARY_EV_COMP.put("7", Integer.valueOf(R.drawable.stat_sys_upload_anim5));
        RESID_DICTIONARY_EV_COMP.put("5", Integer.valueOf(R.drawable.stat_sys_upload_anim4));
        RESID_DICTIONARY_EV_COMP.put("3", Integer.valueOf(R.drawable.stat_sys_upload_anim1));
        RESID_DICTIONARY_EV_COMP.put(ISOSensitivityController.ISO_AUTO, Integer.valueOf(R.drawable.ic_dialog_alert_material));
