...
public class BMExecutorCreator extends ExecutorCreator {
    private NormalBurstExecutor mNormalBurstExecutor = new NormalBurstExecutor();
    private BMCaptureProcess mBMCaptureProcess = new BMCaptureProcess();
    ...
    protected void settingBeforeInitialized() {
        ...
        if (!emc.isValidValue(expMode) && !ModeDialDetector.hasModeDial()) {
