...
public class EditServiceImpl extends EditService {
    ...
    protected static final int KIND_END = 8194;
    protected static final int KIND_PROGRESS = 8193;
    ...
    protected SelectionList mList;
    protected int mNotifyProgressInterval;
    protected int mSelectableCount;
    protected boolean mIsCancelled = false;
    protected boolean[] mIsGroupChecked = null;
    protected Thread mProcessingThread = null;
    protected Handler mHandler = new Handler() { // from class: com.sony.imaging.app.base.playback.contents.EditServiceImpl.1
    ...
    public int selectGroup(boolean selectIt) {
        ...
        Log.d(TAG, LogHelper.getScratchBuilder(Integer.toString(list.size())).append(", ").append(selectingCount).toString());
