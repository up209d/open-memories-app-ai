...
public class ExposureModeController extends AbstractController {
    ...
    private static void initDictionary() {
        ...
        EXPOSURE_MODE_DICTIONARY.put(PROGRAM_AUTO_MODE, BracketMasterSubMenu.PROGRAM_AUTO);
        EXPOSURE_MODE_DICTIONARY.put("Aperture", BracketMasterSubMenu.APERTURE_PRIORITY);
        EXPOSURE_MODE_DICTIONARY.put("Shutter", BracketMasterSubMenu.SHUTTER_SPEED);
        EXPOSURE_MODE_DICTIONARY.put(MANUAL_MODE, BracketMasterSubMenu.MANUAL_EXPOSURE);
        ...
        if (isUiMovieMainFeature()) {
            ...
            EXPOSURE_MODE_DICTIONARY.put(MOVIE_PROGRAM_AUTO_MODE, BracketMasterSubMenu.PROGRAM_AUTO);
            EXPOSURE_MODE_DICTIONARY.put(MOVIE_APERATURE_MODE, BracketMasterSubMenu.APERTURE_PRIORITY);
            EXPOSURE_MODE_DICTIONARY.put(MOVIE_SHUTTER_MODE, BracketMasterSubMenu.SHUTTER_SPEED);
            EXPOSURE_MODE_DICTIONARY.put(MOVIE_MANUAL_MODE, BracketMasterSubMenu.MANUAL_EXPOSURE);
        ...
        MOVIE_SUB_MODE_DICTIONARY.put(MOVIE_PROGRAM_AUTO_MODE, BracketMasterSubMenu.PROGRAM_AUTO);
        MOVIE_SUB_MODE_DICTIONARY.put(MOVIE_APERATURE_MODE, BracketMasterSubMenu.APERTURE_PRIORITY);
        MOVIE_SUB_MODE_DICTIONARY.put(MOVIE_SHUTTER_MODE, BracketMasterSubMenu.SHUTTER_SPEED);
        MOVIE_SUB_MODE_DICTIONARY.put(MOVIE_MANUAL_MODE, BracketMasterSubMenu.MANUAL_EXPOSURE);
    ...
    public void setValue(String tag, String value) {
        ...
        if (mode != null) {
            ...
            if (!mode.equals(BracketMasterSubMenu.PROGRAM_AUTO) && !ExecutorCreator.getInstance().isRecordingModeChanging()) {
            ...
            if (isMovieInhibitted) {
                ...
                ((Camera.Parameters) params2.first).setSceneMode(BracketMasterSubMenu.PROGRAM_AUTO);
