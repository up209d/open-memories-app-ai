...
public class ExposureAndMeteredManualView extends DigitView {
    ...
    void setValue(float value) {
        ...
        if (value < SmoothReflectionConstants.INVALID_APERTURE_VALUE) {
            ...
            displayValue = value > SmoothReflectionConstants.INVALID_APERTURE_VALUE ? String.format(this.FORMAT_FOR_PLUS, Integer.valueOf(((int) value) / 1), Integer.valueOf(((int) (value * 10.0f)) % 10)) : "" + String.format(this.FORMAT_FOR_ZERO, Float.valueOf(value));
        }
