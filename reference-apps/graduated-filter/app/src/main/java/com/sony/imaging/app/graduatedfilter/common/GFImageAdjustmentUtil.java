...
import com.sony.imaging.app.graduatedfilter.sa.PRESA;
...
public class GFImageAdjustmentUtil {
    ...
    public void updateAdjustmentPreview() {
        ...
        mEffectRunnable = new Runnable() { // from class: com.sony.imaging.app.graduatedfilter.common.GFImageAdjustmentUtil.1
