...
public class TouchLessShutterController extends AbstractController {
    ...
    private static final String mAddonPath = "/data/data/com.sony.imaging.app.touchlessshutter";
    private static boolean mHasAddOn;
    ...
    public void checkTouchLessAddOn() {
        File addOnDir = new File(mAddonPath);
        mHasAddOn = FileHelper.exists(addOnDir);
        AppLog.info(TAG, "hasTouchLessAddOn: " + mHasAddOn);
    }
