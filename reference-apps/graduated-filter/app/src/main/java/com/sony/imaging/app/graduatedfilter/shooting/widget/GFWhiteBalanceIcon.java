...
public class GFWhiteBalanceIcon extends ActiveLayout {
    ...
    protected NotificationListener getNotificationListener() {
        if (this.mListener == null) {
            this.mListener = new ActiveLayout.ActiveLayoutListener() { // from class: com.sony.imaging.app.graduatedfilter.shooting.widget.GFWhiteBalanceIcon.1
    ...
    protected void refresh() {
        ...
        String[] optArray = GFEffectParameters.getInstance().getParameters().getWBOption(false).split("/");
