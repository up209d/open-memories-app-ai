...
import com.sony.imaging.app.graduatedfilter.caution.GFCautionLayout;
...
import com.sony.imaging.app.graduatedfilter.menu.layout.GFExposureCompensationMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFExposureMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFExposureModeMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFlashCompensationMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFn15LayerCreativeStyleLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFn15LayerExposureCompensationLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFn15LayerFlashCompensationLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFn15LayerMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFn15LayerWhiteBalanceLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFnMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFFocusModeSpecialScreenMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFGuideLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFISOFn15LayerMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFISOSpecialScreenMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFIntroductionLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFPageMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFSetMenuLayout;
...
import com.sony.imaging.app.graduatedfilter.menu.layout.GFSpecialScreenMenuLayout;
import com.sony.imaging.app.graduatedfilter.menu.layout.GFThemeSelectionLayout;
...
import com.sony.imaging.app.graduatedfilter.playback.browser.GFBrowserIndex;
import com.sony.imaging.app.graduatedfilter.playback.browser.GFBrowserSingle;
import com.sony.imaging.app.graduatedfilter.playback.delete.multiple.DeleteMultiple;
import com.sony.imaging.app.graduatedfilter.playback.delete.multiple.DeleteMultipleConfirm;
import com.sony.imaging.app.graduatedfilter.playback.delete.multiple.DeleteMultipleExecutor;
import com.sony.imaging.app.graduatedfilter.playback.delete.multiple.DeleteMultipleIndex;
import com.sony.imaging.app.graduatedfilter.playback.delete.multiple.DeleteMultipleSingle;
import com.sony.imaging.app.graduatedfilter.playback.layout.DeleteMultipleConfirmLayout;
import com.sony.imaging.app.graduatedfilter.playback.layout.DeleteMultipleIndexLayout;
import com.sony.imaging.app.graduatedfilter.playback.layout.DeleteMultipleProcessingLayout;
import com.sony.imaging.app.graduatedfilter.playback.layout.DeleteMultipleSingleLayout;
...
import com.sony.imaging.app.graduatedfilter.shooting.GFForceSettingState;
import com.sony.imaging.app.graduatedfilter.shooting.layout.BlackMuteLayout;
import com.sony.imaging.app.graduatedfilter.shooting.layout.GFAdjustmentLayout;
import com.sony.imaging.app.graduatedfilter.shooting.layout.GFPreviewLayout;
import com.sony.imaging.app.graduatedfilter.shooting.layout.GFProcessingLayout;
import com.sony.imaging.app.graduatedfilter.shooting.layout.GFS1OffLayout;
import com.sony.imaging.app.graduatedfilter.shooting.layout.GFStableLayout;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFAdjustmentState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFEEState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFNormalCaptureState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFProcessingState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFS1OffEEState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFS1OnEEState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFShootingMenuState;
import com.sony.imaging.app.graduatedfilter.shooting.state.GFShootingState;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFAdjustmentStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFCaptureStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFCustomWhiteBalanceExposureKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFDevelopmentStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFEEStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFProcessingStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFS1OffEEStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFS1OnEEStateKeyHandler;
import com.sony.imaging.app.graduatedfilter.shooting.trigger.GFShootingStateKeyHandler;
...
public class Factory extends com.sony.imaging.app.fw.Factory {
    ...
    public static class MenuLayoutFactory extends LayoutFactory {
        @Override // com.sony.imaging.app.fw.LayoutFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add("ID_THEMESELECTIONLAYOUT", GFThemeSelectionLayout.class);
            ...
            add(GFExposureMenuLayout.MENU_ID, GFExposureMenuLayout.class);
            Factory.add(GFExposureMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(GFGuideLayout.ID_GFGUIDELAYOUT, GFGuideLayout.class);
            add("ID_GFINTRODUCTIONLAYOUT", GFIntroductionLayout.class);
    ...
    public static class EachPlaybackStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            add(GFPlayRoot.ID_DELETE_MULTIPLE, DeleteMultiple.class);
    ...
    public static class EachBrowserFactory extends StateFactory {
        ...
        public void init() {
            ...
            Factory.add(GFBrowserSingle.class, PbFunctionCommonFactory.class, EachBrowserSingleLayoutFactory.class, null);
            add(PlaySubApp.ID_INDEX_PB, GFBrowserIndex.class);
            Factory.add(GFBrowserIndex.class, PbFunctionCommonFactory.class, EachBrowserIndexLayoutFactory.class, null);
        }
    }
