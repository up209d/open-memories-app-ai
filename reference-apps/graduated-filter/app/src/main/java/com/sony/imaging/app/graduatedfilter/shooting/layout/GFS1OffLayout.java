...
public class GFS1OffLayout extends S1OffLayout {
    ...
    protected int getLayout(int device, int dispmode) {
        if (1 == Environment.getVersionOfHW()) {
            return R.layout.gf_shooting_main_skguide_dispon_for_eview_emount;
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mDialTvAv = (ImageView) currentView.findViewById(R.id.dial_tvav);
        mFuncTvAv = (ImageView) currentView.findViewById(R.id.func_tvav);
    ...
    private void disappearButtonView() {
        ...
        if (this.myRunnable == null) {
            this.myRunnable = new Runnable() { // from class: com.sony.imaging.app.graduatedfilter.shooting.layout.GFS1OffLayout.1
    ...
    public void setButtonVisibility(int visiblity) {
        if (!GFExposureModeController.getInstance().getValue(null).equalsIgnoreCase(ExposureModeController.PROGRAM_AUTO_MODE)) {
            mDialTvAv.setVisibility(visiblity);
            mFuncTvAv.setVisibility(visiblity);
        } else {
    ...
    protected void detachView() {
        createView();
        mDialTvAv = (ImageView) this.mMainView.findViewById(R.id.dial_tvav);
        mFuncTvAv = (ImageView) this.mMainView.findViewById(R.id.func_tvav);
