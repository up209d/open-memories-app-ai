...
public class CautionLayout extends Layout {
    ...
    protected boolean mIsViewNull = false;
    ...
    public void onDestroyView() {
        super.onDestroyView();
        if (this.mIsViewNull && Environment.isNewBizDeviceActionCam() && Environment.hasSubLcd()) {
            SubLcdManager.getInstance().holdDrawing(SubLcdManager.HOLD_MODE.OFF_REDRAW_IF_REQUESTED);
        }
        this.mIsViewNull = false;
    }
    ...
    public void onPause() {
        this.cautionfunc.terminateView();
