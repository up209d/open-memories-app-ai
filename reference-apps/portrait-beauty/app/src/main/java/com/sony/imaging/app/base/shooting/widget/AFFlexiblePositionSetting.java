...
public class AFFlexiblePositionSetting extends AFFlexible implements IConvertibleKeyHandler {
    ...
    private static int[] PARAM_TABLE = {64, 90, 320, 240, 576, 390, 32, 30, 0, 0, AppRoot.USER_KEYCODE.WATER_HOUSING, CatchLightPlayBackLayout.mLayoutParams_faceZoom__height};
