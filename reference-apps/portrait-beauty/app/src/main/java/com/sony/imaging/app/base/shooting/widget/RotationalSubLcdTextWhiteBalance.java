...
public class RotationalSubLcdTextWhiteBalance extends RotationalSubLcdTextView {
    ...
    private void setMap() {
        ...
        mTextMap.put(PortraitBeautyConstants.THREE_SECOND_MILLIS, R.string.peerTtyModeOff);
        ...
        mTextMap.put(PortraitBeautyConstants.FOUR_SECOND_MILLIS, R.string.permdesc_accessNetworkConditions);
        ...
        mTextMap.put(PortraitBeautyConstants.FIVE_SECOND_MILLIS, R.string.permdesc_bindCarrierMessagingService);
        ...
        mTextMap.put(PortraitBeautyConstants.SIX_SECOND_MILLIS, R.string.permdesc_changeNetworkState);
        ...
        mTextMap.put(PortraitBeautyConstants.SEVEN_SECOND_MILLIS, R.string.permdesc_nfc);
        ...
        mTextMap.put(PortraitBeautyConstants.EIGHT_SECOND_MILLIS, R.string.permdesc_readSyncSettings);
        ...
        mTextMap.put(PortraitBeautyConstants.NINE_SECOND_MILLIS, R.string.permdesc_setAlarm);
