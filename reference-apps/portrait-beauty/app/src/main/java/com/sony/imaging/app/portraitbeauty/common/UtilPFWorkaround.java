...
public class UtilPFWorkaround {
    ...
    private static boolean isHighSpeedLensPowerOffWorkaroundNeeded() {
        ...
        boolean isDeviceHighSpeedLensPowerOff = DSCHX90V.equals(MODEL_NAME) || DSCWX500.equals(MODEL_NAME) || DSCRX100M4.equals(MODEL_NAME) || DSCRX10M2.equals(MODEL_NAME);
    ...
    public static void setVirtualMediaIds(boolean playAfterShoot) {
        ...
        if (ids != null && ids[0] != null) {
            ...
            boolean isVirtualMedia_PlayProblem_Occures = DSCHX90V.equals(MODEL_NAME) || DSCWX500.equals(MODEL_NAME) || DSCRX100M4.equals(MODEL_NAME) || DSCRX10M2.equals(MODEL_NAME) || ILCE7M2.equals(MODEL_NAME) || ILCE7RM2.equals(MODEL_NAME);
