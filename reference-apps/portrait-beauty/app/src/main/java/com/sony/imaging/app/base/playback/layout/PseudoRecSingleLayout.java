        ...
        if (this.data != null) {
            ...
            if (touchEventAutoReview != null) {
                ...
                if (action.equals(EventParcel.FLICK)) {
                    if (touchEventAutoReview.mVelocityX > PortraitBeautyConstants.INVALID_APERTURE_VALUE) {
                        previousContents();
                    } else if (touchEventAutoReview.mVelocityX < PortraitBeautyConstants.INVALID_APERTURE_VALUE) {
                        nextContents();
                    }
                } else if (action.equals(EventParcel.SCROLL)) {
                    if (touchEventAutoReview.mDistanceX > PortraitBeautyConstants.INVALID_APERTURE_VALUE) {
                        previousContents();
                    } else if (touchEventAutoReview.mDistanceX < PortraitBeautyConstants.INVALID_APERTURE_VALUE) {
                        nextContents();
                    }
                }
    ...
    public boolean onTouchUp(MotionEvent e, boolean isReleasedInside) {
        ...
        if (isReleasedInside) {
            ...
            if (displayMode == 5) {
                ...
                EventParcel touch = new EventParcel(null, e, null, isReleasedInside, PortraitBeautyConstants.INVALID_APERTURE_VALUE, PortraitBeautyConstants.INVALID_APERTURE_VALUE, PortraitBeautyConstants.INVALID_APERTURE_VALUE, PortraitBeautyConstants.INVALID_APERTURE_VALUE, viewRect);
