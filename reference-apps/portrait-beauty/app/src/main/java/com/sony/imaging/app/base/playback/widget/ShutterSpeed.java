    ...
    public void setValue(int exposureTimeNumer, int exposureTimeDenom) {
        ...
        if (exposureTimeNumer > 0 && exposureTimeDenom > 0) {
            ...
            if (exposureTime4Disp * 100.0f >= 40.0f) {
                ...
                } else if (1000 > exposureTimeDeci_int && exposureTimeDeci_int >= 0 && 10 > exposureTimeDeci_point && exposureTimeDeci_point >= 0) {
            ...
            } else if (PortraitBeautyConstants.INVALID_APERTURE_VALUE < exposureTime4Disp * 100.0f && exposureTime4Disp * 100.0f < 40.0f) {
