...
public class DeleteMultipleSingleLayout extends SelectorSingleLayout {
    ...
    protected int getLayoutResource() {
        int device = PortraitBeautyPlayDisplayModeObserver.getInstance().getActiveDevice();
        int displayMode = PortraitBeautyPlayDisplayModeObserver.getInstance().getActiveDispMode(1);
        if (device == 0) {
