...
public class DeleteMultipleIndexLayout extends SelectorIndexLayout {
    ...
    protected int getLayoutResource() {
        int aspect = PortraitBeautyPlayDisplayModeObserver.getInstance().getOsdAspect(0);
    ...
    protected int getScalableLayoutId() {
        DisplayManager.DeviceInfo info = PortraitBeautyPlayDisplayModeObserver.getInstance().getDeviceInfo(0);
        if (2 == info.aspect) {
