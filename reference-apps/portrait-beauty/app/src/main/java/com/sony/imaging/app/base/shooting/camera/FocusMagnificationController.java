...
public class FocusMagnificationController extends ShootingModeController {
    ...
    public int getTimeoutDurationInSettings() {
        ...
        int result = ((CameraEx.ParametersModifier) this.mCamSet.getParameters().second).getPreviewMagnificationTimeOnManualFocus() * 1000;
        StringBuilder builder = StringBuilderThreadLocal.getScratchBuilder();
    ...
    protected Pair<Float, Float> getDistancePerUnitStep() {
        ...
        if (lowestRatio == 0) {
            frame = Pair.create(Float.valueOf(PortraitBeautyConstants.INVALID_APERTURE_VALUE), Float.valueOf(PortraitBeautyConstants.INVALID_APERTURE_VALUE));
        } else {
    ...
    protected Pair<Integer, Integer> movePositionInDigitalZoom() {
        ...
        float currentPosiX = PortraitBeautyConstants.INVALID_APERTURE_VALUE;
        float currentPosiY = PortraitBeautyConstants.INVALID_APERTURE_VALUE;
        ...
        if (this.mCamSet.mChangeZoomRatio) {
            ...
            if (movePositionCenter) {
                currentPosiX = PortraitBeautyConstants.INVALID_APERTURE_VALUE;
                currentPosiY = PortraitBeautyConstants.INVALID_APERTURE_VALUE;
            }
        }
