...
public class SubMenuArea extends RelativeLayout implements GestureDetector.OnGestureListener {
    ...
    private void initView() {
        ...
        RelativeLayout.LayoutParams params2 = new RelativeLayout.LayoutParams(ALPHAVIEW_WIDTH, 480);
    ...
    private boolean isFocusArea(MotionEvent ev) {
        return ev.getX() > PortraitBeautyConstants.INVALID_APERTURE_VALUE && ev.getX() < 100.0f && ev.getY() > 174.0f && ev.getY() < 306.0f;
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (ev.getAction() & BatteryIcon.BATTERY_STATUS_CHARGING) {
            case 0:
                if (isFocusArea(ev)) {
