...
import com.sony.imaging.app.portraitbeauty.common.UtilPFWorkaround;
...
public class MovieFormatController extends AbstractController {
    ...
    public static boolean isPfIssueAvailable_HfrAndFace() {
        ...
        if (!"DSC-RX100M3".equals(ModelName) && !UtilPFWorkaround.DSCRX100M4.equals(ModelName) && !UtilPFWorkaround.DSCRX10M2.equals(ModelName) && !UtilPFWorkaround.ILCE7S.equals(ModelName) && !UtilPFWorkaround.ILCE7RM2.equals(ModelName)) {
            return false;
        }
        return true;
    }
