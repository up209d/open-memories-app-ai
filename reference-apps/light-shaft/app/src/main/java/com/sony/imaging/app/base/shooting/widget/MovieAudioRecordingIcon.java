...
public class MovieAudioRecordingIcon extends ActiveImage {
    ...
    public void refresh() {
        ...
        if (Environment.isMovieAPISupported()) {
            ...
            if (this.mAudioParameters != null && this.mAudioParameters.getMicrophoneEnable() && "on".equals(this.mAudioParameters.getMicrophoneWindNoiseReduction()) && 2 == ExecutorCreator.getInstance().getRecordingMode()) {
