...
public abstract class AbstractController implements IController {
    ...
    static {
        SCENE_MODE_FACTOR.put("program-auto", new String[]{"INH_FACTOR_CAM_SET_EXC_STILL_PROGRAM_MODE_STROBE_MANUAL_POPUP_DISABLE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_PROGRAM_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("aperture-priority", new String[]{"INH_FACTOR_CAM_SET_EXC_STILL_IRIS_MODE_STROBE_MANUAL_POPUP_DISABLE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_IRIS_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("shutter-speed", new String[]{"INH_FACTOR_CAM_SET_EXC_STILL_SHUTTER_MODE_STROBE_MANUAL_POPUP_DISABLE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_SHUTTER_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("manual-exposure", new String[]{"INH_FACTOR_CAM_SET_EXC_STILL_MANUAL_MODE_STROBE_MANUAL_POPUP_DISABLE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_MANUAL_MODE_TYPE_P"});
        ...
        SCENE_MODE_FACTOR.put("auto", new String[]{"INH_FACTOR_CAM_SET_EXC_STILL_AUTO2_MODE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_AUTO2_MODE_FOCUS_DIAL_TYPE_P", "INH_FACTOR_CAM_SET_EXC_STILL_AUTO2_MODE_BODY_PHASE_SHIFT_AF_TYPE_P"});
        ...
        SCENE_MODE_FACTOR.put("movieprogram-auto", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_PROGRAM_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("movieaperture-priority", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_IRIS_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("movieshutter-speed", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_SHUTTER_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("moviemanual-exposure", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_MANUAL_MODE_TYPE_P", "INH_FACTOR_CAM_SET_EXC_MOVIE_MANUAL_MODE_ISO_AUTO_TYPE_P"});
        SCENE_MODE_FACTOR.put("movieauto", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_AUTO2_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("movieportrait", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_PORTRAIT_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("movielandscape", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_LANDSCAPE_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("movienight", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_TWILIGHT_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("moviebeach", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_BEACH_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("moviesnow", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_SNOW_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("moviefireworks", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_FIREWORKS_MODE_TYPE_P"});
        SCENE_MODE_FACTOR.put("moviehigh-sensitivity", new String[]{"INH_FACTOR_CAM_SET_EXC_MOVIE_HIGH_SENSITIVITY_MODE_TYPE_P"});
