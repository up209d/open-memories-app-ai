...
public class CameraSetting implements CameraEx.ApertureChangeListener, CameraEx.ShutterSpeedChangeListener, CameraEx.AutoISOSensitivityListener, CameraEx.SettingChangedListener, CameraEx.ProgramLineRangeOverListener, CameraEx.FocusLightStateListener, CameraEx.EquipmentCallback, CameraEx.PreviewAnalizeListener, CameraEx.FlashEmittingListener, CameraEx.FocalLengthChangeListener, CameraEx.FaceDetectionListener, CameraEx.AutoSceneModeListener, CameraEx.ProgramLineListener, CameraEx.ErrorCallback {
    ...
    public static final int UNSTABLE = 255;
    ...
    static {
        ...
        SETTING_CHANGE_NOTIFY_TAGS.append(4, CameraNotificationManager.AE_LOCK_BUTTON);
        SETTING_CHANGE_NOTIFY_TAGS.append(8, "AutoFocusMode");
        SETTING_CHANGE_NOTIFY_TAGS.append(1, CameraNotificationManager.FACE_DETECTION_MODE);
        SETTING_CHANGE_NOTIFY_TAGS.append(3, CameraNotificationManager.FLASH_CHANGE);
        SETTING_CHANGE_NOTIFY_TAGS.append(2, CameraNotificationManager.FOCUS_CHANGE);
        SETTING_CHANGE_NOTIFY_TAGS.append(6, CameraNotificationManager.ISO_SENSITIVITY);
        SETTING_CHANGE_NOTIFY_TAGS.append(5, "MeteringMode");
        SETTING_CHANGE_NOTIFY_TAGS.append(9, CameraNotificationManager.SCENE_MODE);
        SETTING_CHANGE_NOTIFY_TAGS.append(7, CameraNotificationManager.AUTO_FOCUS_AREA);
        SETTING_CHANGE_NOTIFY_TAGS.append(11, CameraNotificationManager.DRIVE_MODE);
        SETTING_CHANGE_NOTIFY_TAGS.append(12, CameraNotificationManager.DRIVE_MODE);
        SETTING_CHANGE_NOTIFY_TAGS.append(13, CameraNotificationManager.DRIVE_MODE);
        if (1 <= getPfApiVersion()) {
            SETTING_CHANGE_NOTIFY_TAGS.append(15, CameraNotificationManager.ZOOM_MAX_MAG_CHANGED);
        }
        if (3 <= getPfApiVersion()) {
            SETTING_CHANGE_NOTIFY_TAGS.append(19, CameraNotificationManager.ANTI_HAND_BLUR);
        }
        if (3 <= getPfApiVersion()) {
            SETTING_CHANGE_NOTIFY_TAGS.append(22, CameraNotificationManager.ANTI_HAND_BLUR);
        }
        if (3 <= getPfApiVersion()) {
            SETTING_CHANGE_NOTIFY_TAGS.append(20, CameraNotificationManager.CINEMA_TONE_CHANGED);
        }
        if (6 <= getPfApiVersion()) {
            SETTING_CHANGE_NOTIFY_TAGS.append(23, CameraNotificationManager.NDFILTER_CHANGED);
        }
        AUDIO_SETTING_CHANGE_NOTIFY_TAGS = new SparseArray<>();
        if (MicRefLevelController.isSupportedByPF()) {
            AUDIO_SETTING_CHANGE_NOTIFY_TAGS.append(1, CameraNotificationManager.MIC_REF_LEVEL_CHANGED);
        }
    ...
    public void setCamera(CameraEx cameraEx) {
        this.mCurrentMode = ExecutorCreator.getInstance().getRecordingMode();
    ...
    public class BaseAudioSettingChangedListener implements AudioManager.SettingChangedListener {
        ...
        public void onChanged(int[] types, AudioManager.Parameters param, AudioManager am) {
            CameraSetting.this.mAudioParameters = CameraSetting.this.mAudioManager.getParameters();
            for (int type : types) {
                CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_SETTINGCHANGEDLISTENER_ONCHANGED).append(", ").append(CameraSetting.LOG_MSG_STATUS).append(Integer.toString(type));
                Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
                String tag = (String) CameraSetting.AUDIO_SETTING_CHANGE_NOTIFY_TAGS.get(type);
                if (tag != null) {
                    CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_SETTINGCHANGEDLISTENER_ONCHANGED).append(CameraSetting.LOG_MSG_TYPE).append(type).append(", ").append(CameraSetting.LOG_MSG_TAG).append(tag);
                    Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
                    CameraSetting.mNotify.requestNotify(tag);
                }
            }
        }
    }
    ...
    private boolean isShutterSpeedBulb() {
        Pair<Integer, Integer> ss = ((CameraEx.ParametersModifier) this.mCameraParams.second).getShutterSpeed();
    ...
    public void onApertureChange(CameraEx.ApertureInfo info, CameraEx camera) {
        ...
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_ONAPERTURECHANGED).append(Integer.toString(aperture));
    ...
    public float getMeteredManual() {
        ...
        STRBUILD_UI.replace(0, STRBUILD_UI.length(), LOG_MSG_GETEXPOSURECOMPENSATIONSTEP).append(step);
    ...
    public void onAERange(boolean ae, boolean ae_shut, boolean iris, CameraEx cam) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_ONAERANGE).append(LOG_MSG_ONAERANGE_AE).append(Boolean.toString(ae)).append(", ").append(LOG_MSG_ONAERANGE_AESHUT).append(Boolean.toString(ae_shut)).append(", ").append(LOG_MSG_ONAERANGE_IRIS).append(Boolean.toString(iris));
        Log.i(TAG, STRBUILD_CAMERA.toString());
        this.mAeErr = ae;
        this.mCameraParams = getCameraParameterPair();
    ...
    public void onEVRange(int er_level, CameraEx cam) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_ONEVRANGE_ER_LEVE).append(Integer.toString(er_level));
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onMeteringRange(boolean metering, CameraEx cam) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_ONMETERINGRANGE_METERING).append(Boolean.toString(metering));
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onChanged(int[] types, Camera.Parameters param, CameraEx cam) {
        this.mCameraParams = getCameraParameterPair();
        for (int type : types) {
            STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_SETTINGCHANGEDLISTENER_ONCHANGED).append(", ").append(LOG_MSG_STATUS).append(Integer.toString(type));
            Log.i(TAG, STRBUILD_CAMERA.toString());
            if (9 == type) {
                AbstractController.clearCache();
            }
            ...
            String tag = SETTING_CHANGE_NOTIFY_TAGS.get(type);
            if (tag != null) {
                STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_SETTINGCHANGEDLISTENER_ONCHANGED).append(LOG_MSG_TYPE).append(type).append(", ").append(LOG_MSG_TAG).append(tag);
                Log.i(TAG, STRBUILD_CAMERA.toString());
                if (type == 2) {
    ...
    public void onEquipmentChange(int deviceType, int status, CameraEx camera) {
        ...
        if (tag != null) {
            STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_EQUIPMENTCALLBACK_ONEQUIPMENTCHANGE).append(LOG_MSG_DEVICETYPE).append(Integer.toString(deviceType)).append(", ").append(LOG_MSG_STATUS).append(Integer.toString(status));
            Log.i(TAG, STRBUILD_CAMERA.toString());
            if (deviceType == 3) {
    ...
    public static class FlashChargingListener implements CameraEx.FlashChargingStateListener {
        ...
        public void onChanged(int state, CameraEx cam) {
            ...
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_FLASH_CHARGING).append(CameraSetting.LOG_MSG_STATUS).append(Integer.toString(state));
            Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public class PowerZoomListener implements CameraEx.PowerZoomListener {
        ...
        public void onChanged(int status, CameraEx cameraEx) {
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_POWER_ZOOM).append(CameraSetting.LOG_MSG_STATUS).append(Integer.toString(status));
            Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public void onChanged(boolean ready, boolean on, CameraEx cam) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_FOCUSLIGHTSTATELISTENER_ONCHANGED).append(LOG_MSG_READY).append(Boolean.toString(ready)).append(", ").append(LOG_MSG_ON).append(Boolean.toString(on));
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onError(int error, CameraEx cameraex) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_ERRORCALLBACK_ONERROR).append(LOG_MSG_ERROR).append(Integer.toString(error));
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onChanged(String mode, CameraEx cameraex) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_AUTOSCENEMODELISTENER_ONCHANGED).append(LOG_MSG_MODE).append(mode);
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onFaceDetected(FaceInfo[] faceinfos, CameraEx cameraex) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_FACEDETECTIONLISTENER_ONFACEDETECTED).append(LOG_MSG_FACEINFO);
        for (FaceInfo info : faceinfos) {
            STRBUILD_CAMERA.append(LOG_MSG_ROUND_BRACKET_L).append(LOG_MSG_ID).append(Integer.toString(info.id)).append(", ").append(LOG_MSG_SCORE).append(Integer.toString(info.score)).append(LOG_MSG_ROUND_BRACKET_R);
        }
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public void onFocalLengthChanged(int length, CameraEx cameraex) {
        STRBUILD_CAMERA.replace(0, STRBUILD_CAMERA.length(), LOG_MSG_FOCALLENGTHCHANGELISTENER_ONFOCALLENGTHCHANGED).append(LOG_MSG_LENGTH).append(length);
        Log.i(TAG, STRBUILD_CAMERA.toString());
    ...
    public CameraEx.LensInfo getLensInfo() {
        ...
        CameraEx.LensInfo info = this.mCameraEx.getLensInfo();
        return info;
    }
    ...
    private void createParameterComparatorList() {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.DRIVE_MODE) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.11
            /* JADX INFO: Access modifiers changed from: protected */
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<Integer>("ExposureCompensation") { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.12
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Object>(CameraNotificationManager.DRO_AUTO_HDR, 4) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.13
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
        ...
        ComparatorCommand remainingUpdateCommand = new ComparatorCommand() { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.14
        ...
        ComparatorCommand resetDigitalZoomOnStillChangedCommand = new ComparatorCommand() { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.15
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting.ComparatorCommand
            public void execute() {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<Camera.Size>(CameraNotificationManager.PICTURE_SIZE, remainingUpdateCommand) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.16
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
        ...
        if (1 <= getPfApiVersion()) {
            ...
            this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.PICTURE_SIZE, imgSizeChangeCommands) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.17
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
                public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
            ...
            this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.PICTURE_SIZE, remainingUpdateCommand) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.18
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
                public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Object>(CameraNotificationManager.PICTURE_QUALITY, imgQualityChangeCommands, 2) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.19
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
            protected /* bridge */ /* synthetic */ void getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> pair, List x1) {
                getValue2(pair, (List<Object>) x1);
            }
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Object>(CameraNotificationManager.WB_MODE_CHANGE) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.20
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
            protected /* bridge */ /* synthetic */ void getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> pair, List x1) {
                getValue2(pair, (List<Object>) x1);
            }
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Integer>(CameraNotificationManager.WB_DETAIL_CHANGE, 3) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.21
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
            protected /* bridge */ /* synthetic */ void getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> pair, List x1) {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.CREATIVE_STYLE_CHANGE) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.22
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
            public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Object>(CameraNotificationManager.PICTURE_EFFECT_CHANGE, 7) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.23
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
            protected /* bridge */ /* synthetic */ void getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> pair, List x1) {
                getValue2(pair, (List<Object>) x1);
            }
        ...
        if (1 <= getPfApiVersion()) {
            this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.APSC_MODE_CHANGED, remainingUpdateCommand) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.24
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
                public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<Pair<Integer, Integer>>(CameraNotificationManager.FOCUS_POINT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.25
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
        ...
        ComparatorCommand sceneUpdateCommand = new ComparatorCommand() { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.26
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting.ComparatorCommand
            public void execute() {
                AbstractController.clearCache();
            }
        };
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<String>(CameraNotificationManager.SCENE_MODE, sceneUpdateCommand) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.27
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
            public String getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
                String scene = ((Camera.Parameters) obj.first).getSceneMode();
                Log.e(CameraSetting.TAG, "scene: " + scene);
                return scene;
            }
        });
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderSimpleComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.28
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderListComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.29
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._ListComparator
        ...
        this.AUDIO_PARAMETER_COMPARATORS.add(new AudioSimpleComparator<String>(CameraNotificationManager.AUDIO_WIND_NR) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.30
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting._SimpleComparator
            public String getValue(AudioManager.Parameters obj) {
                return obj.getMicrophoneWindNoiseReduction();
            }
        });
    }
    ...
    public abstract class ParameterComparator<TP> {
        List<ComparatorCommand> mCommandList;
        ...
        public ParameterComparator(CameraSetting cameraSetting, String tag, ComparatorCommand command) throws NullPointerException {
            this(tag);
            this.mCommandList.add(command);
        }

        public ParameterComparator(CameraSetting cameraSetting, String tag, List<ComparatorCommand> commands) throws NullPointerException {
            this(tag);
        ...
        public final void compare(TP obj1, TP obj2) {
            if (obj1 != null || obj2 != null) {
                if ((obj1 == null && obj2 != null) || ((obj1 != null && obj2 == null) || isChanged(obj1, obj2))) {
                    CameraNotificationManager.getInstance().requestNotify(this.mNotificationTag);
                    if (!this.mCommandList.isEmpty()) {
                        for (ComparatorCommand command : this.mCommandList) {
                            command.execute();
                        }
                    }
                }
    ...
    /* loaded from: classes.dex */
    public abstract class _SimpleComparator<T, TP> extends ParameterComparator<TP> {
        ...
        public _SimpleComparator(String tag, ComparatorCommand command) {
            super(CameraSetting.this, tag, command);
        }

        public _SimpleComparator(String tag, List<ComparatorCommand> commands) {
            super(CameraSetting.this, tag, commands);
        }

        @Override // com.sony.imaging.app.base.shooting.camera.CameraSetting.ParameterComparator
        protected boolean isChanged(TP obj1, TP obj2) {
            ...
            Log.i(CameraSetting.TAG, "null is gotten " + getClass().getSimpleName());
            return value2 == null;
        }
    }

    /* loaded from: classes.dex */
    public abstract class SimpleComparator<T> extends _SimpleComparator<T, Pair<Camera.Parameters, CameraEx.ParametersModifier>> {
    ...
    /* loaded from: classes.dex */
    public abstract class RecorderSimpleComparator<T> extends _SimpleComparator<T, MediaRecorder.Parameters> {
    ...
    /* loaded from: classes.dex */
    public abstract class AudioSimpleComparator<T> extends _SimpleComparator<T, AudioManager.Parameters> {
        public AudioSimpleComparator(String tag) {
            super(tag);
        }

        public AudioSimpleComparator(String tag, ComparatorCommand command) {
            super(tag, command);
        }

        public AudioSimpleComparator(String tag, List<ComparatorCommand> commands) {
            super(tag, commands);
        }
    }

    /* loaded from: classes.dex */
    public abstract class _ListComparator<T, TP> extends ParameterComparator<TP> {
        ArrayList<T> mList1;
        ArrayList<T> mList2;
        ...
        public _ListComparator(String tag, ComparatorCommand command) {
            super(CameraSetting.this, tag, command);
            this.mList1 = new ArrayList<>();
            this.mList2 = new ArrayList<>();
        }

        public _ListComparator(String tag, List<ComparatorCommand> commands) {
            super(CameraSetting.this, tag, commands);
            this.mList1 = new ArrayList<>();
            this.mList2 = new ArrayList<>();
        }
        ...
        public _ListComparator(String tag, List<ComparatorCommand> commands, int capacity) {
            super(CameraSetting.this, tag, commands);
            this.mList1 = new ArrayList<>(capacity);
            this.mList2 = new ArrayList<>(capacity);
        }
    ...
    /* loaded from: classes.dex */
    public abstract class ListComparator<T> extends _ListComparator<T, Pair<Camera.Parameters, CameraEx.ParametersModifier>> {
    ...
    /* loaded from: classes.dex */
    public abstract class RecorderListComparator<T> extends _ListComparator<T, MediaRecorder.Parameters> {
    ...
    public void updateFocusMagnificationCoordinate() {
        if (1 <= getPfApiVersion() && this.mCameraEx != null && this.mFocusMagnificationRatio != 0) {
            ...
            STRBUILD_UI.replace(0, STRBUILD_UI.length(), LOG_MSG_UPDATE_FOCUS_MAGNIGICATION_POSITION).append(isReverse);
            Log.i(TAG, STRBUILD_UI.toString());
    ...
    public void startFocusMagnification(int ratio, Pair<Integer, Integer> position) {
        STRBUILD_UI.replace(0, STRBUILD_UI.length(), LOG_MSG_START_FOCUS_MAGNIGICATION).append(ratio).append(", ").append(LOG_MSG_ROUND_BRACKET_L).append(position.first).append(", ").append(position.second).append(LOG_MSG_ROUND_BRACKET_R);
    ...
    public class FocusMagnificationListener implements CameraEx.PreviewMagnificationListener {
        ...
        public void onChanged(boolean onoff, int mag, int magLevel, Pair<Integer, Integer> coordinates, CameraEx camex) {
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_FOCUS_MAGNIGICATION_CHANGED).append(onoff).append(", ").append(mag);
            if (coordinates != null) {
                CameraSetting.STRBUILD_CAMERA.append(CameraSetting.LOG_MSG_ROUND_BRACKET_L).append(coordinates.first).append(", ").append(coordinates.second).append(CameraSetting.LOG_MSG_ROUND_BRACKET_R);
            }
            Log.d(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
        ...
        public void onInfoUpdated(boolean focusRing, Pair<Integer, Integer> focusPos, CameraEx camex) {
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_FOCUS_RING_CHANGED).append(focusRing);
            if (focusPos != null) {
                CameraSetting.STRBUILD_CAMERA.append(CameraSetting.LOG_MSG_ROUND_BRACKET_L).append(focusPos.first).append(", ").append(focusPos.second).append(CameraSetting.LOG_MSG_ROUND_BRACKET_R);
            }
            Log.d(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public class FocusDriveListener implements CameraEx.FocusDriveListener {
        ...
        public void onChanged(CameraEx.FocusPosition pos, CameraEx cameraEx) {
            ...
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_FOCUS_DRIVE_ON_CHANGED).append(pos.currentPosition).append(CameraSetting.LOG_MSG_SLASH).append(pos.maxPosition);
            Log.d(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public class ApscModeListener implements CameraEx.AutoApscModeListener {
        ...
        public void onChanged(String mode, CameraEx cam) {
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_APSC_MODE_CHANGED).append(mode);
            Log.d(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public class ZoomInfoChangedListner implements CameraEx.ZoomChangeListener {
        ...
        public void onChanged(CameraEx.ZoomInfo zoomInfo, CameraEx cameraEx) {
            CameraSetting.STRBUILD_CAMERA.replace(0, CameraSetting.STRBUILD_CAMERA.length(), CameraSetting.LOG_MSG_ZOOMCHANGELISTENER_ONCHANGED);
            Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
    ...
    public class MovieRecErrorListener implements MediaRecorder.OnErrorListener {
        ...
        public void onError(int error, MediaRecorder mr) {
            ...
            CameraSetting.STRBUILD_UI.replace(0, CameraSetting.STRBUILD_UI.length(), CameraSetting.LOG_MSG_ON_ERROR_LISTENER).append(CameraSetting.LOG_MSG_ERROR).append(Integer.toString(CameraSetting.this.mMovieRecErrorFactor));
            Log.i(CameraSetting.TAG, CameraSetting.STRBUILD_CAMERA.toString());
