...
import com.sony.imaging.app.lightshaft.caution.LightShaftCautionLayout;
import com.sony.imaging.app.lightshaft.menu.layout.EffectSelectMenuLayout;
import com.sony.imaging.app.lightshaft.menu.layout.LastBastionMenuLayout;
import com.sony.imaging.app.lightshaft.menu.layout.LightShaftExposureModeSubMenuLayout;
import com.sony.imaging.app.lightshaft.menu.layout.LightSourceSettingLayout;
import com.sony.imaging.app.lightshaft.menu.layout.OptionSettingMenuLayout;
import com.sony.imaging.app.lightshaft.playback.LightShaftPlayRoot;
import com.sony.imaging.app.lightshaft.shooting.layout.LSS1OffLayout;
import com.sony.imaging.app.lightshaft.shooting.layout.LightShaftStableLayout;
import com.sony.imaging.app.lightshaft.shooting.state.LightShaftEEState;
import com.sony.imaging.app.lightshaft.shooting.state.LightShaftExposureModeCheckState;
import com.sony.imaging.app.lightshaft.shooting.state.LightShaftForceSettingState;
import com.sony.imaging.app.lightshaft.shooting.state.LightShaftShootingMenuState;
import com.sony.imaging.app.lightshaft.shooting.trigger.LSS1OffEEStateKeyHandler;
import com.sony.imaging.app.util.Environment;

/* loaded from: classes.dex */
public class LSFactory extends Factory {
    ...
    public static class RootStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(ShootingState.class, ShootingStateFactory.class, ShootingLayoutFactory.class, ShootingStateKeyHandler.class);
            add(BaseApp.APP_PLAY, LightShaftPlayRoot.class);
            LSFactory.add(LightShaftPlayRoot.class, PlaybackStateFactory.class, null, null);
            add(BaseApp.CAUTION, CautionFragment.class);
            LSFactory.add(CautionFragment.class, CautionStateFactory.class, null, null);
            add(BaseApp.EXIT_SCREEN, ExitScreenState.class);
            LSFactory.add(ExitScreenState.class, null, ExitScreenLayoutFactory.class, null);
            add(BaseApp.FORCE_EXIT_SCREEN, ForceExitScreenState.class);
            LSFactory.add(ForceExitScreenState.class, null, ForceExitScreenLayoutFactory.class, null);
        }
    }
    ...
    public static class CautionStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(CautionDisplayState.class, null, CautionLayoutFactory.class, null);
        }
    }
    ...
    public static class ShootingStateFactory extends StateFactory {
        @Override // com.sony.imaging.app.fw.StateFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add("FORCESETTING", LightShaftForceSettingState.class);
            LSFactory.add(LightShaftForceSettingState.class, null, null, null);
            add("ExposureModeCheck", LightShaftExposureModeCheckState.class);
            LSFactory.add(LightShaftExposureModeCheckState.class, null, null, null);
            add("EE", LightShaftEEState.class);
            LSFactory.add(LightShaftEEState.class, EEStateFactory.class, null, EEStateKeyHandler.class);
            add("Capture", CaptureState.class);
            LSFactory.add(CaptureState.class, CaptureStateFactory.class, null, CaptureStateKeyHandler.class);
            add("Development", DevelopmentState.class);
            LSFactory.add(DevelopmentState.class, DevelopmentStateFactory.class, DevelopmentLayoutFactory.class, DevelopmentStateKeyHandler.class);
            add(AutoReviewState.STATE_NAME, AutoReviewState.class);
            LSFactory.add(AutoReviewState.class, null, AutoReviewLayoutFactory.class, AutoReviewStateKeyHandler.class);
            add("AutoReviewForLimitedContShooting", AutoReviewForLimitedContShootingState.class);
            LSFactory.add(AutoReviewForLimitedContShootingState.class, null, AutoReviewForLimitedContShootingLayoutFactory.class, AutoReviewForLimitedContShootingStateKeyHandler.class);
            add("CustomWhiteBalance", CustomWhiteBalanceControllerState.class);
            LSFactory.add(CustomWhiteBalanceControllerState.class, CustomWhiteBalanceControllerStateFactory.class, null, null);
            if (Environment.isMovieAPISupported()) {
                add("MovieCapture", MovieCaptureState.class);
                LSFactory.add(MovieCaptureState.class, null, MovieLayoutFactory.class, MovieCaptureStateKeyHandler.class);
                add("MovieRec", MovieRecState.class);
                LSFactory.add(MovieRecState.class, MovieRecStateFactory.class, MovieLayoutFactory.class, MovieRecStateKeyHandler.class);
                add("MovieSave", MovieSaveState.class);
                LSFactory.add(MovieSaveState.class, null, MovieSaveLayoutFactory.class, MovieSaveStateKeyHandler.class);
            }
        }
    }
    ...
    public static class MovieRecStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(MovieMenuState.class, null, MenuLayoutFactory.class, null);
        }
    }
    ...
    public static class MovieLayoutFactory extends LayoutFactory {
        ...
        public void init() {
            add(StateBase.DEFAULT_LAYOUT, LightShaftStableLayout.class);
    ...
    public static class EEStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(S1OffEEState.class, null, S1OffEELayoutFactory.class, LSS1OffEEStateKeyHandler.class);
            add("S1OnEE", S1OnEEState.class);
            LSFactory.add(S1OnEEState.class, null, S1OnEELayoutFactory.class, S1OnEEStateKeyHandler.class);
            add("MfAssist", MfAssistState.class);
            LSFactory.add(MfAssistState.class, null, MfAssistLayoutFactory.class, MfAssistKeyHandler.class);
            add("FocusAdjustment", FocusAdjustmentState.class);
            LSFactory.add(FocusAdjustmentState.class, null, FocusAdjustmentFactory.class, FocusAdjustmentKeyHandler.class);
            add("MovieRecStandby", MovieRecStandbyState.class);
            LSFactory.add(MovieRecStandbyState.class, null, MovieLayoutFactory.class, MovieRecStandbyStateKeyHandler.class);
            add(ICustomKey.CATEGORY_MENU, LightShaftShootingMenuState.class);
            LSFactory.add(LightShaftShootingMenuState.class, null, MenuLayoutFactory.class, null);
        }
    }
    ...
    public static class CaptureStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(NormalCaptureState.class, null, null, null);
            add("SelfTimerCapture", SelfTimerCaptureState.class);
            LSFactory.add(SelfTimerCaptureState.class, null, SelfTimerCaptureLayoutFactory.class, SelfTimerCaptureStateKeyHandler.class);
        }
    }
    ...
    public static class CustomWhiteBalanceControllerStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(CustomWhiteBalanceEEState.class, null, CWBEELayoutFactory.class, CustomWhiteBalanceEEKeyHandler.class);
            add("CWBCapture", CustomWhiteBalanceCaptureState.class);
            LSFactory.add(CustomWhiteBalanceCaptureState.class, null, null, CustomWhiteBalanceCaptureKeyHandler.class);
            add("CWBExposure", CustomWhiteBalanceExposureState.class);
            LSFactory.add(CustomWhiteBalanceExposureState.class, null, CWBExposureLayoutFactory.class, CustomWhiteBalanceExposureKeyHandler.class);
        }
    }
    ...
    public static class CautionLayoutFactory extends LayoutFactory {
        @Override // com.sony.imaging.app.fw.LayoutFactory, com.sony.imaging.app.fw.BaseFactory
        public void init() {
            add("cautionLayout", LightShaftCautionLayout.class);
        }
    }
    ...
    public static class S1OffEELayoutFactory extends LayoutFactory {
        ...
        public void init() {
            add(StateBase.DEFAULT_LAYOUT, LightShaftStableLayout.class);
            add(StateBase.S1OFF_LAYOUT, LSS1OffLayout.class);
            add(StateBase.FOCUS_LAYOUT, FocusLayout.class);
    ...
    public static class PlaybackStateFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(Browser.class, BrowserFactory.class, null, null);
            add(PlayRootContainer.ID_PLAYZOOM, PlayZoom.class);
            LSFactory.add(PlayZoom.class, PlayZoomFactory.class, null, null);
            add(PlayRootContainer.ID_PSEUDOREC, PseudoRec.class);
            LSFactory.add(PseudoRec.class, PseudoRecFactory.class, null, null);
            add(PlayRootContainer.ID_PSEUDOREC_ZOOM, PseudoRecZoom.class);
            LSFactory.add(PseudoRecZoom.class, PseudoRecZoomFactory.class, null, null);
    ...
    public static class BrowserFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(BrowserSingle.class, PbFunctionCommonFactory.class, BrowserSingleLayoutFactory.class, null);
            add(PlaySubApp.ID_INDEX_PB, BrowserIndex.class);
            LSFactory.add(BrowserIndex.class, PbFunctionCommonFactory.class, BrowserIndexLayoutFactory.class, null);
        }
    }
    ...
    public static class PbFunctionCommonFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(DeleteSingle.class, DeleteSingleFactory.class, null, null);
        }
    }
    ...
    public static class DeleteSingleFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(DeleteSingleConfirm.class, null, DeleteSingleConfirmLayoutFactory.class, null);
            add(Editor.ID_EXECUTOR, DeleteSingleExecutor.class);
            LSFactory.add(DeleteSingleExecutor.class, null, DeleteSingleExecutorLayoutFactory.class, null);
            add(DeleteSingle.ID_FINALIZER, DeleteSingleFinalize.class);
            LSFactory.add(DeleteSingleFinalize.class, null, DeleteSingleFinalizeLayoutFactory.class, null);
        }
    }
    ...
    public static class PlayZoomFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(PlayZoomState.class, PbFunctionCommonFactory.class, PlayZoomStateLayoutFactory.class, null);
        }
    }
    ...
    public static class PseudoRecFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(PseudoRecSingle.class, null, PseudoRecSingleLayoutFactory.class, null);
        }
    }
    ...
    public static class PseudoRecZoomFactory extends StateFactory {
        ...
        public void init() {
            ...
            LSFactory.add(PseudoRecZoomState.class, null, PseudoRecZoomStateLayoutFactory.class, null);
        }
    }
    ...
    public static class MenuLayoutFactory extends LayoutFactory {
        ...
        public void init() {
            ...
            LSFactory.add(WhiteBalanceMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(WhiteBalanceAdjustmentMenuLayout.MENU_ID, WhiteBalanceAdjustmentMenuLayout.class);
            LSFactory.add(WhiteBalanceAdjustmentMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_FLASHCOMPENSATIONMENULAYOUT", FlashCompensationMenuLayout.class);
            LSFactory.add(FlashCompensationMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_AFFLEXIBLEPOSITIONMENULAYOUT", AFFlexiblePositionMenuLayout.class);
            LSFactory.add(AFFlexiblePositionMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_CREATIVESTYLEMENULAYOUT", CreativeStyleMenuLayout.class);
            LSFactory.add(CreativeStyleMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_AFLOCALPOSITIONMENULAYOUT", AFLocalPositionMenuLayout.class);
            LSFactory.add(AFLocalPositionMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            if (ExposureModeController.isMovieMainFeature()) {
                add(ExposureModeMenuLayout.MENU_ID, ExposureModeMenuMovieFeatureLayout.class);
                LSFactory.add(ExposureModeMenuMovieFeatureLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            } else {
                add(ExposureModeMenuLayout.MENU_ID, LightShaftExposureModeSubMenuLayout.class);
                LSFactory.add(LightShaftExposureModeSubMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            }
            add("ID_SCENESELECTIONMENULAYOUT", SceneSelectionMenuLayout.class);
            LSFactory.add(SceneSelectionMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_EXPOSURECOMPENSATIONMENULAYOUT", ExposureCompensationMenuLayout.class);
            LSFactory.add(ExposureCompensationMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_MOVIEMODEMENULAYOUT", MovieModeMenuLayout.class);
            LSFactory.add(MovieModeMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(UnknownItemMenuLayout.MENU_ID, UnknownItemMenuLayout.class);
            LSFactory.add(UnknownItemMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("LastBastionLayout", LastBastionMenuLayout.class);
            LSFactory.add(LastBastionMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(FnMenuLayout.MENU_ID, FnMenuLayout.class);
            LSFactory.add(FnMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(Fn15LayerMenuLayout.MENU_ID, Fn15LayerMenuLayout.class);
            LSFactory.add(Fn15LayerMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(SpecialScreenMenuLayout.MENU_ID, SpecialScreenMenuLayout.class);
            LSFactory.add(SpecialScreenMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(ISOSpecialScreenMenuLayout.MENU_ID, ISOSpecialScreenMenuLayout.class);
            LSFactory.add(ISOSpecialScreenMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(DigitalZoomSettingLayout.MENU_ID, DigitalZoomSettingLayout.class);
            LSFactory.add(DigitalZoomSettingLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(FocusModeSpecialScreenMenuLayout.MENU_ID, FocusModeSpecialScreenMenuLayout.class);
            LSFactory.add(FocusModeSpecialScreenMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(Fn15LayerExposureCompensationLayout.MENU_ID, Fn15LayerExposureCompensationLayout.class);
            LSFactory.add(Fn15LayerExposureCompensationLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(Fn15LayerFlashCompensationLayout.MENU_ID, Fn15LayerFlashCompensationLayout.class);
            LSFactory.add(Fn15LayerFlashCompensationLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(Fn15LayerCreativeStyleLayout.MENU_ID, Fn15LayerCreativeStyleLayout.class);
            LSFactory.add(Fn15LayerCreativeStyleLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(Fn15LayerWhiteBalanceLayout.MENU_ID, Fn15LayerWhiteBalanceLayout.class);
            LSFactory.add(Fn15LayerWhiteBalanceLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(ISOFn15LayerMenuLayout.MENU_ID, ISOFn15LayerMenuLayout.class);
            LSFactory.add(ISOFn15LayerMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(PageMenuLayout.MENU_ID, PageMenuLayout.class);
            LSFactory.add(PageMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(SetMenuLayout.MENU_ID, SetMenuLayout.class);
            LSFactory.add(SetMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add(SpecialScreenMenuLayoutHiddenEE.MENU_ID, SpecialScreenMenuLayoutHiddenEE.class);
            LSFactory.add(SpecialScreenMenuLayoutHiddenEE.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_EFFECTSELECTMENULAYOUT", EffectSelectMenuLayout.class);
            LSFactory.add(EffectSelectMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_LIGHTSOURCESETTINGLAYOUT", LightSourceSettingLayout.class);
            LSFactory.add(LightSourceSettingLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
            add("ID_OPTIONSETTINGMENULAYOUT", OptionSettingMenuLayout.class);
            LSFactory.add(OptionSettingMenuLayout.class, null, OneAnotherMenuLayoutFactory.class, null);
        }
    }
