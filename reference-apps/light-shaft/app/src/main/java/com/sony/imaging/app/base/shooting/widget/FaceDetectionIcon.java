...
public class FaceDetectionIcon extends ActiveImage {
    public static final int LAYOUT_REC_LEFTFN_6 = 367;
    ...
    public void onAttachedToWindow() {
        ...
        if (6 <= CameraSetting.getPfApiVersion() && NDfilterController.getInstance().getSupportedValueList() != null) {
            ViewGroup.MarginLayoutParams currentParams = (ViewGroup.MarginLayoutParams) getLayoutParams();
            currentParams.topMargin = LAYOUT_REC_LEFTFN_6;
