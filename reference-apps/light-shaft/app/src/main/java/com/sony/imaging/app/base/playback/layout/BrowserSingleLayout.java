...
public class BrowserSingleLayout extends SingleLayoutBase {
    ...
    public void onResume() {
        ...
        if (Environment.getVersionOfHW() == 1) {
            setFooterGuideData(new FooterGuideDataResId(getActivity(), 0, android.R.string.heavy_weight_notification_detail));
        }
    }
