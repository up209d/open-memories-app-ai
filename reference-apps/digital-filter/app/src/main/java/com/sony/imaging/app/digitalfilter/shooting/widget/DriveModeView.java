...
public class DriveModeView extends ActiveImage {
    ...
    public class NotificationListener extends ActiveImage.ActiveImageListener {
        ...
        private NotificationListener() {
            super();
            this.tags = new String[]{CameraNotificationManager.DRIVE_MODE, GFConstants.START_SELFTIMER, GFConstants.ENABLE_NEXT_CAPTURE, GFConstants.CANCELTAKEPICTURE};
        }
        ...
        public void onNotify(String tag) {
            if (CameraNotificationManager.DRIVE_MODE.equals(tag) || GFConstants.START_SELFTIMER.equals(tag) || GFConstants.ENABLE_NEXT_CAPTURE.equals(tag) || GFConstants.CANCELTAKEPICTURE.equals(tag)) {
    ...
    protected void refresh() {
        ...
        if (GFSelfTimerController.SELF_TIMER_ON.equalsIgnoreCase(value)) {
            ...
            resId = com.sony.imaging.app.digitalfilter.R.drawable.p_16_dd_parts_gf_timer_off;
        }
