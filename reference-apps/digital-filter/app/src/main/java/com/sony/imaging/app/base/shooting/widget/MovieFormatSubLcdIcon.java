...
public class MovieFormatSubLcdIcon extends ShootingSubLcdActiveIcon {
    private static final String[] ADD_NOTIFIER_TAGS = {CameraNotificationManager.MOVIE_FORMAT};

    public MovieFormatSubLcdIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected boolean isXavcS() {
        String setting = MovieFormatController.getInstance().getValue("movie_format");
        return MovieFormatController.XAVC_S.equals(setting) || MovieFormatController.XAVC_S_4K.equals(setting);
    }
    ...
    public class CustomActiveIconListener extends ShootingSubLcdActiveIcon.ActiveIconListener {
        ...
        public String[] addTags() {
            return MovieFormatSubLcdIcon.ADD_NOTIFIER_TAGS;
        }
    }
}
