...
public class GFWhiteBalanceAdjustmentMenuLayout extends WhiteBalanceAdjustmentMenuLayout {
    ...
    private static WhiteBalanceAdjustLayerAndArrowView mAdjustLayout = null;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mAdjustLayout = (WhiteBalanceAdjustLayerAndArrowView) currentView.findViewById(R.id.wb_adjust_layout);
        isCanceled = false;
    ...
    public void onResume() {
        ...
        super.onResume();
        if (isLand) {
            mTitle.setText(R.string.STRID_FUNC_DF_WB_ADJUST_LAND);
        } else if (isSky) {
            mTitle.setText(R.string.STRID_FUNC_DF_WB_ADJUST_SKY);
        } else if (isLayer3) {
            mTitle.setText(R.string.STRID_FUNC_SKYND_WB_ADJUSTMENT_LAYER3);
        }
        mAdjustLayout.setAlpha(0.66f);
    ...
    @Override // com.sony.imaging.app.base.menu.layout.WhiteBalanceAdjustmentMenuLayout, com.sony.imaging.app.base.menu.layout.DisplayMenuItemsMenuLayout, com.sony.imaging.app.base.menu.layout.BaseMenuLayout, com.sony.imaging.app.fw.Layout, com.sony.imaging.app.fw.FakeFragment
