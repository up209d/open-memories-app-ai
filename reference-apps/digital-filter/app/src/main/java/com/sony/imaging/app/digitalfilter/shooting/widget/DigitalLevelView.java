...
public class DigitalLevelView extends View {
    ...
    private static final float[] SIN = {0.0f, 0.017452406f, 0.034899496f, 0.052335955f, 0.06975647f, 0.087155744f, 0.104528464f, 0.12186934f, 0.1391731f, 0.15643446f, 0.17364818f, 0.190809f, 0.20791169f, 0.22495106f, 0.2419219f, 0.25881904f, 0.27563736f, 0.2923717f, 0.309017f, 0.32556814f, 0.34202015f};
    ...
    public DigitalLevelView(Context context, AttributeSet attrs) {
        ...
        this.mGyroListener = new NotificationListener() { // from class: com.sony.imaging.app.digitalfilter.shooting.widget.DigitalLevelView.1
    ...
    protected void onAttachedToWindow() {
        ...
        float[] values = (float[]) this.mGyroObserver.getValue(GyroscopeObserver.TAG_GYROSCOPE);
        if (values != null) {
            changeRad(values);
        }
        refresh();
