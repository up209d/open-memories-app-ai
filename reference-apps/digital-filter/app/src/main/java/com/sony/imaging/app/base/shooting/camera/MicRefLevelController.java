...
public class MicRefLevelController extends AbstractController {
    ...
    public void setValue(String tag, String value) {
        String value2;
        if (isSupportedByPF() && ExecutorCreator.getInstance().isCameraModeMovie() && (value2 = appToPf(value)) != null) {
    ...
    protected void createSupportedList() {
        ...
        if (sSupportedValued == null && (supportedParameters = AudioSetting.getInstance().getSupportedAudioParameters()) != null && (supported = supportedParameters.getSupportedMicrophoneReferenceLevels()) != null) {
    ...
    public boolean isAvailable(String tag) {
        if (!isSupportedByPF() || !ExecutorCreator.getInstance().isCameraModeMovie()) {
            return false;
        }
        AvailableInfo.update();
