...
public class TimelapseBatteryIcon extends BatteryIcon {
    static String[] tags = {BatteryObserver.TAG_LEVEL, BatteryObserver.TAG_PLUGGED, BatteryObserver.TAG_STATUS, GFConstants.PB_DISPLAY_MODE_KEY};
    ...
    public void onNotify(String tag) {
        ...
        int displayMode = BackUpUtil.getInstance().getPreferenceInt(GFConstants.PB_DISPLAY_MODE_KEY, 0);
