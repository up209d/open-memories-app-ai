...
public class NormalFunctionTable implements IFunctionTable {
    ...
    public NormalFunctionTable() {
        ...
        this.table.put(CustomizableFunction.ImageQuality, new FunctionInfo(-1, "setPictureStorageFormat", PictureQualityController.class));
        ...
        this.table.put(CustomizableFunction.IsoAutoMinSS, new FunctionInfo(-1, ISOAutoMinSSController.MENU_ITEM_ID_ISO_AUTO_MIN_SS, ISOAutoMinSSController.class));
