...
public class CameraNotificationManager extends NotificationManager {
    ...
    public static final String ISO_AUTO_MIN_SS_MODE = "ISOAutoMinSSMode";
    public static final String ISO_AUTO_MIN_SS_VALUE = "ISOAutoMinSSValue";
    ...
    public static final String ISO_SENSITIVITY_AUTO_MAX = "ISOSensitivityAutoMax";
    public static final String ISO_SENSITIVITY_AUTO_MIN = "ISOSensitivityAutoMin";
