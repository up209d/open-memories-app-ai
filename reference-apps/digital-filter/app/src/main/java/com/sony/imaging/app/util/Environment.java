...
public final class Environment {
    ...
    public static final int API_VERSION_SUPPORTING_BLUETOOTH = 15;
    public static final int API_VERSION_SUPPORTING_CANCEL_EXPOSURE = 6;
    ...
    public static final int API_VERSION_SUPPORTING_ISO_AUTO_MAX_MIN = 13;
    public static final int API_VERSION_SUPPORTING_ISO_AUTO_MIN_SHUT_SPEED = 13;
    public static final int API_VERSION_SUPPORTING_METERING_MODE_POINT = 17;
    public static final int API_VERSION_SUPPORTING_METERING_SPOT_SIZE = 17;
    ...
    public static final int API_VERSION_SUPPORTING_PROP_UI_BULB_SUPPORTED = 14;
    public static final int API_VERSION_SUPPORTING_RAW_REC_MODE = 15;
    public static final int API_VERSION_SUPPORTING_RECEIVE_GPSDATA = 16;
    public static final int API_VERSION_SUPPORTING_SILENT_SHUTER = 15;
    private static final int API_VERSION_SUPPORTING_TOUCH_OPERATION_VERSION_2 = 17;
    ...
    public static final int PATCH_BIT_CANCEL_EXPOSURE = 4;
    public static final int PATCH_BIT_RAW_REC_MODE = 8;
    public static final int PATCH_BIT_SILENT_SHUTER = 2;
    ...
    public static final int TOUCH_OPERATION_VERSION_1 = 1;
    public static final int TOUCH_OPERATION_VERSION_2 = 2;
    ...
    private static final List<String> bulbShootingNotSupportedModelName = Collections.unmodifiableList(new ArrayList<String>() { // from class: com.sony.imaging.app.util.Environment.1
        {
            add("DSC-HX60V");
            add("DSC-HX400V");
            add(PfBugAvailability.DSCHX90V);
            add(PfBugAvailability.DSCHX80);
            add(PfBugAvailability.DSCWX500);
        }
    });
    public static boolean isBulbSupported = isBulbSupported();
    public static boolean isCancelExposureSupported = isCancelExposureSupported();
    ...
    private static boolean isBulbSupported() {
        if (bulbShootingNotSupportedModelName.contains(ScalarProperties.getString("model.name")) || ScalarProperties.getInt("ui.bulb.supported", 1) != 1) {
            return false;
        }
        Log.v(TAG, "Bulb Shooting Support Model.");
        return true;
    }

    private static boolean isCancelExposureSupported() {
        return (getVersionPfAPI() >= 6 && !"DSC-RX100M3".equals(ScalarProperties.getString("model.name"))) || (ScalarProperties.getInt("ui.modification.patch.bits0") & 4) == 4;
    }

    public static boolean isSilentShutterAPISupported() {
        return 15 <= getVersionPfAPI() || (ScalarProperties.getInt("ui.modification.patch.bits0") & 2) == 2;
    }

    public static boolean isRawRecModeAPISupported() {
        return 15 <= getVersionPfAPI() || (ScalarProperties.getInt("ui.modification.patch.bits0") & 8) == 8;
    }

    public static boolean isBluetoothAPISupported() {
        return 15 <= getVersionPfAPI();
    }

    public static boolean isReceiveGpsData() {
        return 16 <= getVersionPfAPI();
    }

    public static boolean isMeteringSpotSizeAPISupported() {
        return 17 <= getVersionPfAPI();
    }

    public static boolean isMeteringModePointAPISupported() {
        return 17 <= getVersionPfAPI();
    }

    public static boolean isIsoAutoMaxMinAPISupported() {
        return 13 <= getVersionPfAPI();
    }

    public static boolean isISOAutoMinShutterSpeedAPISupported() {
        return 13 <= getVersionPfAPI();
    }
    ...
    public static int getTouchOperationVersion() {
        int pfVersion = getVersionPfAPI();
        return 17 <= pfVersion ? 2 : 1;
    }
}
