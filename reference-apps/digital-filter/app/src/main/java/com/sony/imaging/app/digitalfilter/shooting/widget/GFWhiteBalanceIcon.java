...
public class GFWhiteBalanceIcon extends ActiveLayout {
    ...
    private static final int OSD169_ICON_ONLY_LEFT_X = 0;
    private static final int OSD169_K_PADDING_LEFT = -3;
    private static final int OSD169_K_PADDING_TOP = 0;
    private static final int OSD169_LOWER_LEFT_X = 13;
    private static final int OSD169_LOWER_RIGHT_X = 35;
    private static final int OSD169_UPPER_K_X = 11;
    private static final int OSD43_ICON_ONLY_LEFT_X = 0;
    private static final int OSD43_LOWER_LEFT_X = 8;
    private static final int OSD43_LOWER_RIGHT_X = 37;
    private static final int OSD43_UPPER_K_X = 5;
    private static final int OSD_CWB_H = 22;
    private static final int OSD_CWB_W = 38;
    private static final int OSD_CWB_Y = 12;
    ...
    private static final String TAG = "GFWhiteBalanceIcon";
    ...
    public GFWhiteBalanceIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected NotificationListener getNotificationListener() {
        if (this.mListener == null) {
            this.mListener = new ActiveLayout.ActiveLayoutListener() { // from class: com.sony.imaging.app.digitalfilter.shooting.widget.GFWhiteBalanceIcon.1
                ...
                public void onNotify(String tag) {
                    super.onNotify(tag);
                    GFWhiteBalanceIcon.this.refresh();
                }
    ...
    public boolean isVisible() {
        List<String> supported = this.mWbController.getSupportedValue(WhiteBalanceController.WHITEBALANCE);
    ...
    protected void refresh() {
        ...
        String option = GFBackUpKey.getInstance().getWBOption(GFWhiteBalanceController.getInstance().getValue(), layer, theme);
        ...
        boolean isCustom = s.equals(WhiteBalanceController.CUSTOM) || s.equals("custom1") || s.equals("custom2") || s.equals("custom3");
    ...
    private void refreshParam() {
        ...
        if (device != 1) {
            if (2 == aspect) {
                ...
                this.mAbLayoutParam.leftMargin = 13;
                this.mGmLayoutParam.leftMargin = 35;
                this.mUpperKLayoutParam.leftMargin = 11;
            } else {
                this.mUpperIconLayoutParam.leftMargin = 0;
                this.mAbLayoutParam.leftMargin = 8;
                this.mGmLayoutParam.leftMargin = 37;
                this.mUpperKLayoutParam.leftMargin = 5;
            }
            ...
            this.mCWBIconLayoutParam.leftMargin = 75;
            this.mCWBIconLayoutParam.topMargin = 12;
        ...
        this.mUpperIconLayoutParam.leftMargin = 0;
        this.mUpperIconLayoutParam.topMargin = 0;
        this.mAbLayoutParam.leftMargin = 2;
        this.mAbLayoutParam.topMargin = 28;
        this.mGmLayoutParam.leftMargin = 30;
        this.mGmLayoutParam.topMargin = 28;
        this.mUpperKLayoutParam.leftMargin = 1;
        this.mUpperKLayoutParam.topMargin = 6;
        this.mCWBIconLayoutParam.leftMargin = 68;
    ...
    public static class NumberImageForAB_GM extends NumberImage {
        ...
        public int setNumber(char ch) {
            ...
            Log.e(GFWhiteBalanceIcon.TAG, GFWhiteBalanceIcon.LOG_INVALID);
            return 0;
        }
    }
}
