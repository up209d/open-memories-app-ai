...
public class ExposureModeDialView extends SubMenuView {
    ...
    private static final DialPositionInfo[] DIAL_POS_INFOS = {new DialPositionInfo(-69, -1, 145, 0, 255, 0), new DialPositionInfo(0, 2, 48, 0, 255, 0), new DialPositionInfo(69, 64, 28, 1, 255, 0), new DialPositionInfo(138, 126, 14, 2, 255, 0), new DialPositionInfo(AppRoot.USER_KEYCODE.PLAYBACK, 200, 3, 3, 255, 0), new DialPositionInfo(276, 282, 14, 4, 255, 0), new DialPositionInfo(345, 344, 28, 5, 255, 0), new DialPositionInfo(HttpServletResponse.SC_REQUEST_URI_TOO_LONG, HttpServletResponse.SC_NOT_ACCEPTABLE, 48, 6, 255, 0), new DialPositionInfo(VIEW_SIZE, HttpServletResponse.SC_CONFLICT, 145, 6, 255, 0)};
    private static final DialPositionInfo[] DIAL_POS_INFOS_LEFT = {new DialPositionInfo(-69, -1, 145, 0, 255, 0), new DialPositionInfo(0, 2, -6, 0, 255, 0), new DialPositionInfo(69, 64, 14, 1, 255, 0), new DialPositionInfo(138, 126, 28, 2, 255, 0), new DialPositionInfo(AppRoot.USER_KEYCODE.PLAYBACK, 200, 27, 3, 255, 0), new DialPositionInfo(276, 282, 28, 4, 255, 0), new DialPositionInfo(345, 344, 14, 5, 255, 0), new DialPositionInfo(HttpServletResponse.SC_REQUEST_URI_TOO_LONG, HttpServletResponse.SC_NOT_ACCEPTABLE, -6, 6, 255, 0), new DialPositionInfo(VIEW_SIZE, HttpServletResponse.SC_CONFLICT, 145, 6, 255, 0)};
    ...
    private void initialize() {
        ...
        setGravity(3);
        setPadding(0, 0, 0, 0);
        setLayoutAttributes(102, CENTER_ICON_HEIGHT, -3, 69);
    ...
    protected ViewGroup.LayoutParams generateDefaultLayoutParams() {
        return new ViewGroup.LayoutParams(102, CENTER_ICON_HEIGHT);
    }
