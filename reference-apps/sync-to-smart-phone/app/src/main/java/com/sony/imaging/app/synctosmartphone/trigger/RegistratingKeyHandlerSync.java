...
public class RegistratingKeyHandlerSync extends BaseInvalidKeyHandler {
    private static final String DIALOG_STATE = "DialogState";
    private static final String TAG = "RegistratingKeyHandlerSync";
    ...
    public int pushedPlayBackKey() {
        State state = (State) this.target;
        state.setNextState(ConstantsSync.REGISTRATION_WAITING_STATE, null);
    ...
    public int pushedFnKey() {
        State state = (State) this.target;
        state.setNextState("DialogState", null);
