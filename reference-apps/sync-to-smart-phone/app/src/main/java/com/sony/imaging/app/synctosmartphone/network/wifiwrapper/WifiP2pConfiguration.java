...
public class WifiP2pConfiguration implements Parcelable {
    public static final Parcelable.Creator<WifiP2pConfiguration> CREATOR = new Parcelable.Creator<WifiP2pConfiguration>() { // from class: com.sony.imaging.app.synctosmartphone.network.wifiwrapper.WifiP2pConfiguration.1
