...
public final class MimeType {
    ...
    private static HashMap<String, String> extToType = new HashMap<String, String>() { // from class: com.sony.mexi.orb.servlet.MimeType.1
        private static final long serialVersionUID = 1;

        {
            put("xul", MimeType.APPLICATION_VND_MOZZILLA_XUL_XML);
            put("json", MimeType.APPLICATION_JSON);
            ...
            put(AutoSyncConstants.FILE_EXTENTION_HTML, MimeType.TEXT_HTML);
            ...
            put(AutoSyncConstants.FILE_EXTENTION_JPEG, MimeType.IMAGE_JPEG);
