...
public class RegistrationWaitingKeyHandlerSync extends BaseInvalidKeyHandler {
    private static final String TAG = "RegistrationWaitingKeyHandlerSync";
    ...
    public int pushedPlayBackKey() {
        State state = (State) this.target;
        state.setNextState(ConstantsSync.TRANSFERRING_STATUS_STATE, null);
