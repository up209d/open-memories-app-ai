...
public interface IEachFunctionEventHandler {
    ...
    int releasedFocusHoldCustomKey();
    ...
    int turnedLensApertureRingToLeft();

    int turnedLensApertureRingToRight();
