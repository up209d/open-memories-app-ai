...
public class MiniatureEffectView extends SimulatingEERelativeLayout {
    ...
    static {
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 827));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL32.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL169 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 111, SsdpDevice.RETRY_INTERVAL, HttpServletResponse.SC_LENGTH_REQUIRED));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 350, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.LENS_APERTURE_RING_STATUS));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, AppRoot.USER_KEYCODE.SLIDE_AEL_FOCUS_CHANGED, SsdpDevice.RETRY_INTERVAL, 889));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL43 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 827));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_LEFT, new Rect(135, 0, HttpServletResponse.SC_REQUESTED_RANGE_NOT_SATISFIABLE, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_VCENTER, new Rect(360, 0, AppRoot.USER_KEYCODE.WATER_HOUSING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_RIGHT, new Rect(584, 0, 865, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL11 = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 173, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 374, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PROJECTOR));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 827));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(19, 0, 393, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_VCENTER, new Rect(313, 0, 687, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL11.put(PictureEffectController.MINIATURE_RIGHT, new Rect(AppRoot.USER_KEYCODE.FEL, 0, 986, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL_COMMON = new HashMap<>();
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 825));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL_COMMON = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 825));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL32 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 136, SsdpDevice.RETRY_INTERVAL, HttpServletResponse.SC_REQUESTED_RANGE_NOT_SATISFIABLE));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 360, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.WATER_HOUSING));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 584, SsdpDevice.RETRY_INTERVAL, 864));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL169 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 67, SsdpDevice.RETRY_INTERVAL, HttpServletResponse.SC_BAD_REQUEST));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 333, SsdpDevice.RETRY_INTERVAL, 667));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, AppRoot.USER_KEYCODE.FOCUS_MODE_DIAL_AF_S, SsdpDevice.RETRY_INTERVAL, 933));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL43 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 825));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_LEFT, new Rect(175, 0, 425, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_VCENTER, new Rect(375, 0, AppRoot.USER_KEYCODE.PEAKING, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL43.put(PictureEffectController.MINIATURE_RIGHT, new Rect(575, 0, 825, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL11 = new HashMap<>();
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 175, SsdpDevice.RETRY_INTERVAL, 425));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 375, SsdpDevice.RETRY_INTERVAL, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, SsdpDevice.RETRY_INTERVAL, 825));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(67, 0, HttpServletResponse.SC_BAD_REQUEST, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_VCENTER, new Rect(333, 0, 667, SsdpDevice.RETRY_INTERVAL));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_RIGHT, new Rect(AppRoot.USER_KEYCODE.FOCUS_MODE_DIAL_AF_S, 0, 933, SsdpDevice.RETRY_INTERVAL));
        ...
        GRADATION_COLOR = Color.argb(128, HttpServletResponse.SC_NO_CONTENT, HttpServletResponse.SC_NO_CONTENT, HttpServletResponse.SC_NO_CONTENT);
    }
    ...
    protected void addCameraNotificationListener(NotificationListener listener) {
        if (this.mCameraNotifier != null) {
            this.mCameraNotifier.setNotificationListener(listener);
        }
    }

    protected void removeCameraNotificationListener(NotificationListener listener) {
        if (this.mCameraNotifier != null) {
    ...
    protected void refresh() {
        ...
        if (DigitalZoomController.getInstance().isDigitalZoomStatus()) {
            if (2 > CameraSetting.getPfApiVersion()) {
                setVisibility(4);
                return;
            } else if (PictureEffectController.getInstance().isMiniatureForSpecialSequence()) {
                setVisibility(4);
                return;
            }
        }
