...
public class NDfilterController extends AbstractController {
    ...
    public void setValue(String tag, String value) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SETNDFILTER).append(value);
    ...
    public String getValue(String tag) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETNDFILTER).append(pfValue);
        Log.i(TAG, STRBUILD.toString());
        return pfValue;
    }
    ...
    public List<String> getSupportedValue(String tag) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSUPPORTEDNDFILTERS).append(supList);
        Log.i(TAG, STRBUILD.toString());
        return supList;
    }
