...
public class CautionDisplayState extends State {
    ...
    public void onResume() {
        ...
        CautionProcessingFunction cautionfunc = new CautionProcessingFunction(cautionId, getActivity());
        CautionProcessingFunction.priorityData mPriData = cautionfunc.getMaxPriorityId(cautionId);
