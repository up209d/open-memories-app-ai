...
public class StillImageQualityIcon extends ActiveImage {
    ...
    static {
        ...
        ICONS.put(PictureQualityController.PICTURE_QUALITY_FINE, 2);
        ICONS.put(PictureQualityController.PICTURE_QUALITY_STANDARD, 3);
        ICONS.put(PictureQualityController.PICTURE_QUALITY_EXTRAFINE, 4);
    }
    ...
    protected void refresh() {
        ...
        try {
            ...
            if (quality != null && (id = ICONS.get(quality)) != null) {
