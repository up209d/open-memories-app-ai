...
public class CameraSetting implements CameraEx.ApertureChangeListener, CameraEx.ShutterSpeedChangeListener, CameraEx.AutoISOSensitivityListener, CameraEx.SettingChangedListener, CameraEx.ProgramLineRangeOverListener, CameraEx.FocusLightStateListener, CameraEx.EquipmentCallback, CameraEx.PreviewAnalizeListener, CameraEx.FlashEmittingListener, CameraEx.FocalLengthChangeListener, CameraEx.FaceDetectionListener, CameraEx.AutoSceneModeListener, CameraEx.ProgramLineListener, CameraEx.ErrorCallback {
    ...
    public void onChanged(int[] types, Camera.Parameters param, CameraEx cam) {
        ...
        for (int type : types) {
            ...
            String[] tags = SETTING_CHANGE_NOTIFY_TAGS.get(type);
            if (tags != null) {
                for (String tag : tags) {
    ...
    private void createParameterComparatorList() {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new ListComparator<Boolean>(CameraNotificationManager.DIGITAL_ZOOM_MODE_CHANGED) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.28
            @Override // com.sony.imaging.app.base.common.comparator.ParameterComparator._ListComparator
            protected /* bridge */ /* synthetic */ void getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> pair, List x1) {
        ...
        this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<Boolean>(CameraNotificationManager.IR_CONTROL_MODE_CHANGED) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.29
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.common.comparator.ParameterComparator._SimpleComparator
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderSimpleComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.30
            /* JADX INFO: Access modifiers changed from: protected */
            @Override // com.sony.imaging.app.base.common.comparator.ParameterComparator._SimpleComparator
        ...
        this.RECORDER_PARAMETER_COMPARATORS.add(new RecorderListComparator<String>(CameraNotificationManager.MOVIE_FORMAT) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.31
            @Override // com.sony.imaging.app.base.common.comparator.ParameterComparator._ListComparator
        ...
        if (Environment.isIntervalRecAPISupported()) {
            this.CAMERA_PARAMETER_COMPARATORS.add(new SimpleComparator<Integer>(CameraNotificationManager.TAG_INTERVAL_SETTING_CHANGED) { // from class: com.sony.imaging.app.base.shooting.camera.CameraSetting.32
                /* JADX INFO: Access modifiers changed from: protected */
                @Override // com.sony.imaging.app.base.common.comparator.ParameterComparator._SimpleComparator
                public Integer getValue(Pair<Camera.Parameters, CameraEx.ParametersModifier> obj) {
