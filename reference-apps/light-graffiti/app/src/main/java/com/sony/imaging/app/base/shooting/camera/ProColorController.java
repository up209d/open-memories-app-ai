...
public class ProColorController extends AbstractController {
    ...
    private List<String> createSupportedValueArray(int mode) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSUPPORTEDPROCOLORMODES).append(supList);
    ...
    public void setValue(String tag, String value) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SETPROCOLORMODE).append(value);
        Log.i(TAG, STRBUILD.toString());
    ...
    public String getValue(String tag) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETPROCOLORMODE).append(pfValue);
        Log.i(TAG, STRBUILD.toString());
        return pfValue;
    }
