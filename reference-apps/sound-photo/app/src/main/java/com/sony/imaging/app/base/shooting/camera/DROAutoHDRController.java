...
public class DROAutoHDRController extends AbstractController {
    ...
    protected DROAutoHDRController() {
    ...
    protected void createSupported() {
        ...
        if (mRawSupportedDroModes == null) {
            ...
            builder.replace(0, builder.length(), LOG_MSG_GETSUPPORTEDDROMODE).append(mRawSupportedDroModes);
            Log.i(TAG, builder.toString());
        }
        if (mRawSupportedHdrModes == null) {
            mRawSupportedHdrModes = ((CameraEx.ParametersModifier) params.second).getSupportedHDRModes();
            builder.replace(0, builder.length(), LOG_MSG_GETSUPPORTEDHDRMODE).append(mRawSupportedHdrModes);
            Log.i(TAG, builder.toString());
        }
        ...
        if (mSupportedDroLevels == null) {
            ...
            builder.replace(0, builder.length(), LOG_MSG_GETMAXDROLEVEL).append(mRawMaxDROLevel);
            Log.i(TAG, builder.toString());
        ...
        if (mSupportedHdrLevels == null) {
            ...
            builder.replace(0, builder.length(), LOG_MSG_GETMINHDREV).append(mRawMinHDRExposureDifferenceLevel).append(", ").append(LOG_MSG_GETMAXHDREV).append(mRawMaxHDRExposureDifferenceLevel);
            Log.i(TAG, builder.toString());
    ...
    public String getValue() {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_INVALIDMODE).append(mode);
    ...
    private String getValueMode(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_GETDROMODE).append(droMode).append(", ").append(LOG_MSG_GETHDRMODE).append(hdrMode);
        Log.i(TAG, builder.toString());
    ...
    private int getValueLevel(String mode) {
        if (MODE_DRO_ON.equals(mode)) {
            ...
            StringBuilder builder = STRBUILD.get();
            builder.replace(0, builder.length(), LOG_MSG_GETDROLEVEL).append(level);
            Log.i(TAG, builder.toString());
            return level;
        }
    ...
    private int getValueEv(String mode) {
        if (MODE_HDR_ON.equals(mode)) {
            ...
            StringBuilder builder = STRBUILD.get();
            builder.replace(0, builder.length(), LOG_MSG_GETHDREV).append(level);
            Log.i(TAG, builder.toString());
            return level;
        }
    ...
    protected void setDROAuto(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROMODE).append("auto").append(", ").append(LOG_MSG_SETHDRMODE).append("off");
        Log.i(TAG, builder.toString());
    }
    ...
    protected void setDROOn(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        ((CameraEx.ParametersModifier) params.second).setHDRMode("off");
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROMODE).append("on").append(", ").append(LOG_MSG_SETHDRMODE).append("off");
        Log.i(TAG, builder.toString());
    }
    ...
    protected void setHDRAuto(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROMODE).append("off").append(", ").append(LOG_MSG_SETHDRMODE).append("auto");
        Log.i(TAG, builder.toString());
    }
    ...
    protected void setHDROn(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROMODE).append("off").append(", ").append(LOG_MSG_SETHDRMODE).append("on");
        Log.i(TAG, builder.toString());
    }
    ...
    protected void setModeOff(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        ((CameraEx.ParametersModifier) params.second).setHDRMode("off");
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROMODE).append("off").append(", ").append(LOG_MSG_SETHDRMODE).append("off");
        Log.i(TAG, builder.toString());
    }
    ...
    private void updateCameraParameterLevel(Pair<Camera.Parameters, CameraEx.ParametersModifier> params, int value) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETDROLEVEL).append(value);
        Log.i(TAG, builder.toString());
    }
    ...
    private void updateCameraParameterEv(Pair<Camera.Parameters, CameraEx.ParametersModifier> params, int value) {
        ...
        StringBuilder builder = STRBUILD.get();
        builder.replace(0, builder.length(), LOG_MSG_SETHDREV).append(value);
        Log.i(TAG, builder.toString());
    }
