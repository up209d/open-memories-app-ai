...
public class UploadMultipleConfirmLayout extends EditorConfirmLayoutBase {
    TextView mCancel;
    TextView mOk;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (this.mOk != null) {
            this.mOk.setText(R.string.STRID_FUNC_SNSDIRECT_UPLOAD);
    ...
    public void onResume() {
        super.onResume();
        setFooterGuideData(new FooterGuideDataResId(getActivity(), android.R.string.whichSendToApplicationNamed, android.R.string.httpErrorRedirectLoop));
        TextView label = (TextView) getView().findViewById(R.id.dialog_message);
        if (label != null) {
            String text = getResources().getString(R.string.STRID_FUNC_SOUNDPHOTO_CAUTION_UPLOAD, Integer.valueOf(getEditService().countSelected()));
            label.setText(text);
        }
    }
