...
public class ShootingState extends StateBase implements ShootingLayout.HolderListener {
    ...
    /* loaded from: classes.dex */
    public static class ShootingIdleHandler implements MessageQueue.IdleHandler {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    /* loaded from: classes.dex */
    public static class MyMotionShotResultListener implements CameraEx.MotionShotResultListener {
