...
public class UploadMultipleIndexLayout extends SelectorIndexLayout {
    ...
    public void invalidate() {
        ...
        if (selectedCount != null) {
            selectedCount.setText(String.valueOf(getEditService().countSelected()));
        }
    }
        ...
        public void loadInfoDone(IndexLayoutGridViewBase.ImageAdapter.ViewHolder holder, ContentInfo result, Task task) {
            ...
            if (result != null) {
                ...
                if (position == theHolder.getId()) {
                    ...
                    if (UploadMultipleIndexLayout.this.getEditService().isSelectable(position)) {
                        checkbox.setVisibility(0);
                        checkbox.setChecked(UploadMultipleIndexLayout.this.getEditService().isChecked(position));
                    } else {
