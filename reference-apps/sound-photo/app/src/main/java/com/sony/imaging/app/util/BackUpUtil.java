...
public class BackUpUtil {
    ...
    private ArrayList<String> mRevertableKeys;
    ...
    public void Init(Context context) {
        ...
        this.mRevertableKeys = new ArrayList<>();
    }
    ...
    public void removePreference(String key) {
        ...
        if (this.mRevertableKeys.contains(key)) {
            this.mRevertableKeys.remove(key);
        }
    }
    ...
    public boolean setRevertablePreference(String key, Object value) {
        boolean result = setPreference(key, value);
        if (result && !this.mRevertableKeys.contains(key)) {
            this.mRevertableKeys.add(key);
        }
        return result;
    }
    ...
    public boolean preferenceWrite() {
        ...
        for (String key : set) {
            ...
            switch (checkModel(item)) {
                case INT:
                    if (this.mRevertable.contains(key) || this.mRevertableKeys.contains(key)) {
