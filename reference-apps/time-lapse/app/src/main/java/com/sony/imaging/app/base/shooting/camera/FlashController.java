...
public class FlashController extends ShootingModeController implements CompensationControllable {
    ...
    public String getSettingValue(String itemId) {
        if (FLASHMODE.equals(itemId)) {
            String ret = BackUpUtil.getInstance().getPreferenceString(BaseBackUpKey.ID_FLASH_TYPE, null);
            return ret;
        }
        Log.e(TAG, LOG_NO_CATEGOLY);
        return null;
    ...
    protected void removeUnavailableValue(List<String> availables) {
        ...
        if ("ProgramAuto".equals(expMode) || "Aperture".equals(expMode) || "Shutter".equals(expMode) || ExposureModeController.MANUAL_MODE.equals(expMode)) {
    ...
    protected void setDefaultValueEx(Pair<Camera.Parameters, CameraEx.ParametersModifier> params) {
        ...
        if ("ProgramAuto".equals(expMode) || "Aperture".equals(expMode) || "Shutter".equals(expMode) || ExposureModeController.MANUAL_MODE.equals(expMode)) {
            ...
            if ("off".equals(flashMode)) {
                ...
                if ("auto".equals(flashType) || "off".equals(flashType)) {
                    flashType = FRONTSYNC;
                }
    ...
    public float getExternalCompensation() {
        if (isMovieMode()) {
            return TimeLapseConstants.INVALID_APERTURE_VALUE;
        }
