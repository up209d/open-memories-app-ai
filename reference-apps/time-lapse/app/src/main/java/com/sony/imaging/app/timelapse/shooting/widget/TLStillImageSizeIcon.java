...
public class TLStillImageSizeIcon extends ActiveImage {
    ...
    public TLStillImageSizeIcon(Context context) {
        this(context, null);
    }

    public TLStillImageSizeIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected NotificationListener getNotificationListener() {
        if (this.mPictureSizeListener == null) {
            this.mPictureSizeListener = new NotificationListener() { // from class: com.sony.imaging.app.timelapse.shooting.widget.TLStillImageSizeIcon.1
                ...
                public void onNotify(String tag) {
                    if (CameraNotificationManager.REC_MODE_CHANGED.equals(tag)) {
                        TLStillImageSizeIcon.this.setVisibility(TLStillImageSizeIcon.this.isVisible() ? 0 : 4);
                    }
                    TLStillImageSizeIcon.this.refresh();
                }
