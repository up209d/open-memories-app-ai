...
public class PanoramaSize extends IconFileInfo {
    ...
    private static final int[][] STD_SIZE_TBL = {new int[]{8192, 1856}, new int[]{3872, 2160}, new int[]{AngleShiftConstants.PICTURE_WIDTH_OF_16M, 1080}};
    private static final int[][] WIDE_SIZE_TBL = {new int[]{12416, 1856}, new int[]{5536, 2160}, new int[]{7152, 1080}};
