...
public class WhiteBalanceMenuLayout extends SpecialScreenMenuLayout {
    ...
    public void onResume() {
        ...
        if (this.wbc.getValue().equals("color-temp") && layout != null && layout.equals(WhiteBalanceAdjustmentMenuLayout.MENU_ID)) {
    ...
    public int pushedDownKey() {
        ...
        String itemId = this.mList.get(pos);
        String value = this.mService.getMenuItemValue(itemId);
        if ("color-temp".equals(value) && this.mLayoutStatus == Layout.OPTION) {
    ...
    public int pushedRightKey() {
        ...
        if ("color-temp".equals(value) && this.mLayoutStatus == Layout.SUB) {
            setLayoutStatus(Layout.OPTION);
