...
public class ISOIconFn extends ActiveImage {
    ...
    static {
        RESID_DICTIONARY_ISO.put("0", Integer.valueOf(R.drawable.numberpicker_input));
        ...
        RESID_DICTIONARY_ISO.put("100", Integer.valueOf(R.drawable.numberpicker_up_disabled_focused_holo_dark));
        ...
        RESID_DICTIONARY_ISO.put("1600", 17305127);
        ...
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_32000, 17306083);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_40000, 17306084);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_51200, Integer.valueOf(R.drawable.ic_bt_pointing_hid));
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_64000, 17307888);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_80000, 17307939);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_102400, 17307931);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_128000, 17307916);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_160000, 17307917);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_204800, 17307941);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_256000, 17307944);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_320000, 17307928);
        RESID_DICTIONARY_ISO.put(ISOSensitivityController.ISO_409600, 17307921);
    }
