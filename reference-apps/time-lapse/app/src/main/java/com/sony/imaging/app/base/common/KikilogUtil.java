...
public class KikilogUtil {
    private static final int KIKILOGID_STILL_COUNT = 4411;
    ...
    static {
        EXPOSURES_KIKILOG.put("ProgramAuto", 769);
        EXPOSURES_KIKILOG.put("Aperture", 770);
        EXPOSURES_KIKILOG.put("Shutter", 771);
        ...
        EXPOSURES_KIKILOG.put(ExposureModeController.COMMON_NORMAL, 899);
        EXPOSURES_KIKILOG.put(ExposureModeController.COMMON_UNDERWATER, 900);
    ...
    public static void incrementShootingCount() {
        ...
        options.getClass();
        options.recType = 32;
        Kikilog.setUserLog(KIKILOGID_STILL_COUNT, options);
        ...
        String mode2 = pictureEffect.getValue("PictureEffect");
        if (mode2 != null) {
