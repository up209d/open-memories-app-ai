...
public class PictureEffectIcon extends ActiveImage {
    ...
    public boolean isVisible() {
        List<String> supported = PictureEffectController.getInstance().getSupportedValue("PictureEffect");
    ...
    private Drawable obtainDrawable(String key) {
        ...
        try {
            ...
            Log.i(TAG, builder.replace(0, builder.length(), LOG_RESOURCE_NOT_FOUND).append(key).toString());
