...
public class AngleShiftConfirmSavingLayout extends EditorConfirmLayoutBase {
    TextView mCancel;
    TextView mOk;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mOk.setText(R.string.STRID_CMN_SAVE2);
    ...
    public void onResume() {
        ...
        int numberOfImages = bundle.getInt("ShootCount");
        String text = getEstTime(numberOfImages);
    ...
    private String getEstTime(int numberOfImages) {
        int estTime = (AngleShiftImageEditor.getInstance().getProcessingTime() * numberOfImages) / 1000;
        int hour = estTime / 3600;
        int min = (estTime - ((hour * 60) * 60)) / 60;
        int sec = estTime % 60;
        String text = getResources().getString(R.string.STRID_FUNC_TIMELAPSE_EFFECT_SAVE_MSG1);
        return String.format(text, Integer.valueOf(hour), Integer.valueOf(min), Integer.valueOf(sec));
    }
    ...
    public int pushedCenterKey() {
        if (this.mOk != null && this.mOk.isSelected()) {
            ...
            CameraNotificationManager.getInstance().requestNotify(AngleShiftConstants.TAG_AS_SAVE_EXEC);
            return 1;
        }
