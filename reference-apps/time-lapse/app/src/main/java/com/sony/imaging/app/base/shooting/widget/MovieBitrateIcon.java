...
public class MovieBitrateIcon extends ActiveImage {
    ...
    static {
        ...
        RESID_DICTIONARY.put(MovieFormatController.MP4_1080_PS_50P, 4);
        RESID_DICTIONARY.put(MovieFormatController.MP4_1080_PS_60P, 4);
        RESID_DICTIONARY.put(MovieFormatController.MP4_1080_HQ_30P, 4);
        RESID_DICTIONARY.put(MovieFormatController.MP4_1080_HQ_25P, 4);
        RESID_DICTIONARY.put(MovieFormatController.MP4_720_30P, 5);
        ...
        RESID_DICTIONARY.put(MovieFormatController.XAVC_100M_100P, 9);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_100M_120P, 9);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_60M_100P, 8);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_60M_120P, 8);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_100M_24P, 9);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_100M_25P, 9);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_100M_30P, 9);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_60M_24P, 8);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_60M_25P, 8);
        RESID_DICTIONARY.put(MovieFormatController.XAVC_4K_60M_30P, 8);
    }
    ...
    protected void refresh() {
        if (Environment.isMovieAPISupported()) {
            ...
            if (!DatabaseManager.getInstance().isReady()) {
                ...
                resid = this.dbManager.getResourceId(DatabaseManager.SETTING_BITRATE, setting, panel);
            }
