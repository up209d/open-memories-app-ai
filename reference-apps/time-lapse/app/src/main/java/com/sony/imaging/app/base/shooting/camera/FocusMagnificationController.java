...
public class FocusMagnificationController extends ShootingModeController {
    ...
    protected Pair<Float, Float> getDistancePerUnitStep() {
        ...
        if (lowestRatio == 0) {
            frame = Pair.create(Float.valueOf(TimeLapseConstants.INVALID_APERTURE_VALUE), Float.valueOf(TimeLapseConstants.INVALID_APERTURE_VALUE));
        } else {
    ...
    protected Pair<Integer, Integer> movePositionInDigitalZoom() {
        ...
        float currentPosiX = TimeLapseConstants.INVALID_APERTURE_VALUE;
        float currentPosiY = TimeLapseConstants.INVALID_APERTURE_VALUE;
        ...
        if (this.mCamSet.mChangeZoomRatio) {
            ...
            if (movePositionCenter) {
                currentPosiX = TimeLapseConstants.INVALID_APERTURE_VALUE;
                currentPosiY = TimeLapseConstants.INVALID_APERTURE_VALUE;
            }
        }
