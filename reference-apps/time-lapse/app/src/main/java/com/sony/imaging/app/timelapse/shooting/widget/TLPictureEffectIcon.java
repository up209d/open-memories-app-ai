...
public class TLPictureEffectIcon extends ActiveImage {
    ...
    public TLPictureEffectIcon(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    protected NotificationListener getNotificationListener() {
        if (this.mListener == null) {
            this.mListener = new ActiveImage.ActiveImageListener() { // from class: com.sony.imaging.app.timelapse.shooting.widget.TLPictureEffectIcon.1
                ...
                public void onNotify(String tag) {
                    super.onNotify(tag);
                    TLPictureEffectIcon.this.refresh();
                }
    ...
    public boolean isVisible() {
        return !PictureEffectController.getInstance().isUnavailableSceneFactor("PictureEffect");
    }

    @Override // com.sony.imaging.app.base.shooting.widget.ActiveImage
    protected void refresh() {
        String key;
        if (TLCommonUtil.getInstance().isPictureEffectIconUpdate()) {
            key = getValue();
        } else {
            key = TLCommonUtil.getInstance().getPictureEffectKey();
        }
