...
public class MiniatureEffectView extends SimulatingEERelativeLayout {
    ...
    static {
        ...
        MINIATURE_AREA_IMAGER32_STILL32.put("hcenter", new Rect(0, 374, 1000, AppRoot.USER_KEYCODE.PROJECTOR));
        ...
        MINIATURE_AREA_IMAGER32_STILL169.put("hcenter", new Rect(0, 350, 1000, AppRoot.USER_KEYCODE.LENS_APERTURE_RING_STATUS));
        ...
        MINIATURE_AREA_IMAGER32_STILL43.put("hcenter", new Rect(0, 374, 1000, AppRoot.USER_KEYCODE.PROJECTOR));
        ...
        MINIATURE_AREA_IMAGER32_STILL43.put(PictureEffectController.MINIATURE_VCENTER, new Rect(360, 0, 640, 1000));
        ...
        MINIATURE_AREA_IMAGER32_STILL11.put("hcenter", new Rect(0, 374, 1000, AppRoot.USER_KEYCODE.PROJECTOR));
        ...
        MINIATURE_AREA_IMAGER32_STILL_COMMON.put("hcenter", new Rect(0, 375, 1000, AppRoot.USER_KEYCODE.PEAKING));
        ...
        MINIATURE_AREA_IMAGER43_STILL_COMMON.put("hcenter", new Rect(0, 375, 1000, AppRoot.USER_KEYCODE.PEAKING));
        ...
        MINIATURE_AREA_IMAGER43_STILL32.put("hcenter", new Rect(0, 360, 1000, 640));
        ...
        MINIATURE_AREA_IMAGER43_STILL169.put(PictureEffectController.MINIATURE_UPPER, new Rect(0, 67, 1000, AngleShiftConstants.AS_SAVING_TIME_OFFSET_MUSASHI));
        MINIATURE_AREA_IMAGER43_STILL169.put("hcenter", new Rect(0, 333, 1000, 667));
        ...
        MINIATURE_AREA_IMAGER43_STILL43.put("hcenter", new Rect(0, 375, 1000, AppRoot.USER_KEYCODE.PEAKING));
        ...
        MINIATURE_AREA_IMAGER43_STILL11.put("hcenter", new Rect(0, 375, 1000, AppRoot.USER_KEYCODE.PEAKING));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LOWER, new Rect(0, 575, 1000, 825));
        MINIATURE_AREA_IMAGER43_STILL11.put(PictureEffectController.MINIATURE_LEFT, new Rect(67, 0, AngleShiftConstants.AS_SAVING_TIME_OFFSET_MUSASHI, 1000));
    ...
    protected void refresh() {
        ...
        if (PictureEffectController.MINIATURE_UPPER.equals(pos) || "hcenter".equals(pos) || PictureEffectController.MINIATURE_LOWER.equals(pos)) {
    ...
    private String getMiniatureSetting() {
        ...
        String effect = pec.getValue("PictureEffect");
