...
public class TimelapseMonitorBrightnessController extends AbstractController {
    ...
    private static TimelapseMonitorBrightnessController mInstance;
    ...
    public static TimelapseMonitorBrightnessController getInstance() {
        if (mInstance == null) {
    ...
    private static TimelapseMonitorBrightnessController createInstance() {
        if (mInstance == null) {
            mInstance = new TimelapseMonitorBrightnessController();
        }
        return mInstance;
    }

    private TimelapseMonitorBrightnessController() {
