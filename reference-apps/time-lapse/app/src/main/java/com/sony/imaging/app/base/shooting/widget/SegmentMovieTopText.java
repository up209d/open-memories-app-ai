        ...
        if (this.mListener == null) {
            this.mListener = new NotificationListener() { // from class: com.sony.imaging.app.base.shooting.widget.SegmentMovieTopText.1
                ...
                public String[] getTags() {
                    return new String[]{CameraNotificationManager.STREAM_WRITE_START, CameraNotificationManager.STREAM_WRITE_STOP, CameraNotificationManager.MOVIE_REC_START_SUCCEEDED, CameraNotificationManager.MOVIE_REC_STOP};
                }
            };
        }
