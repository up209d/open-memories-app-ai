...
import com.sony.imaging.app.avi.DataBaseAdapterIf;
...
public class DataBaseAdapter implements DataBaseAdapterIf {
    ...
    @Override // com.sony.imaging.app.avi.DataBaseAdapterIf
    ...
    public void insert(String tableName, ContentValues contentValues) {
        ...
        this.mSQLiteDatabase.insertOrThrow(tableName, null, contentValues);
    ...
    public int getTotalGroups() {
        ...
        Cursor c = null;
        try {
            c = query("SELECT COUNT(*) AS Total FROM tblPlay", null);
            c.moveToFirst();
        ...
        */
        private void createDataBase(android.database.sqlite.SQLiteDatabase r10) {
            /*
                r9 = this;
                r1 = 0
                android.content.Context r7 = com.sony.imaging.app.timelapse.databaseutil.AppContext.getAppContext()     // Catch: java.io.IOException -> L46
            ...
            L39:
                r5 = move-exception
                java.lang.String r7 = com.sony.imaging.app.timelapse.databaseutil.DataBaseAdapter.access$100()
            ...
            L6a:
                ...
                goto L47
            */
            throw new UnsupportedOperationException("Method not decompiled: com.sony.imaging.app.timelapse.databaseutil.DataBaseAdapter.DBHelper.createDataBase(android.database.sqlite.SQLiteDatabase):void");
        }
    }
    ...
    public boolean isDBSizeFull() {
        boolean isDBSizeFull = false;
        if (this.mSQLiteDatabase == null) {
            open(2);
        }
        if (getTotalGroups() >= 100) {
            isDBSizeFull = true;
        }
        close();
        return isDBSizeFull;
