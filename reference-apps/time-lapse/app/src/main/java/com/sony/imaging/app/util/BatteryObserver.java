...
public final class BatteryObserver extends BroadcastReceiver {
    ...
    public static final String TAG_EXTRA_PRESENT = "EXTRA_PRESENT";
    ...
    public static boolean getBoolean(String tag) {
        Boolean value = (Boolean) getValue(tag);
        if (value != null) {
    ...
    public void onReceive(Context arg0, Intent intent) {
        ...
        if (action.equals("android.intent.action.BATTERY_CHANGED")) {
            ...
            this.mNotification.onDeviceChanged(TAG_EXTRA_PRESENT, Boolean.valueOf(present));
        }
    }
}
