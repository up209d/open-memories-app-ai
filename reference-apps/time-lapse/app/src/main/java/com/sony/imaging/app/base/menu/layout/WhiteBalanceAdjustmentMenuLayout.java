...
public class WhiteBalanceAdjustmentMenuLayout extends DisplayMenuItemsMenuLayout implements View.OnTouchListener, IModableLayout {
    ...
    public void onResume() {
        super.onResume();
        if (WhiteBalanceController.CUSTOM.equals(this.value) || "custom1".equals(this.value) || "custom2".equals(this.value) || "custom3".equals(this.value) || "color-temp".equals(this.value)) {
    ...
    private void update() {
        String temp = this.mController.getValue("color-temp");
        if (temp != null) {
    ...
    private void updateOptionValueText() {
        ...
        if (this.value.equals("color-temp") || this.value.equals(WhiteBalanceController.CUSTOM) || this.value.equals("custom1") || this.value.equals("custom2") || this.value.equals("custom3")) {
