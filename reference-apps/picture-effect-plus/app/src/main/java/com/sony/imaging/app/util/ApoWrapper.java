...
public class ApoWrapper {
    ...
    public static void fixApoType(APO_TYPE type) {
        Log.d(TAG, LOG_STRING.replace(0, LOG_STRING.length(), LOG_FIX_APO_TYPE).append(type).toString());
        mFixedType = type;
    ...
    public static boolean setApoType(APO_TYPE type) {
        Log.d(TAG, LOG_STRING.replace(0, LOG_STRING.length(), LOG_APO_TYPE).append(type).toString());
    ...
    public static void update() {
        ...
        Log.i(TAG, LOG_STRING.replace(0, LOG_STRING.length(), LOG_APO_TYPE_FIXED).append(mFixedType).toString());
    }
