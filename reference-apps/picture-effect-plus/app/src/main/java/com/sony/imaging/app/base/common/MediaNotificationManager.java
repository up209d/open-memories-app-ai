...
public class MediaNotificationManager extends NotificationManager {
    ...
    public void updateRemainingAmount() {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GERREMAINING).append(this.mRemainingAmount);
    ...
    /* loaded from: classes.dex */
    class MediaEventBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!MediaNotificationManager.this.mGone) {
                ...
                MediaNotificationManager.STRBUILD.replace(0, MediaNotificationManager.STRBUILD.length(), MediaNotificationManager.LOG_MSG_INTENTRECEIVED).append(action);
                Log.i(MediaNotificationManager.TAG, MediaNotificationManager.STRBUILD.toString());
