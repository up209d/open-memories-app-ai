...
public class PageMenuLayout extends DisplayMenuItemsMenuLayout {
    ...
    AdapterView.OnItemSelectedListener mOnItemSelectedListenerForPageListView = new AdapterView.OnItemSelectedListener() { // from class: com.sony.imaging.app.base.menu.layout.PageMenuLayout.1
        ...
        public void onItemSelected(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            ArrayList<String> listItemIds = PageMenuLayout.this.mItemListService.getSupportedItemList();
    ...
    AdapterView.OnItemClickListener mOnItemClickListenerForItemListView = new AdapterView.OnItemClickListener() { // from class: com.sony.imaging.app.base.menu.layout.PageMenuLayout.2
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ArrayList<String> menuItemList = PageMenuLayout.this.mItemListService.getSupportedItemList();
    ...
    public DisplayMenuItemsMenuLayout.MenuUpdater getMenuUpdater() {
        if (this.mMenuUpdater == null) {
            this.mMenuUpdater = new DisplayMenuItemsMenuLayout.MenuUpdater(new Handler()) { // from class: com.sony.imaging.app.base.menu.layout.PageMenuLayout.3
                ...
                public void run() {
                    PageMenuLayout.this.updateListViewItems(PageMenuLayout.this.mItemListService.getSupportedItemList());
                }
            };
        }
    ...
    public int turnedMainDialPrev() {
        this.mItemListView.dispatchKeyEvent(new KeyEvent(0L, 0L, 0, 0, 0, 0, 0, AppRoot.USER_KEYCODE.UP));
        return 1;
    }
    ...
    public void onResume() {
        ...
        updateListViewItems(this.mItemListService.getSupportedItemList());
    ...
    protected void updatePageViewItems(ArrayList<String> itemIds) {
    ...
    protected void updateListViewItems(ArrayList<String> itemIds) {
        ...
        while (i$.hasNext()) {
            ...
            item.value = null;
            if (!PictureEffectPlusAppSettingController.ApplicationSettings.equals(itemId) && !PictureEffectPlusController.PICTUREEFFECTPLUS.equals(itemId) && (curItemValueId = this.mItemListService.getCurrentValue(itemId)) != null) {
                String valueText = (String) this.mItemListService.getMenuItemText(curItemValueId);
                if (valueText == null) {
    ...
    protected void setFunctionGuideResources(ArrayList<Object> guideResources) {
        ...
        ArrayList<String> itemIdList = this.mItemListService.getSupportedItemList();
