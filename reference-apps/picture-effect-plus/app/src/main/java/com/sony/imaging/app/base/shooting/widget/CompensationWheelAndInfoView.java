...
public class CompensationWheelAndInfoView extends RelativeLayout {
    ...
    private static final int EV_COMP_2_MOVIE_AVAILABLE_MAX_STEP_3 = 18;
    ...
    public CompensationWheelAndInfoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        RelativeLayout.LayoutParams param = new RelativeLayout.LayoutParams(AREAFIG_COMP_VALUE_WIDTH, AREAFIG_COMP_VALUE_HEIGHT);
