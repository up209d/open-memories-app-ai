...
public class LabelFileNumber extends LabelFileInfo {
    ...
    public void setValue(boolean isOverlapped, long dirName, long fileName) {
        setValue(isOverlapped, String.format(FORMAT_DIRECTORY, Long.valueOf(dirName)), String.format(FORMAT_FILE, Long.valueOf(fileName)));
    }
    ...
    public void setContentInfo(ContentInfo info) {
        int overlapped = Integer.MIN_VALUE;
        String dirName = null;
