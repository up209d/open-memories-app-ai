...
public class CompositProcess implements IImagingProcess, ICaptureProcess {
    private static final String TAG = "CompositProcess";
    ...
    public void prepare(CameraEx cameraEx, IAdapter adapter) {
        ...
        this.mAdapter = adapter;
        Log.i(TAG, "filePath:/android/data/lib/com.sony.imaging.app.pictureeffectplus/lib/libSingleCap.so");
        CameraSequence.Options opt = new CameraSequence.Options();
        opt.setOption("MEMORY_MAP_FILE", "/android/data/lib/com.sony.imaging.app.pictureeffectplus/lib/libSingleCap.so");
