...
public class FocusAdjustmentKeyHandler extends MfAssistKeyHandler {
    ...
    public int pushedMovieRecKey() {
        ...
        int ret = super.pushedMovieRecKey();
        return ret;
    }
    ...
    protected boolean isMovieRecording() {
        return Environment.isMovieAPISupported() && ((BaseApp) this.target.getActivity()).isMovieModeSupported() && 2 == ExecutorCreator.getInstance().getRecordingMode() && MovieShootingExecutor.isMovieRecording();
    }
}
