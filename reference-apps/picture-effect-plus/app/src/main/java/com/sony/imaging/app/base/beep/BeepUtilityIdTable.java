    ...
    public void init() {
        ...
        if (this.mKeyBeepPatternTable == null) {
            KEY_BEEP_PATTERN_MENU_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.1
                {
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.SHUTTLE_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.SHUTTLE_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.DIAL2_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DIAL2_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.DIAL1_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DIAL1_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
            ...
            KEY_BEEP_PATTERN_SETTING_COMMON_NO_WHEEL_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.3
                {
                    ...
                    put(AppRoot.USER_KEYCODE.RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.MENU, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_NONE);
            ...
            KEY_BEEP_PATTERN_SETTING_PLAY_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.4
                {
                    put(AppRoot.USER_KEYCODE.PLAYBACK, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
            ...
            KEY_BEEP_PATTERN_DIALOG_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.6
                {
                    ...
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.SHUTTLE_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.SHUTTLE_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.DIAL2_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DIAL2_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
            ...
            KEY_BEEP_PATTERN_REC_NORMAL_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.7
                {
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.LEFT, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.RIGHT, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.MENU, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    ...
                    put(AppRoot.USER_KEYCODE.DIAL1_RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DIAL1_LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.FN, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                }
            };
            KEY_BEEP_PATTERN_AUTO_REVIEW_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.8
                {
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.MENU, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.AEL, BeepUtilityRsrcTable.BEEP_ID_NONE);
                    put(AppRoot.USER_KEYCODE.AF_MF, BeepUtilityRsrcTable.BEEP_ID_NONE);
                    put(AppRoot.USER_KEYCODE.PLAYBACK, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
            ...
            KEY_BEEP_PATTERN_MULTI_EDIT_PLAY_SINGLE_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.13
                {
                    put(AppRoot.USER_KEYCODE.PLAYBACK, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.MENU, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
            ...
            KEY_BEEP_PATTERN_MULTI_EDIT_PLAY_CONFIRM_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.15
                {
                    ...
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_NONE);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_NONE);
            ...
            KEY_BEEP_PATTERN_PLAY_SINGLE_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.17
                {
                    put(AppRoot.USER_KEYCODE.PLAYBACK, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.SK1, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_SWITCH_MODE);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
            ...
            KEY_BEEP_PATTERN_PLAY_ZOOM_TBL = new SparseArray<String>(i) { // from class: com.sony.imaging.app.base.beep.BeepUtilityIdTable.19
                {
                    ...
                    put(AppRoot.USER_KEYCODE.MENU, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.SK2, BeepUtilityRsrcTable.BEEP_ID_OPTION_ON);
                    put(AppRoot.USER_KEYCODE.CENTER, BeepUtilityRsrcTable.BEEP_ID_BACK_CANCEL);
                    put(AppRoot.USER_KEYCODE.UP, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
                    put(AppRoot.USER_KEYCODE.DOWN, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.LEFT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_DOWN);
                    put(AppRoot.USER_KEYCODE.RIGHT, BeepUtilityRsrcTable.BEEP_ID_WHEEL_UP);
