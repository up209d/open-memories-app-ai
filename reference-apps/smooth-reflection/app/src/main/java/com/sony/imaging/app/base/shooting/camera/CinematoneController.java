...
public class CinematoneController extends AbstractController {
    ...
    private List<String> createSupportedValueArray(int mode) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETSUPPORTEDCINEMATONES).append(supList);
    ...
    public void setValue(String tag, String value) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_SETCINEMATONEMODE).append(value);
        Log.i(TAG, STRBUILD.toString());
    ...
    public String getValue(String tag) {
        ...
        STRBUILD.replace(0, STRBUILD.length(), LOG_MSG_GETCINEMATONEMODE).append(pfValue);
        Log.i(TAG, STRBUILD.toString());
        return appValue;
    }
