...
public class MiniatureEffectView extends SimulatingEERelativeLayout {
    ...
    static {
        ...
        MINIATURE_AREA_IMAGER32_STILL169.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 350, 1000, AppRoot.USER_KEYCODE.LENS_APERTURE_RING_STATUS));
        ...
        MINIATURE_AREA_IMAGER43_STILL32.put(PictureEffectController.MINIATURE_HCENTER, new Rect(0, 360, 1000, 640));
