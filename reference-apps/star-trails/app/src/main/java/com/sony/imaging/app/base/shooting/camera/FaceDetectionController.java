...
public class FaceDetectionController extends AbstractController {
    ...
    protected FaceDetectionController() {
        setController(this);
    }
    ...
    public void setValue(String value) throws IllegalArgumentException {
        ...
        builder.replace(0, builder.length(), LOG_MSG_SETFACEDETECTIONMODE).append(set);
    ...
    public String getValue() throws IController.NotSupportedException {
        ...
        StringBuilder builder = StringBuilderThreadLocal.getScratchBuilder();
        builder.replace(0, builder.length(), LOG_MSG_GETFACEDETECTIONMODE).append(pfValue);
        Log.i(TAG, builder.toString());
        StringBuilderThreadLocal.releaseScratchBuilder(builder);
    ...
    public List<String> getSupportedValue() {
        ...
        StringBuilder builder = StringBuilderThreadLocal.getScratchBuilder();
        builder.replace(0, builder.length(), LOG_MSG_GETSUPPORTEDFACEDETECTIONMODES).append(supParams);
        Log.i(TAG, builder.toString());
        StringBuilderThreadLocal.releaseScratchBuilder(builder);
