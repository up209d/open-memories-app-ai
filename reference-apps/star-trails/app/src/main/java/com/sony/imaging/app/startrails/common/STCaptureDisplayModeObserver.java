...
public class STCaptureDisplayModeObserver extends DisplayModeObserver {
    ...
    private static STCaptureDisplayModeObserver mTheInstance = new STCaptureDisplayModeObserver();
    ...
    public static STCaptureDisplayModeObserver getInstance() {
        return mTheInstance;
    }

    protected STCaptureDisplayModeObserver() {
    ...
    public void toggleDisplayMode(int appMode) {
        ...
        int newDispMode = (this.mActiveDisplayModeIndex[appMode][stActiveDevice] + 1) % dispModeCount;
        iArr[stActiveDevice] = newDispMode;
        AppLog.enter(TAG, AppLog.getMethodName());
        int newDispMode2 = manageCustomDisplayMode(appMode, stActiveDevice, dispModeCount, newDispMode);
        if (1 == appMode) {
    ...
    public void updataActiveDisplayModeWithCommonSettingsForStarTrails() {
        ...
        if (-1 != dispModeEVF) {
            this.mActiveDisplayModeIndex[0][1] = indexOf(this.mDispModeList[0][1], roundDisplayMode(1));
        } else {
    ...
    public void writeDisplayModeToCommonSettingsForStarTrails() {
        CommonSettings.getInstance().putCommonSettingInt(CommonSettings.KEY_DISP_MODE_LCD, getDispMode(0, 0));
        CommonSettings.getInstance().putCommonSettingInt(CommonSettings.KEY_DISP_MODE_EVF, getDispMode(0, 1));
        CommonSettings.getInstance().putCommonSettingInt(CommonSettings.KEY_DISP_MODE_PBS, getDispMode(1, 0));
    }
