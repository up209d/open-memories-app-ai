...
public class FlashLevelIcon extends FlashAbstractIcon {
    ...
    static {
        ...
        RESID_DICTIONARY_PANEL_0_3.put(ISOSensitivityController.ISO_AUTO, 17306359);
        RESID_DICTIONARY_PANEL_0_3.put("1", 17306392);
        ...
        RESID_DICTIONARY_PANEL_0_3.put("5", 17306471);
        RESID_DICTIONARY_PANEL_0_3.put("6", 17306507);
        RESID_DICTIONARY_PANEL_0_3.put("7", 17306537);
        ...
        RESID_DICTIONARY_EVF_0_3.put(ISOSensitivityController.ISO_AUTO, 17306705);
        RESID_DICTIONARY_EVF_0_3.put("1", 17306515);
        RESID_DICTIONARY_EVF_0_3.put("2", 17307432);
        RESID_DICTIONARY_EVF_0_3.put("3", 17307458);
        RESID_DICTIONARY_EVF_0_3.put("4", 17306772);
        RESID_DICTIONARY_EVF_0_3.put("5", 17306484);
        RESID_DICTIONARY_EVF_0_3.put("6", 17306676);
        RESID_DICTIONARY_EVF_0_3.put("7", 17306373);
    ...
    protected boolean isVisible() {
        List<String> availables = this.mFlashController.getAvailableValue(FlashController.FLASH_COMPENSATION);
        if (availables != null) {
            this.mVisible = this.mFlashController.isUnavailableSceneFactor(FlashController.FLASH_COMPENSATION) ? false : true;
        } else {
            this.mVisible = false;
        }
    ...
    protected NotificationListener getNotificationListener() {
        return new NotificationListener() { // from class: com.sony.imaging.app.base.shooting.widget.FlashLevelIcon.1
            ...
            public void onNotify(String tag) {
                ...
                Log.i(FlashLevelIcon.TAG, builder.replace(0, FlashLevelIcon.LOG_ONNOTIFY.length(), FlashLevelIcon.LOG_ONNOTIFY).append(tag).toString());
