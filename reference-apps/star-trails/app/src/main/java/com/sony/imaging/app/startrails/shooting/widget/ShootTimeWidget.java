...
public class ShootTimeWidget extends DigitView {
    private static final String TAG = "ShootTimeWidget";
    private static final float THRESHODL_ONE_OR_SMALL = 0.4f;
    private ShutterSpeedChangeListener mShutterSpeedListener;

    public ShootTimeWidget(Context context) {
        this(context, null);
    }

    public ShootTimeWidget(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
