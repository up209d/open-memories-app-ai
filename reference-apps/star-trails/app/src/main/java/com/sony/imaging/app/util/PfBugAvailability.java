...
public class PfBugAvailability {
    ...
    private static boolean highSpeedLensPowerOff() {
        ...
        boolean isDeviceHighSpeedLensPowerOff = "DSC-HX90V".equals(MODEL_NAME) || DSCHX80.equals(MODEL_NAME) || "DSC-WX500".equals(MODEL_NAME) || "DSC-RX100M4".equals(MODEL_NAME) || "DSC-RX10M2".equals(MODEL_NAME);
    ...
    private static boolean virtualMediaPlay() {
        return "DSC-HX90V".equals(MODEL_NAME) || "DSC-WX500".equals(MODEL_NAME) || "DSC-RX100M4".equals(MODEL_NAME) || "DSC-RX10M2".equals(MODEL_NAME) || "ILCE-7M2".equals(MODEL_NAME) || "ILCE-7RM2".equals(MODEL_NAME);
    }
