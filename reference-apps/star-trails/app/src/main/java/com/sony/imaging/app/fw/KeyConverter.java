...
public class KeyConverter implements IKeyHandler {
    ...
    public KeyConverter(IConvertibleKeyHandler handler) {
        this(CustomKeyMgr.getInstance(), handler, "None");
    }
    ...
    public final int apply(KeyEvent event, String category) {
        ...
        if (key != null && category != null && !"None".equals(category)) {
            ...
            if (customizableFunc != null) {
                StringBuilder sStringBuilder = StringBuilderThreadLocal.getScratchBuilder();
                ...
                StringBuilderThreadLocal.releaseScratchBuilder(sStringBuilder);
            } else {
                StringBuilder sStringBuilder2 = StringBuilderThreadLocal.getScratchBuilder();
                sStringBuilder2.replace(0, sStringBuilder2.length(), MSG_FAIL_TO_CONV).append(code);
                Log.i(TAG, sStringBuilder2.toString());
                StringBuilderThreadLocal.releaseScratchBuilder(sStringBuilder2);
            }
        }
